...
`);r.description=h?`${h}
${k}`:k}else r.description=h;a=b-1;continue}f==="anchor"?r.anchor=zt(h,t):f==="spotlight"?r.spotlight=zt(h,t):f==="action"?r.action=h.trim():f==="change"?r.change=h.trim():f==="only"?(r.change=h.trim(),r.replace=!0):f==="highlight"?r.highlight=Ul(h):f==="width"?r.width=Gl(h):f==="position"?r.position=Kl(h):f==="offsetx"?r.offsetX=ql(h):f==="keep"&&(r.keep=h.trim()!=="false");continue}r&&!l.startsWith("-")&&(r.text=`${r.text} ${l}`.trim())}}return o(),s.length>0?s:void 0}function hg(e,t,n){const i=e.split(`
`),r=i[0].match(/^###\s+(.+)$/);if(!r)return null;const o=r[1].trim();Yl(i,rg,o,n);const a=xe(i,"Title")??o,l=Xl(i,"Description")??"",c=cg(i,"Interactions"),u=xe(i,"Shortcut"),f=xe(i,"Context"),h=zt(xe(i,"Anchor"),o),g=xe(i,"Spotlight"),p=g===void 0?void 0:zt(g,o),b=xe(i,"Action"),m=xe(i,"Once"),w=xe(i,"Only"),k=xe(i,"Change"),v=k??w,x=k===void 0&&w!==void 0?!0:void 0,C=Ul(xe(i,"Highlight")),D=Gl(xe(i,"Width")),S=Kl(xe(i,"Position")),P=ql(xe(i,"OffsetX")),E=ug(i,o,n),L=xe(i,"Tour");return{id:o,title:a,description:l,interactions:c,shortcut:u,context:f,anchor:h,action:b,once:m,change:v,replace:x,highlight:C,width:D,position:S,offsetX:P,tour:L===void 0?void 0:L||sg,order:t,beats:E,...p?{spotlight:p}:{}}}function dg(e,t,n){const i=e.split(`
...
`,"\r"];return r+"="+f+Ng(o,{subset:h})+f}}function _g(e){Hs.call(this,"containerDirective",e)}function Hg(e){Hs.call(this,"leafDirective",e)}function zg(e){Hs.call(this,"textDirective",e)}function Hs(e,t){this.enter({type:e,name:"",attributes:{},children:[]},t)}function bi(e){const t=this.stack[this.stack.length-1];_r(t.type==="containerDirective"||t.type==="leafDirective"||t.type==="textDirective"),t.name=this.sliceSerialize(e)}function Wg(e){this.enter({type:"paragraph",data:{directiveLabel:!0},children:[]},e)}function Gg(e){this.exit(e)}function wi(){this.data.directiveAttributes=[],this.buffer()}function xi(e){this.data.directiveAttributes.push(["id",_s(this.sliceSerialize(e),{attribute:!0})])}function vi(e){this.data.directiveAttributes.push(["class",_s(this.sliceSerialize(e),{attribute:!0})])}function ki(e){const t=this.data.directiveAttributes;t[t.length-1][1]=_s(this.sliceSerialize(e),{attribute:!0})}function Si(e){this.data.directiveAttributes.push([this.sliceSerialize(e),""])}function Ti(){const e=this.data.directiveAttributes,t={};let n=-1;for(;++n<e.length;){const s=e[n];s[0]==="class"&&t.class?t.class+=" "+s[1]:t[s[0]]=s[1]}this.data.directiveAttributes=void 0,this.resume();const i=this.stack[this.stack.length-1];_r(i.type==="containerDirective"||i.type==="leafDirective"||i.type==="textDirective"),i.attributes=t}function Ci(e){this.exit(e)}function Ug(){return":"}function Lr(e){return!!(e&&e.type==="paragraph"&&e.data&&e.data.directiveLabel)}function Kg(e){let t=0;return e.type==="containerDirective"?(xc(e,function(n,i){if(n.type==="containerDirective"){let s=i.length,r=0;for(;s--;)i[s].type==="containerDirective"&&r++;r>t&&(t=r)}}),t+=3):e.type==="leafDirective"?t=2:t=1,":".repeat(t)}function zs(e,t,n,i,s,r,o,a,l,c,u,f,h,g,p){let b,m;return w;function w(T){return e.enter(i),e.enter(s),e.consume(T),e.exit(s),k}function k(T){return T===35?(b=o,v(T)):T===46?(b=a,v(T)):p&&qn(T)?Ye(e,k,"whitespace")(T):!p&&nt(T)?Zt(e,k)(T):T===null||Ae(T)||Cn(T)||An(T)&&T!==45&&T!==95?_(T):(e.enter(r),e.enter(l),e.consume(T),D)}function v(T){const W=b+"Marker";return e.enter(r),e.enter(b),e.enter(W),e.consume(T),e.exit(W),x}function x(T){if(T===null||T===34||T===35||T===39||T===46||T===60||T===61||T===62||T===96||T===125||nt(T))return n(T);const W=b+"Value";return e.enter(W),e.consume(T),C}function C(T){if(T===null||T===34||T===39||T===60||T===61||T===62||T===96)return n(T);if(T===35||T===46||T===125||nt(T)){const W=b+"Value";return e.exit(W),e.exit(b),e.exit(r),k(T)}return e.consume(T),C}function D(T){return T===null||Ae(T)||Cn(T)||An(T)&&T!==45&&T!==46&&T!==58&&T!==95?(e.exit(l),p&&qn(T)?Ye(e,S,"whitespace")(T):!p&&nt(T)?Zt(e,S)(T):S(T)):(e.consume(T),D)}function S(T){return T===61?(e.enter(c),e.consume(T),e.exit(c),P):(e.exit(r),k(T))}function P(T){return T===null||T===60||T===61||T===62||T===96||T===125||p&&Ae(T)?n(T):T===34||T===39?(e.enter(u),e.enter(h),e.consume(T),e.exit(h),m=T,L):p&&qn(T)?Ye(e,P,"whitespace")(T):!p&&nt(T)?Zt(e,P)(T):(e.enter(f),e.enter(g),e.consume(T),m=void 0,E)}function E(T){return T===null||T===34||T===39||T===60||T===61||T===62||T===96?n(T):T===125||nt(T)?(e.exit(g),e.exit(f),e.exit(r),k(T)):(e.consume(T),E)}function L(T){return T===m?(e.enter(h),e.consume(T),e.exit(h),e.exit(u),e.exit(r),O):(e.enter(f),I(T))}function I(T){return T===m?(e.exit(f),L(T)):T===null?n(T):Ae(T)?p?n(T):Zt(e,I)(T):(e.enter(g),e.consume(T),B)}function B(T){return T===m||T===null||Ae(T)?(e.exit(g),I(T)):(e.consume(T),B)}function O(T){return T===125||nt(T)?k(T):_(T)}function _(T){return T===125?(e.enter(s),e.consume(T),e.exit(s),e.exit(i),t):n(T)}}function Ws(e,t,n,i,s,r,o){let a=0,l=0,c;return u;function u(m){return e.enter(i),e.enter(s),e.consume(m),e.exit(s),f}function f(m){return m===93?(e.enter(s),e.consume(m),e.exit(s),e.exit(i),t):(e.enter(r),h(m))}function h(m){if(m===93&&!l)return b(m);const w=e.enter("chunkText",{_contentTypeTextTrailing:!0,contentType:"text",previous:c});return c&&(c.next=w),c=w,g(m)}function g(m){return m===null||a>999||m===91&&++l>32?n(m):m===93&&!l--?(e.exit("chunkText"),b(m)):Ae(m)?o?n(m):(e.consume(m),e.exit("chunkText"),h):(e.consume(m),m===92?p:g)}function p(m){return m===91||m===92||m===93?(e.consume(m),a++,g):g(m)}function b(m){return e.exit(r),e.enter(s),e.consume(m),e.exit(s),e.exit(i),t}}function Gs(e,t,n,i){const s=this;return r;function r(a){return a===null||Ae(a)||An(a)||Cn(a)?n(a):(e.enter(i),e.consume(a),o)}function o(a){return a===null||Ae(a)||Cn(a)||An(a)&&a!==45&&a!==95?(e.exit(i),s.previous===45||s.previous===95?n(a):t(a)):(e.consume(a),o)}}const qg={tokenize:Xg,concrete:!0},Qg={tokenize:Zg,partial:!0},Yg={tokenize:Jg,partial:!0},pn={tokenize:ey,partial:!0};function Xg(e,t,n){const i=this,s=i.events[i.events.length-1],r=s&&s[1].type==="linePrefix"?s[2].sliceSerialize(s[1],!0).length:0;let o=0,a;return l;function l(E){return e.enter("directiveContainer"),e.enter("directiveContainerFence"),e.enter("directiveContainerSequence"),c(E)}function c(E){return E===58?(e.consume(E),o++,c):o<3?n(E):(e.exit("directiveContainerSequence"),Gs.call(i,e,u,n,"directiveContainerName")(E))}function u(E){return E===91?e.attempt(Qg,f,f)(E):f(E)}function f(E){return E===123?e.attempt(Yg,h,h)(E):h(E)}function h(E){return Ye(e,g,"whitespace")(E)}function g(E){return e.exit("directiveContainerFence"),E===null?S(E):Ae(E)?i.interrupt?t(E):e.attempt(pn,p,S)(E):n(E)}function p(E){return E===null?S(E):Ae(E)?e.check(pn,v,S)(E):(e.enter("directiveContainerContent"),b(E))}function b(E){return e.attempt({tokenize:P,partial:!0},D,r?Ye(e,m,"linePrefix",r+1):m)(E)}function m(E){return E===null?D(E):Ae(E)?e.check(pn,k,D)(E):k(E)}function w(E){if(E===null){const L=e.exit("chunkDocument");return i.parser.lazy[L.start.line]=!1,D(E)}return Ae(E)?e.check(pn,x,C)(E):(e.consume(E),w)}function k(E){const L=e.enter("chunkDocument",{contentType:"document",previous:a});return a&&(a.next=L),a=L,w(E)}function v(E){return e.enter("directiveContainerContent"),b(E)}function x(E){e.consume(E);const L=e.exit("chunkDocument");return i.parser.lazy[L.start.line]=!1,b}function C(E){const L=e.exit("chunkDocument");return i.parser.lazy[L.start.line]=!1,D(E)}function D(E){return e.exit("directiveContainerContent"),S(E)}function S(E){return e.exit("directiveContainer"),t(E)}function P(E,L,I){let B=0;return Ye(E,O,"linePrefix",i.parser.constructs.disable.null.includes("codeIndented")?void 0:4);function O(W){return E.enter("directiveContainerFence"),E.enter("directiveContainerSequence"),_(W)}function _(W){return W===58?(E.consume(W),B++,_):B<o?I(W):(E.exit("directiveContainerSequence"),Ye(E,T,"whitespace")(W))}function T(W){return W===null||Ae(W)?(E.exit("directiveContainerFence"),L(W)):I(W)}}}function Zg(e,t,n){return Ws(e,t,n,"directiveContainerLabel","directiveContainerLabelMarker","directiveContainerLabelString",!0)}function Jg(e,t,n){return zs(e,t,n,"directiveContainerAttributes","directiveContainerAttributesMarker","directiveContainerAttribute","directiveContainerAttributeId","directiveContainerAttributeClass","directiveContainerAttributeName","directiveContainerAttributeInitializerMarker","directiveContainerAttributeValueLiteral","directiveContainerAttributeValue","directiveContainerAttributeValueMarker","directiveContainerAttributeValueData",!0)}function ey(e,t,n){const i=this;return s;function s(o){return e.enter("lineEnding"),e.consume(o),e.exit("lineEnding"),r}function r(o){return i.parser.lazy[i.now().line]?n(o):t(o)}}const ty={tokenize:sy},ny={tokenize:oy,partial:!0},iy={tokenize:ry,partial:!0};function sy(e,t,n){const i=this;return s;function s(u){return e.enter("directiveLeaf"),e.enter("directiveLeafSequence"),e.consume(u),r}function r(u){return u===58?(e.consume(u),e.exit("directiveLeafSequence"),Gs.call(i,e,o,n,"directiveLeafName")):n(u)}function o(u){return u===91?e.attempt(ny,a,a)(u):a(u)}function a(u){return u===123?e.attempt(iy,l,l)(u):l(u)}function l(u){return Ye(e,c,"whitespace")(u)}function c(u){return u===null||Ae(u)?(e.exit("directiveLeaf"),t(u)):n(u)}}function oy(e,t,n){return Ws(e,t,n,"directiveLeafLabel","directiveLeafLabelMarker","directiveLeafLabelString",!0)}function ry(e,t,n){return zs(e,t,n,"directiveLeafAttributes","directiveLeafAttributesMarker","directiveLeafAttribute","directiveLeafAttributeId","directiveLeafAttributeClass","directiveLeafAttributeName","directiveLeafAttributeInitializerMarker","directiveLeafAttributeValueLiteral","directiveLeafAttributeValue","directiveLeafAttributeValueMarker","directiveLeafAttributeValueData",!0)}const ay={tokenize:hy,previous:uy},ly={tokenize:dy,partial:!0},cy={tokenize:fy,partial:!0};function uy(e){return e!==58||this.events[this.events.length-1][1].type==="characterEscape"}function hy(e,t,n){const i=this;return s;function s(l){return e.enter("directiveText"),e.enter("directiveTextMarker"),e.consume(l),e.exit("directiveTextMarker"),Gs.call(i,e,r,n,"directiveTextName")}function r(l){return l===58?n(l):l===91?e.attempt(ly,o,o)(l):o(l)}function o(l){return l===123?e.attempt(cy,a,a)(l):a(l)}function a(l){return e.exit("directiveText"),t(l)}}function dy(e,t,n){return Ws(e,t,n,"directiveTextLabel","directiveTextLabelMarker","directiveTextLabelString")}function fy(e,t,n){return zs(e,t,n,"directiveTextAttributes","directiveTextAttributesMarker","directiveTextAttribute","directiveTextAttributeId","directiveTextAttributeClass","directiveTextAttributeName","directiveTextAttributeInitializerMarker","directiveTextAttributeValueLiteral","directiveTextAttributeValue","directiveTextAttributeValueMarker","directiveTextAttributeValueData")}function py(){return{text:{58:ay},flow:{58:[qg,ty]}}}function my(){const t=this.data(),n=t.micromarkExtensions||(t.micromarkExtensions=[]),i=t.fromMarkdownExtensions||(t.fromMarkdownExtensions=[]),s=t.toMarkdownExtensions||(t.toMarkdownExtensions=[]);n.push(py()),i.push($g()),s.push(Fg())}const Nr={size:e=>`font-size:${e}`,color:e=>`color:${e}`,bg:e=>`background-color:${e}`,opacity:e=>`opacity:${e}`,nowrap:()=>"white-space:nowrap",center:()=>"text-align:center"},gy=new Set(["center"]),yy="s",by=/^[\w.#%(),\s-]*$/,wy=new Set(["color","bg"]);function xy(e,t=!1,n){const i=[];for(const[s,r]of Object.entries(e??{})){if(!(s in Nr)||t&&gy.has(s))continue;let o=(r??"").trim();wy.has(s)&&(o=n?.[o]??o),!(!by.test(o)||/url\s*\(/i.test(o))&&i.push(Nr[s](o))}return i.join(";")}const vy=new Set(["textDirective","leafDirective","containerDirective"]);function tc(e,t){if(vy.has(e.type)){const n=e.type==="textDirective",i=e.name===yy?xy(e.attributes,n,t):"";e.data={...e.data,hName:n?"span":"div",hProperties:i?{style:i,className:"help-styled"}:{}}}for(const n of e.children??[])tc(n,t)}function ky(e={}){return t=>{tc(t,e.colors)}}const Sy=e=>[my,[ky,{colors:e}]],rs={a:({href:e,children:t})=>d.jsx("a",{href:e,target:"_blank",rel:"noreferrer",children:t}),blockquote:({children:e})=>d.jsxs("div",{className:"help-popover-alert",role:"note",children:[d.jsx("span",{className:"help-popover-alert-mark","aria-hidden":"true",children:"!"}),d.jsx("div",{children:e})]})},as="widget:",Ty=e=>e.startsWith(as)?e:vc(e);function Cy(e){return function({src:n,alt:i}){if(n?.startsWith(as)){const s=n.slice(as.length),r=s.indexOf(":"),o=r===-1?s:s.slice(0,r),a=r===-1?"":s.slice(r+1);return e?.[o]?.(a)??d.jsx("span",{children:i})}return d.jsx("img",{src:n,alt:i})}}function Ay(e){try{return localStorage.getItem(e)}catch{return null}}function Py(e,t){try{localStorage.setItem(e,t)}catch{}}const nc="help-once-",Ai="data-help-anchor",Pi="data-help-spotlight",Vr="data-help-hint",Ey="--help-hint",Dy=40;function My(e){return e.split(`
`).filter(t=>!/^\s{0,3}>/.test(t)).join(`
`).replace(/\n{3,}/g,`

`).trim()}function Oy(e){return Ay(nc+e)==="1"}function Ry(e){Py(nc+e,"1")}function jy(e){return{...rs,blockquote:({children:t})=>d.jsxs("div",{className:"help-popover-alert",role:"note",children:[d.jsx("span",{className:"help-popover-alert-mark","aria-hidden":"true",children:"!"}),d.jsxs("div",{children:[t,d.jsxs("label",{className:"help-popover-alert-once",children:[d.jsx("input",{type:"checkbox",onChange:e}),"Don't show this again"]})]})]})}}function Ly(){const{helpMode:e,tourIndex:t,position:n,positions:i,stepCount:s,content:r,activeId:o,dismissEntry:a,nextStep:l,prevStep:c,endTour:u,showEntry:f,resolveAnchor:h,centerRect:g,showAddresses:p,tourName:b,tourMeta:m,widgets:w,colors:k}=ht(),v=y.useMemo(()=>Sy(k),[k]),x=b===void 0?void 0:m.get(b)?.abbr??b,[C,D]=y.useState(!1),S=t!==null;y.useEffect(()=>{S||D(!1)},[S]);const P=o?r.entries.get(o):void 0,E=Hl(),L=h,I=S?n?.anchor:P?.anchor,B=S?n?.spotlight:P?.spotlight,O=(S?n?.highlight:P?.highlight)??"dim",_=()=>{if(!n||n.beatCount===0)return null;const U=n.beatIndex+1;return d.jsx("span",{className:"help-tour-dots",title:`Screen ${U+1} of ${n.beatCount+1} in this step`,children:Array.from({length:n.beatCount},(J,pe)=>d.jsx("span",{className:pe<U?"help-dot help-dot-on":"help-dot"},pe))})},[T,W]=y.useState(!1),[fe,N]=y.useState(!1),[G,j]=y.useState(void 0),[X,oe]=y.useState(!1),re=y.useRef(null),[,Me]=y.useState(0),be=P?.once,Pe=be!==void 0&&Oy(be),ve=y.useMemo(()=>({...be===void 0?rs:jy(()=>{Ry(be),Me(U=>U+1)}),img:Cy(w)}),[be,w]),Te=(S?n?.blocks??[]:[P?.description??""]).map(U=>Pe?My(U):U).filter(Boolean),q=(S?n?.width:void 0)??Math.max(_y(Te.join(`

`)),S?Hy():0),Q=y.useRef(!1);y.useEffect(()=>{Q.current=!1},[o,I]);const ne=E.reset;y.useEffect(()=>{ne()},[o,t,ne]),y.useLayoutEffect(()=>{if(!o){W(!1),j(void 0);return}let U=null;const J=()=>{const me=L(I);me!==U&&(U?.removeAttribute(Ai),U=me,W(!!me),j(me?.closest("[data-graph-direction]")?.getAttribute("data-graph-direction")==="RIGHT"?"below":void 0),me&&(me.setAttribute(Ai,""),Q.current||(Q.current=!0,me.scrollIntoView({block:"center",behavior:"smooth"}))))};J();const pe=new MutationObserver(J);return pe.observe(document.body,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["data-help-id"]}),()=>{pe.disconnect(),U?.removeAttribute(Ai),W(!1),j(void 0)}},[o,I,L]),y.useLayoutEffect(()=>{if(!o||!B){N(!1);return}let U=null;const J=()=>{const me=L(B);me!==U&&(U?.removeAttribute(Pi),U=me,N(!!me),me?.setAttribute(Pi,""))};J();const pe=new MutationObserver(J);return pe.observe(document.body,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["data-help-id"]}),()=>{pe.disconnect(),U?.removeAttribute(Pi),N(!1)}},[o,B,L]);const ae=600,we=S&&n?.change!=null&&I!==void 0&&I.kind!=="none",[Le,Ne]=y.useState(!1);y.useEffect(()=>{if(!we){Ne(!0);return}Ne(!1);const U=window.setTimeout(()=>Ne(!0),ae);return()=>window.clearTimeout(U)},[we,t]);const dt=Le||T,ft=S?n?.address??"tour":o??"none";y.useEffect(()=>{const U=re.current;U&&(P&&dt?U.matches(":popover-open")||U.showPopover():U.matches(":popover-open")&&U.hidePopover())},[P,dt,ft]),y.useEffect(()=>{(!e||S)&&oe(!1)},[e,S]);const pt=y.useMemo(()=>e&&!S?[...r.entries.values()].filter(U=>L(U.anchor)).slice(0,Dy).map((U,J)=>({id:U.id,title:U.title,name:`${Ey}-${J}`})):[],[e,S,r,L]);return y.useLayoutEffect(()=>{const U=pt.map(J=>{const pe=L(r.entries.get(J.id)?.anchor);return pe?.setAttribute(Vr,J.name),pe}).filter(Boolean);return()=>U.forEach(J=>J.removeAttribute(Vr))},[pt,r,L]),d.jsxs(d.Fragment,{children:[(fe||T)&&o&&O!=="none"&&d.jsx("div",{className:`help-spotlight${O==="ring"?" help-spotlight-ring":""}`,"data-on-spotlight":fe?"":void 0}),pt.map(({id:U,title:J,name:pe})=>d.jsx("button",{className:"help-hint",title:J??U,style:{positionAnchor:pe},onMouseEnter:()=>{X||f(U)},onMouseLeave:()=>{X||a()},onClick:me=>{me.stopPropagation(),oe(!0),f(U)},children:"?"},U)),d.jsx("div",{ref:re,popover:"manual","data-help-popover":"","data-anchored":T&&!E.offset?"":void 0,className:"help-popover",style:{...zy(T,S?n?.position:void 0,S?n?.offsetX:void 0,q,T?null:g(),G),...E.offset?{positionArea:"none",left:E.offset.left,top:E.offset.top,right:"auto",bottom:"auto",margin:0,transform:"none"}:{}},children:P&&d.jsxs(d.Fragment,{children:[d.jsxs("h4",{className:"help-popover-title",onPointerDown:E.onPointerDown,style:{cursor:E.offset?"grabbing":"grab",userSelect:"none"},title:"Drag to move",children:[S&&x&&d.jsx("span",{className:"help-popover-tour",children:x}),P.title]}),S&&n?.action&&d.jsxs("div",{className:"help-popover-action",children:[d.jsx("span",{className:"help-popover-action-mark","aria-hidden":"true",children:"✓"}),d.jsx("div",{children:d.jsx(Jt,{children:n.action})})]}),S&&p&&n?.change&&!n.action&&d.jsxs("div",{className:"help-popover-action",style:{opacity:.85},children:[d.jsx("span",{className:"help-popover-action-mark","aria-hidden":"true",children:"⚠"}),d.jsxs("div",{children:[d.jsx("em",{children:"Authoring:"})," this position changes the app (",d.jsx("code",{children:n.change}),") but has no ",d.jsx("code",{children:"Action:"}),"."]})]}),Te.length>0&&d.jsx("div",{className:"help-popover-body",children:Te.map((U,J,pe)=>d.jsx("div",{className:J===pe.length-1?void 0:"help-beat-past",children:d.jsx(Jt,{components:ve,urlTransform:Ty,remarkPlugins:v,children:U})},J))}),P.interactions.length>0&&d.jsx("ul",{className:"help-popover-interactions",children:P.interactions.map((U,J)=>d.jsx("li",{children:d.jsx(Jt,{components:rs,children:U})},J))}),P.shortcut&&d.jsxs("p",{className:"help-popover-shortcut",children:["Shortcut: ",d.jsx("kbd",{children:P.shortcut})]}),P.context&&d.jsx("div",{className:"help-popover-context",children:d.jsx(Jt,{children:P.context})}),S?d.jsxs("div",{className:"help-tour-nav",children:[d.jsxs("span",{className:"help-tour-count",title:`Position ${t+1} of ${i.length}`,children:[n?.step," / ",s]}),_(),d.jsx("button",{className:"help-tour-map-btn",onClick:()=>D(U=>!U),"aria-expanded":C,title:"Show the tour outline",children:"⊞"}),d.jsx("span",{className:"help-tour-spacer"}),d.jsx("button",{onClick:c,disabled:t===0,title:"Previous (← arrow key)",children:"← back"}),d.jsx("button",{onClick:l,className:"help-tour-next",title:"Next (→ arrow key)",children:t+1===i.length?"done":"next →"}),d.jsx("button",{onClick:u,title:"End the tour and undo what it added (Esc)",children:"✕"})]}):d.jsxs("div",{className:"help-tour-nav",children:[d.jsx("span",{className:"help-tour-spacer"}),d.jsx("button",{onClick:()=>{oe(!1),a()},children:"close"})]}),p&&d.jsx(Ny,{address:S?n?.address:P.id,searchFor:S?n?.searchFor:`### ${P.id}`})]})},ft),C&&S&&d.jsx(Jl,{scope:"tour",onClose:()=>D(!1)})]})}function Ny({address:e,searchFor:t}){const[n,i]=y.useState(!1);return y.useEffect(()=>{if(!n)return;const s=setTimeout(()=>i(!1),1200);return()=>clearTimeout(s)},[n]),!e||!t?null:d.jsxs("button",{type:"button",className:"help-popover-address",title:`Copy “${t}” — search help-content.md for it`,onClick:()=>{navigator.clipboard?.writeText(t).then(()=>i(!0),()=>{})},children:[e,n?" ✓":""]})}const ic=320,Vy=320,Iy=800,By=8,$y=24,Fy=3;function _y(e){const t=e.trim().length;return t===0?ic:Math.round(Math.min(Iy,Math.max(Vy,Math.sqrt(t*By*$y*Fy))))}function Hy(){return 393}function zy(e,t,n,i,s,r){const o=window.innerWidth,a=window.innerHeight,l=Math.min(i??ic,o-16);if(!e){const u=s??new DOMRect(0,0,o,a),f=u.left+u.width/2;return{left:Math.max(8,Math.min(f-l/2,o-l-8)),top:"50%",transform:"translateY(-50%)",maxHeight:`${a-16}px`,width:l}}return{positionArea:t?{right:"inline-end span-block-end",left:"inline-start span-block-end",top:"block-start span-inline-end",bottom:"block-end span-inline-end"}[t]:r==="below"?"block-end span-inline-end":"inline-end span-block-end",width:l,...Wy(n)}}function Wy(e){return e?{marginLeft:"px"in e?`${e.px}px`:`calc(anchor-size(${e.of}) * ${e.times})`}:{}}const Ei=e=>e&&e.trim()?e.trim():void 0;function Gy(e){return{"model-description":t=>Ei(e.getClassDescription(t)),"enum-description":t=>Ei(e.getEnumDetail(t)?.description),"category-label":t=>Ei($r.find(n=>n.id===t)?.label),edge:t=>t in ie.kinds?`![${ie.kinds[t].label}](widget:edge:${t})`:void 0,relation:t=>{const n=sc(t);return n?`![${n.left} ${n.right}](widget:relation:${t})`:void 0}}}function sc(e){const[t,n,i]=e.split(":");return t&&t in ie.kinds&&n&&i?{kind:t,left:n,right:i}:void 0}const Uy={edge:e=>e in ie.kinds?d.jsx(In,{kind:e,width:40,className:"help-inline-widget"}):null,relation:e=>{const t=sc(e);return t?d.jsxs("span",{className:"help-inline-relation",children:[d.jsx("code",{children:t.left}),d.jsx(In,{kind:t.kind,width:40,className:"help-inline-widget"}),d.jsx("code",{children:t.right})]}):null}},Ky={...Object.fromEntries(Object.entries(ie.kinds).map(([e,t])=>[e,t.color])),entity:He.entity,enum:He.enum,"data-type":He.dataType,variable:He.variable,slot:He.slot,...Object.fromEntries(Fr.flatMap((e,t)=>[[`sibling-${t}`,e.text],[`sibling-${t}-fill`,e.fill]]))},qy=`# BDCHM Explorer help
