import{i as os,p as kl,r as p,j as h,g as Tl,E as xe,a as tr,b as nr,S as Sl,c as Cl,d as Al,s as Pl,w as El,R as xt,e as Ml,f as Dl,m as Ol,h as Rl,k as jl,M as Wt,u as Ll,D as Nl,l as Vl}from"./index-DrnSqbqh.js";function sr(e){return[...new Set([...e.classIds,...e.pins])]}const Il=e=>`entity-row:${e}`,Bl=e=>`entity-checkbox:${e}`,$l=e=>`category-row:${e}`,Fl=e=>`node-box:${e}`,_l=e=>`child-header:${e}`,Hl=(e,t)=>`slot-row:${e}.${t}`,ir=e=>os(e.id)?kl(e.id):e.id,Wl=e=>Fl(ir(e)),zl=(e,t)=>Hl(t.declaringClass??ir(e),t.slot);function Ul({dataService:e,selectedIds:t,onToggle:n,onShowCategory:s}){const i=p.useMemo(()=>e.getCategoryTrees(),[e]),[r,o]=p.useState(new Set),a=l=>o(d=>{const f=new Set(d);return f.has(l)?f.delete(l):f.add(l),f}),c=i.reduce((l,d)=>l+d.classIds.length,0);return h.jsxs("div",{className:"text-sm",children:[h.jsx("div",{className:"flex items-baseline gap-2 px-3 py-2 border-b border-gray-200 dark:border-slate-700",children:h.jsxs("span",{className:"font-semibold flex-1",children:[e.getConceptLabel("entity",!0)," (",c,")"]})}),i.map(l=>{const d=r.has(l.id),f=l.classIds.filter(u=>t.has(u)).length;return h.jsxs("div",{children:[h.jsxs("div",{"data-help-id":$l(l.id),className:`w-full flex items-stretch font-medium
                    ...
                    ${n.has(i)?"bg-blue-50 dark:bg-slate-800":""}`,style:{paddingLeft:`${.75+t*1}rem`},children:[h.jsx("input",{type:"checkbox","data-help-id":Bl(i),checked:n.has(i),onChange:()=>s(i)}),h.jsxs("span",{className:"flex-1 min-w-0 truncate",children:[h.jsx("span",{className:"font-mono text-xs",children:i}),e.outOfCategoryParent&&h.jsxs("span",{className:"ml-1 text-[10px] text-gray-400 dark:text-slate-500",title:`Extends ${e.outOfCategoryParent}, which is in another category`,children:["↳ ",e.outOfCategoryParent]})]})]}),e.children.map(r=>h.jsx(or,{node:r,depth:t+1,selectedIds:n,onToggle:s},r.classId))]})}const Is=p.createContext({});function Bs(e){const t=p.useRef(null);return t.current===null&&(t.current=e()),t.current}const Gl=typeof window<"u",un=Gl?p.useLayoutEffect:p.useEffect,kn=p.createContext(null);function $s(e,t){e.indexOf(t)===-1&&e.push(t)}function fn(e,t){const n=e.indexOf(t);n>-1&&e.splice(n,1)}const $e=(e,t,n)=>n>t?t:n<e?e:n;let Tn=()=>{};const Ue={},rr=e=>/^-?(?:\d+(?:\.\d+)?|\.\d+)$/u.test(e),ar=e=>typeof e=="object"&&e!==null,lr=e=>/^0[^.\s]+$/u.test(e);function cr(e){let t;return()=>(t===void 0&&(t=e()),t)}const Ae=e=>e,Nt=(...e)=>e.reduce((t,n)=>s=>n(t(s))),Ot=(e,t,n)=>{const s=t-e;return s?(n-e)/s:1};class Fs{constructor(){this.subscriptions=[]}add(t){return $s(this.subscriptions,t),()=>fn(this.subscriptions,t)}notify(t,n,s){const i=this.subscriptions.length;if(i)if(i===1)this.subscriptions[0](t,n,s);else for(let r=0;r<i;r++){const o=this.subscriptions[r];o&&o(t,n,s)}}getSize(){return this.subscriptions.length}clear(){this.subscriptions.length=0}}const Pe=e=>e*1e3,Ce=e=>e/1e3,dr=(e,t)=>t?e*(1e3/t):0,hr=(e,t,n)=>(((1-3*n+3*t)*e+(3*n-6*t))*e+3*t)*e,Kl=1e-7,Ql=12;function ql(e,t,n,s,i){let r,o,a=0;do o=t+(n-t)/2,r=hr(o,s,i)-e,r>0?n=o:t=o;while(Math.abs(r)>Kl&&++a<Ql);return o}function Vt(e,t,n,s){if(e===t&&n===s)return Ae;const i=r=>ql(r,0,1,e,n);return r=>r===0||r===1?r:hr(i(r),t,s)}const ur=e=>t=>t<=.5?e(2*t)/2:(2-e(2*(1-t)))/2,fr=e=>t=>1-e(1-t),pr=Vt(.33,1.53,.69,.99),_s=fr(pr),mr=ur(_s),gr=e=>e>=1?1:(e*=2)<1?.5*_s(e):.5*(2-Math.pow(2,-10*(e-1))),Hs=e=>1-Math.sin(Math.acos(e)),yr=fr(Hs),wr=ur(Hs),Xl=Vt(.42,0,1,1),Yl=Vt(0,0,.58,1),br=Vt(.42,0,.58,1),Zl=e=>Array.isArray(e)&&typeof e[0]!="number",xr=e=>Array.isArray(e)&&typeof e[0]=="number",Jl={linear:Ae,easeIn:Xl,easeInOut:br,easeOut:Yl,circIn:Hs,circInOut:wr,circOut:yr,backIn:_s,backInOut:mr,backOut:pr,anticipate:gr},ec=e=>typeof e=="string",ki=e=>{if(xr(e)){Tn(e.length===4);const[t,n,s,i]=e;return Vt(t,n,s,i)}else if(ec(e))return Jl[e];return e},zt=["setup","read","resolveKeyframes","preUpdate","update","preRender","render","postRender"];function tc(e){let t=new Set,n=new Set,s=!1,i=!1;const r=new WeakSet;let o={delta:0,timestamp:0,isProcessing:!1};function a(l){r.has(l)&&(c.schedule(l),e()),l(o)}const c={schedule:(l,d=!1,f=!1)=>{const m=f&&s?t:n;return d&&r.add(l),m.add(l),l},cancel:l=>{n.delete(l),r.delete(l)},process:l=>{if(o=l,s){i=!0;return}s=!0;const d=t;t=n,n=d,t.forEach(a),t.clear(),s=!1,i&&(i=!1,c.process(l))}};return c}const nc=40;function vr(e,t){let n=!1,s=!0;const i={delta:0,timestamp:0,isProcessing:!1},r=()=>n=!0,o=zt.reduce((v,g)=>(v[g]=tc(r),v),{}),{setup:a,read:c,resolveKeyframes:l,preUpdate:d,update:f,preRender:u,render:m,postRender:y}=o,b=()=>{const v=Ue.useManualTiming,g=v?i.timestamp:performance.now();n=!1,v||(i.delta=s?1e3/60:Math.max(Math.min(g-i.timestamp,nc),1)),i.timestamp=g,i.isProcessing=!0,a.process(i),c.process(i),l.process(i),d.process(i),f.process(i),u.process(i),m.process(i),y.process(i),i.isProcessing=!1,n&&t&&(s=!1,e(b))},w=()=>{n=!0,s=!0,i.isProcessing||e(b)};return{schedule:zt.reduce((v,g)=>{const k=o[g];return v[g]=(P,C=!1,E=!1)=>(n||w(),k.schedule(P,C,E)),v},{}),cancel:v=>{for(let g=0;g<zt.length;g++)o[zt[g]].cancel(v)},state:i,steps:o}}const{schedule:te,cancel:Ge,state:pe,steps:jn}=vr(typeof requestAnimationFrame<"u"?requestAnimationFrame:Ae,!0);let nn;function sc(){nn=void 0}const we={now:()=>(nn===void 0&&we.set(pe.isProcessing||Ue.useManualTiming?pe.timestamp:performance.now()),nn),set:e=>{nn=e,queueMicrotask(sc)}},kr=e=>t=>typeof t=="string"&&t.startsWith(e),Tr=kr("--"),ic=kr("var(--"),Ws=e=>ic(e)?oc.test(e.split("/*")[0].trim()):!1,oc=/var\(--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)$/iu;function Ti(e){return typeof e!="string"?!1:e.split("/*")[0].includes("var(--")}const pt={test:e=>typeof e=="number",parse:parseFloat,transform:e=>e},Rt={...pt,transform:e=>$e(0,1,e)},Ut={...pt,default:1},St=e=>Math.round(e*1e5)/1e5,zs=/-?(?:\d+(?:\.\d+)?|\.\d+)/gu;function rc(e){return e==null}const ac=/^(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))$/iu,Us=(e,t)=>n=>!!(typeof n=="string"&&ac.test(n)&&n.startsWith(e)||t&&!rc(n)&&Object.prototype.hasOwnProperty.call(n,t)),Sr=(e,t,n)=>s=>{if(typeof s!="string")return s;const[i,r,o,a]=s.match(zs);return{[e]:parseFloat(i),[t]:parseFloat(r),[n]:parseFloat(o),alpha:a!==void 0?parseFloat(a):1}},lc=e=>$e(0,255,e),Ln={...pt,transform:e=>Math.round(lc(e))},Ye={test:Us("rgb","red"),parse:Sr("red","green","blue"),transform:({red:e,green:t,blue:n,alpha:s=1})=>"rgba("+Ln.transform(e)+", "+Ln.transform(t)+", "+Ln.transform(n)+", "+St(Rt.transform(s))+")"};function cc(e){let t="",n="",s="",i="";return e.length>5?(t=e.substring(1,3),n=e.substring(3,5),s=e.substring(5,7),i=e.substring(7,9)):(t=e.substring(1,2),n=e.substring(2,3),s=e.substring(3,4),i=e.substring(4,5),t+=t,n+=n,s+=s,i+=i),{red:parseInt(t,16),green:parseInt(n,16),blue:parseInt(s,16),alpha:i?parseInt(i,16)/255:1}}const rs={test:Us("#"),parse:cc,transform:Ye.transform},It=e=>({test:t=>typeof t=="string"&&t.endsWith(e)&&t.split(" ").length===1,parse:parseFloat,transform:t=>`${t}${e}`}),Fe=It("deg"),Be=It("%"),L=It("px"),dc=It("vh"),hc=It("vw"),Si={...Be,parse:e=>Be.parse(e)/100,transform:e=>Be.transform(e*100)},ct={test:Us("hsl","hue"),parse:Sr("hue","saturation","lightness"),transform:({hue:e,saturation:t,lightness:n,alpha:s=1})=>"hsla("+Math.round(e)+", "+Be.transform(St(t))+", "+Be.transform(St(n))+", "+St(Rt.transform(s))+")"},re={test:e=>Ye.test(e)||rs.test(e)||ct.test(e),parse:e=>Ye.test(e)?Ye.parse(e):ct.test(e)?ct.parse(e):rs.parse(e),transform:e=>typeof e=="string"?e:e.hasOwnProperty("red")?Ye.transform(e):ct.transform(e),getAnimatableNone:e=>{const t=re.parse(e);return t.alpha=0,re.transform(t)}},uc=/(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))/giu;function fc(e){return isNaN(e)&&typeof e=="string"&&(e.match(zs)?.length||0)+(e.match(uc)?.length||0)>0}const Cr="number",Ar="color",pc="var",mc="var(",Ci="${}",gc=/var\s*\(\s*--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)|#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\)|-?(?:\d+(?:\.\d+)?|\.\d+)/giu;function ut(e){const t=e.toString(),n=[],s={color:[],number:[],var:[]},i=[];let r=0;const a=t.replace(gc,c=>(re.test(c)?(s.color.push(r),i.push(Ar),n.push(re.parse(c))):c.startsWith(mc)?(s.var.push(r),i.push(pc),n.push(c)):(s.number.push(r),i.push(Cr),n.push(parseFloat(c))),++r,Ci)).split(Ci);return{values:n,split:a,indexes:s,types:i}}function yc(e){return ut(e).values}function Pr({split:e,types:t}){const n=e.length;return s=>{let i="";for(let r=0;r<n;r++)if(i+=e[r],s[r]!==void 0){const o=t[r];o===Cr?i+=St(s[r]):o===Ar?i+=re.transform(s[r]):i+=s[r]}return i}}function wc(e){return Pr(ut(e))}const bc=e=>typeof e=="number"?0:re.test(e)?re.getAnimatableNone(e):e,xc=(e,t)=>typeof e=="number"?t?.trim().endsWith("/")?e:0:bc(e);function vc(e){const t=ut(e);return Pr(t)(t.values.map((s,i)=>xc(s,t.split[i])))}const Re={test:fc,parse:yc,createTransformer:wc,getAnimatableNone:vc};function Nn(e,t,n){return n<0&&(n+=1),n>1&&(n-=1),n<1/6?e+(t-e)*6*n:n<1/2?t:n<2/3?e+(t-e)*(2/3-n)*6:e}function kc({hue:e,saturation:t,lightness:n,alpha:s}){e/=360,t/=100,n/=100;let i=0,r=0,o=0;if(!t)i=r=o=n;else{const a=n<.5?n*(1+t):n+t-n*t,c=2*n-a;i=Nn(c,a,e+1/3),r=Nn(c,a,e),o=Nn(c,a,e-1/3)}return{red:Math.round(i*255),green:Math.round(r*255),blue:Math.round(o*255),alpha:s}}function pn(e,t){return n=>n>0?t:e}const ee=(e,t,n)=>e+(t-e)*n,Vn=(e,t,n)=>{const s=e*e,i=n*(t*t-s)+s;return i<0?0:Math.sqrt(i)},Tc=[rs,Ye,ct],Sc=e=>Tc.find(t=>t.test(e));function Ai(e){const t=Sc(e);if(!t)return!1;let n=t.parse(e);return t===ct&&(n=kc(n)),n}const Pi=(e,t)=>{const n=Ai(e),s=Ai(t);if(!n||!s)return pn(e,t);const i={...n};return r=>(i.red=Vn(n.red,s.red,r),i.green=Vn(n.green,s.green,r),i.blue=Vn(n.blue,s.blue,r),i.alpha=ee(n.alpha,s.alpha,r),Ye.transform(i))},as=new Set(["none","hidden"]);function Cc(e,t){return as.has(e)?n=>n<=0?e:t:n=>n>=1?t:e}function Ac(e,t){return n=>ee(e,t,n)}function Gs(e){return typeof e=="number"?Ac:typeof e=="string"?Ws(e)?pn:re.test(e)?Pi:Mc:Array.isArray(e)?Er:typeof e=="object"?re.test(e)?Pi:Pc:pn}function Er(e,t){const n=[...e],s=n.length,i=e.map((r,o)=>Gs(r)(r,t[o]));return r=>{for(let o=0;o<s;o++)n[o]=i[o](r);return n}}function Pc(e,t){const n={...e,...t},s={};for(const i in n)e[i]!==void 0&&t[i]!==void 0&&(s[i]=Gs(e[i])(e[i],t[i]));return i=>{for(const r in s)n[r]=s[r](i);return n}}function Ec(e,t){const n=[],s={color:0,var:0,number:0};for(let i=0;i<t.values.length;i++){const r=t.types[i],o=e.indexes[r][s[r]],a=e.values[o]??0;n[i]=a,s[r]++}return n}const Mc=(e,t)=>{const n=Re.createTransformer(t),s=ut(e),i=ut(t);return s.indexes.var.length===i.indexes.var.length&&s.indexes.color.length===i.indexes.color.length&&s.indexes.number.length>=i.indexes.number.length?as.has(e)&&!i.values.length||as.has(t)&&!s.values.length?Cc(e,t):Nt(Er(Ec(s,i),i.values),n):pn(e,t)};function Mr(e,t,n){return typeof e=="number"&&typeof t=="number"&&typeof n=="number"?ee(e,t,n):Gs(e)(e,t)}const Dc=e=>{const t=({timestamp:n})=>e(n);return{start:(n=!0)=>te.update(t,n),stop:()=>Ge(t),now:()=>pe.isProcessing?pe.timestamp:we.now()}},Dr=(e,t,n=10)=>{let s="";const i=Math.max(Math.round(t/n),2);for(let r=0;r<i;r++)s+=Math.round(e(r/(i-1))*1e4)/1e4+", ";return`linear(${s.substring(0,s.length-2)})`},Ks=2e4;function Qs(e,t=50,n=Ks,s){let i=0,r=e.next(i);for(;!r.done&&i<n;)i+=t,r=e.next(i);return i>=n?1/0:i}function Oc(e,t=100,n){const s=n({...e,keyframes:[0,t]}),i=Math.min(Qs(s),Ks);return{type:"keyframes",ease:r=>s.next(i*r).value/t,duration:Ce(i)}}const ie={stiffness:100,damping:10,mass:1,velocity:0,duration:800,bounce:.3,visualDuration:.3,restSpeed:{granular:.01,default:2},restDelta:{granular:.005,default:.5},minDuration:.01,maxDuration:10,minDamping:.05,maxDamping:1};function ls(e,t){return e*Math.sqrt(1-t*t)}const Rc=12;function jc(e,t,n){let s=n;for(let i=1;i<Rc;i++)s=s-e(s)/t(s);return s}const In=.001;function Lc({duration:e=ie.duration,bounce:t=ie.bounce,velocity:n=ie.velocity,mass:s=ie.mass}){let i,r,o=1-t;o=$e(ie.minDamping,ie.maxDamping,o),e=$e(ie.minDuration,ie.maxDuration,Ce(e)),o<1?(i=l=>{const d=l*o,f=d*e,u=d-n,m=ls(l,o),y=Math.exp(-f);return In-u/m*y},r=l=>{const f=l*o*e,u=f*n+n,m=o*o*l*l*e,y=Math.exp(-f),b=ls(l*l,o);return(-i(l)+In>0?-1:1)*((u-m)*y)/b}):(i=l=>{const d=Math.exp(-l*e),f=(l-n)*e+1;return-In+d*f},r=l=>{const d=Math.exp(-l*e),f=(n-l)*(e*e);return d*f});const a=5/e,c=jc(i,r,a);if(e=Pe(e),isNaN(c))return{stiffness:ie.stiffness,damping:ie.damping,duration:e};{const l=c*c*s;return{stiffness:l,damping:o*2*Math.sqrt(s*l),duration:e}}}const Nc=["duration","bounce"],Vc=["stiffness","damping","mass"];function Ei(e,t){return t.some(n=>e[n]!==void 0)}function Ic(e){let t={velocity:ie.velocity,stiffness:ie.stiffness,damping:ie.damping,mass:ie.mass,isResolvedFromDuration:!1,...e};if(!Ei(e,Vc)&&Ei(e,Nc))if(t.velocity=0,e.visualDuration){const n=e.visualDuration,s=2*Math.PI/(n*1.2),i=s*s,r=2*$e(.05,1,1-(e.bounce||0))*Math.sqrt(i);t={...t,mass:ie.mass,stiffness:i,damping:r}}else{const n=Lc({...e,velocity:0});t={...t,...n,mass:ie.mass},t.isResolvedFromDuration=!0}return t}function mn(e=ie.visualDuration,t=ie.bounce){const n=typeof e!="object"?{visualDuration:e,keyframes:[0,1],bounce:t}:e;let{restSpeed:s,restDelta:i}=n;const r=n.keyframes[0],o=n.keyframes[n.keyframes.length-1],a={done:!1,value:r},{stiffness:c,damping:l,mass:d,duration:f,velocity:u,isResolvedFromDuration:m}=Ic({...n,velocity:-Ce(n.velocity||0)}),y=u||0,b=l/(2*Math.sqrt(c*d)),w=o-r,x=Ce(Math.sqrt(c/d)),S=b*x,v=Math.abs(w)<5;s||(s=v?ie.restSpeed.granular:ie.restSpeed.default),i||(i=v?ie.restDelta.granular:ie.restDelta.default);let g,k;if(b<1){const C=ls(x,b),E=(y+S*w)/C,N=S*E+w*C,z=S*w-E*C;let _=-1,I=0,R=0;const H=Z=>{if(Z!==_){_=Z;const ne=Math.exp(-S*Z),fe=Math.sin(C*Z),O=Math.cos(C*Z);I=o-ne*(E*fe+w*O),R=ne*(N*fe+z*O)}};g=Z=>(H(Z),I),k=Z=>(H(Z),R)}else if(b===1){g=E=>o-Math.exp(-x*E)*(w+(y+x*w)*E);const C=y+x*w;k=E=>Math.exp(-x*E)*(x*C*E-y)}else{const C=x*Math.sqrt(b*b-1);g=_=>{const I=Math.exp(-S*_),R=Math.min(C*_,300);return o-I*((y+S*w)*Math.sinh(R)+C*w*Math.cosh(R))/C};const E=(y+S*w)/C,N=S*E-w*C,z=S*w-E*C;k=_=>{const I=Math.exp(-S*_),R=Math.min(C*_,300);return I*(N*Math.sinh(R)+z*Math.cosh(R))}}const P={calculatedDuration:m&&f||null,velocity:C=>Pe(k(C)),next:C=>{const E=g(C);if(m)a.done=C>=f;else{const N=Pe(k(C));a.done=Math.abs(N)<=s&&Math.abs(o-E)<=i}return a.value=a.done?o:E,a},toString:()=>{const C=Math.min(Qs(P),Ks),E=Dr(N=>P.next(C*N).value,C,30);return C+"ms "+E},toTransition:()=>{}};return P}mn.applyToOptions=e=>{const t=Oc(e,100,mn);return e.ease=t.ease,e.duration=Pe(t.duration),e.type="keyframes",e};function cs({keyframes:e,velocity:t=0,power:n=.8,timeConstant:s=325,bounceDamping:i=10,bounceStiffness:r=500,modifyTarget:o,min:a,max:c,restDelta:l=.5,restSpeed:d}){const f=e[0],u={done:!1,value:f},m=C=>C<a||C>c,y=C=>a===void 0?c:c===void 0||Math.abs(a-C)<Math.abs(c-C)?a:c;let b=n*t;const w=f+b,x=o===void 0?w:o(w);x!==w&&(b=x-f);const S=C=>-b*Math.exp(-C/s),v=C=>{const E=S(C);u.done=Math.abs(E)<=l,u.value=u.done?x:x+E};let g,k;const P=C=>{m(u.value)&&(g=C,k=mn({keyframes:[u.value,y(u.value)],velocity:-S(C)/s*1e3,damping:i,stiffness:r,restDelta:l,restSpeed:d}))};return P(0),{calculatedDuration:null,next:C=>{let E=!1;return!k&&g===void 0&&(E=!0,v(C),P(C)),g!==void 0&&C>=g?k.next(C-g):(!E&&v(C),u)}}}function Bc(e,t,n){const s=[],i=n||Ue.mix||Mr,r=e.length-1;for(let o=0;o<r;o++){let a=i(e[o],e[o+1]);if(t){const c=Array.isArray(t)?t[o]||Ae:t;a=Nt(c,a)}s.push(a)}return s}function $c(e,t,{clamp:n=!0,ease:s,mixer:i}={}){const r=e.length;if(Tn(r===t.length),r===1)return()=>t[0];if(r===2&&t[0]===t[1])return()=>t[1];const o=e[0]===e[1];e[0]>e[r-1]&&(e=[...e].reverse(),t=[...t].reverse());const a=Bc(t,s,i),c=a.length,l=d=>{if(o&&d<e[0])return t[0];let f=0;if(c>1)for(;f<e.length-2&&!(d<e[f+1]);f++);const u=Ot(e[f],e[f+1],d);return a[f](u)};return n?d=>l($e(e[0],e[r-1],d)):l}function Fc(e,t){const n=e[e.length-1];for(let s=1;s<=t;s++){const i=Ot(0,t,s);e.push(ee(n,1,i))}}function _c(e){const t=[0];return Fc(t,e.length-1),t}function Hc(e,t){return e.map(n=>n*t)}function Wc(e,t){return e.map(()=>t||br).splice(0,e.length-1)}function Ct({duration:e=300,keyframes:t,times:n,ease:s="easeInOut"}){const i=Zl(s)?s.map(ki):ki(s),r={done:!1,value:t[0]},o=Hc(n&&n.length===t.length?n:_c(t),e),a=$c(o,t,{ease:Array.isArray(i)?i:Wc(t,i)});return{calculatedDuration:e,next:c=>(r.value=a(c),r.done=c>=e,r)}}const zc=5;function Uc(e,t,n){const s=Math.max(t-zc,0);return dr(n-e(s),t-s)}const Gc=e=>e!==null;function Sn(e,{repeat:t,repeatType:n="loop"},s,i=1){const r=e.filter(Gc),a=i<0||t&&n!=="loop"&&t%2===1?0:r.length-1;return!a||s===void 0?r[a]:s}const Kc={decay:cs,inertia:cs,tween:Ct,keyframes:Ct,spring:mn};function Or(e){typeof e.type=="string"&&(e.type=Kc[e.type])}class qs{constructor(){this.updateFinished()}get finished(){return this._finished}updateFinished(){this._finished=new Promise(t=>{this.resolve=t})}notifyFinished(){this.resolve()}then(t,n){return this.finished.then(t,n)}}const Qc=e=>e/100;class gn extends qs{constructor(t){super(),this.state="idle",this.startTime=null,this.isStopped=!1,this.currentTime=0,this.holdTime=null,this.playbackSpeed=1,this.delayState={done:!1,value:void 0},this.stop=()=>{const{motionValue:n}=this.options;n&&n.updatedAt!==we.now()&&this.tick(we.now()),this.isStopped=!0,this.state!=="idle"&&(this.teardown(),this.options.onStop?.())},this.options=t,this.initAnimation(),this.play(),t.autoplay===!1&&this.pause()}initAnimation(){const{options:t}=this;Or(t);const{type:n=Ct,repeat:s=0,repeatDelay:i=0,repeatType:r,velocity:o=0}=t;let{keyframes:a}=t;const c=n||Ct;c!==Ct&&typeof a[0]!="number"&&(this.mixKeyframes=Nt(Qc,Mr(a[0],a[1])),a=[0,100]);const l=c({...t,keyframes:a});r==="mirror"&&(this.mirroredGenerator=c({...t,keyframes:[...a].reverse(),velocity:-o})),l.calculatedDuration===null&&(l.calculatedDuration=Qs(l));const{calculatedDuration:d}=l;this.calculatedDuration=d,this.resolvedDuration=d+i,this.totalDuration=this.resolvedDuration*(s+1)-i,this.generator=l}updateTime(t){const n=Math.round(t-this.startTime)*this.playbackSpeed;this.holdTime!==null?this.currentTime=this.holdTime:this.currentTime=n}tick(t,n=!1){const{generator:s,totalDuration:i,mixKeyframes:r,mirroredGenerator:o,resolvedDuration:a,calculatedDuration:c}=this;if(this.startTime===null)return s.next(0);const{delay:l=0,keyframes:d,repeat:f,repeatType:u,repeatDelay:m,type:y,onUpdate:b,finalKeyframe:w}=this.options;this.speed>0?this.startTime=Math.min(this.startTime,t):this.speed<0&&(this.startTime=Math.min(t-i/this.speed,this.startTime)),n?this.currentTime=t:this.updateTime(t);const x=this.currentTime-l*(this.playbackSpeed>=0?1:-1),S=this.playbackSpeed>=0?x<0:x>i;this.currentTime=Math.max(x,0),this.state==="finished"&&this.holdTime===null&&(this.currentTime=i);let v=this.currentTime,g=s;if(f){const E=Math.min(this.currentTime,i)/a;let N=Math.floor(E),z=E%1;!z&&E>=1&&(z=1),z===1&&N--,N=Math.min(N,f+1),N%2&&(u==="reverse"?(z=1-z,m&&(z-=m/a)):u==="mirror"&&(g=o)),v=$e(0,1,z)*a}let k;S?(this.delayState.value=d[0],k=this.delayState):k=g.next(v),r&&!S&&(k.value=r(k.value));let{done:P}=k;!S&&c!==null&&(P=this.playbackSpeed>=0?this.currentTime>=i:this.currentTime<=0);const C=this.holdTime===null&&(this.state==="finished"||this.state==="running"&&P);return C&&y!==cs&&(k.value=Sn(d,this.options,w,this.speed)),b&&b(k.value),C&&this.finish(),k}then(t,n){return this.finished.then(t,n)}get duration(){return Ce(this.calculatedDuration)}get iterationDuration(){const{delay:t=0}=this.options||{};return this.duration+Ce(t)}get time(){return Ce(this.currentTime)}set time(t){t=Pe(t),this.currentTime=t,this.startTime===null||this.holdTime!==null||this.playbackSpeed===0?this.holdTime=t:this.driver&&(this.startTime=this.driver.now()-t/this.playbackSpeed),this.driver?this.driver.start(!1):(this.startTime=0,this.state="paused",this.holdTime=t,this.tick(t))}getGeneratorVelocity(){const t=this.currentTime;if(t<=0)return this.options.velocity||0;if(this.generator.velocity)return this.generator.velocity(t);const n=this.generator.next(t).value;return Uc(s=>this.generator.next(s).value,t,n)}get speed(){return this.playbackSpeed}set speed(t){const n=this.playbackSpeed!==t;n&&this.driver&&this.updateTime(we.now()),this.playbackSpeed=t,n&&this.driver&&(this.time=Ce(this.currentTime))}play(){if(this.isStopped)return;const{driver:t=Dc,startTime:n}=this.options;this.driver||(this.driver=t(i=>this.tick(i))),this.options.onPlay?.();const s=this.driver.now();this.state==="finished"?(this.updateFinished(),this.startTime=s):this.holdTime!==null?this.startTime=s-this.holdTime:this.startTime||(this.startTime=n??s),this.state==="finished"&&this.speed<0&&(this.startTime+=this.calculatedDuration),this.holdTime=null,this.state="running",this.driver.start()}pause(){this.state="paused",this.updateTime(we.now()),this.holdTime=this.currentTime}complete(){this.state!=="running"&&this.play(),this.state="finished",this.holdTime=null}finish(){this.notifyFinished(),this.teardown(),this.state="finished",this.options.onComplete?.()}cancel(){this.holdTime=null,this.startTime=0,this.tick(0),this.teardown(),this.options.onCancel?.()}teardown(){this.state="idle",this.stopDriver(),this.startTime=this.holdTime=null}stopDriver(){this.driver&&(this.driver.stop(),this.driver=void 0)}sample(t){return this.startTime=0,this.tick(t,!0)}attachTimeline(t){return this.options.allowFlatten&&(this.options.type="keyframes",this.options.ease="linear",this.initAnimation()),this.driver?.stop(),t.observe(this)}}function qc(e){for(let t=1;t<e.length;t++)e[t]??(e[t]=e[t-1])}const Ze=e=>e*180/Math.PI,ds=e=>{const t=Ze(Math.atan2(e[1],e[0]));return hs(t)},Xc={x:4,y:5,translateX:4,translateY:5,scaleX:0,scaleY:3,scale:e=>(Math.abs(e[0])+Math.abs(e[3]))/2,rotate:ds,rotateZ:ds,skewX:e=>Ze(Math.atan(e[1])),skewY:e=>Ze(Math.atan(e[2])),skew:e=>(Math.abs(e[1])+Math.abs(e[2]))/2},hs=e=>(e=e%360,e<0&&(e+=360),e),Mi=ds,Di=e=>Math.sqrt(e[0]*e[0]+e[1]*e[1]),Oi=e=>Math.sqrt(e[4]*e[4]+e[5]*e[5]),Yc={x:12,y:13,z:14,translateX:12,translateY:13,translateZ:14,scaleX:Di,scaleY:Oi,scale:e=>(Di(e)+Oi(e))/2,rotateX:e=>hs(Ze(Math.atan2(e[6],e[5]))),rotateY:e=>hs(Ze(Math.atan2(-e[2],e[0]))),rotateZ:Mi,rotate:Mi,skewX:e=>Ze(Math.atan(e[4])),skewY:e=>Ze(Math.atan(e[1])),skew:e=>(Math.abs(e[1])+Math.abs(e[4]))/2};function us(e){return e.includes("scale")?1:0}function fs(e,t){if(!e||e==="none")return us(t);const n=e.match(/^matrix3d\(([-\d.e\s,]+)\)$/u);let s,i;if(n)s=Yc,i=n;else{const a=e.match(/^matrix\(([-\d.e\s,]+)\)$/u);s=Xc,i=a}if(!i)return us(t);const r=s[t],o=i[1].split(",").map(Jc);return typeof r=="function"?r(o):o[r]}const Zc=(e,t)=>{const{transform:n="none"}=getComputedStyle(e);return fs(n,t)};function Jc(e){return parseFloat(e.trim())}const mt=["transformPerspective","x","y","z","translateX","translateY","translateZ","scale","scaleX","scaleY","rotate","rotateX","rotateY","rotateZ","skew","skewX","skewY"],gt=new Set([...mt,"pathRotation"]),Ri=e=>e===pt||e===L,ed=new Set(["x","y","z"]),td=mt.filter(e=>!ed.has(e));function nd(e){const t=[];return td.forEach(n=>{const s=e.getValue(n);s!==void 0&&(t.push([n,s.get()]),s.set(n.startsWith("scale")?1:0))}),t}const ze={width:({x:e},{paddingLeft:t="0",paddingRight:n="0",boxSizing:s})=>{const i=e.max-e.min;return s==="border-box"?i:i-parseFloat(t)-parseFloat(n)},height:({y:e},{paddingTop:t="0",paddingBottom:n="0",boxSizing:s})=>{const i=e.max-e.min;return s==="border-box"?i:i-parseFloat(t)-parseFloat(n)},top:(e,{top:t})=>parseFloat(t),left:(e,{left:t})=>parseFloat(t),bottom:({y:e},{top:t})=>parseFloat(t)+(e.max-e.min),right:({x:e},{left:t})=>parseFloat(t)+(e.max-e.min),x:(e,{transform:t})=>fs(t,"x"),y:(e,{transform:t})=>fs(t,"y")};ze.translateX=ze.x;ze.translateY=ze.y;const Je=new Set;let ps=!1,ms=!1,gs=!1;function Rr(){if(ms){const e=Array.from(Je).filter(s=>s.needsMeasurement),t=new Set(e.map(s=>s.element)),n=new Map;t.forEach(s=>{const i=nd(s);i.length&&(n.set(s,i),s.render())}),e.forEach(s=>s.measureInitialState()),t.forEach(s=>{s.render();const i=n.get(s);i&&i.forEach(([r,o])=>{s.getValue(r)?.set(o)})}),e.forEach(s=>s.measureEndState()),e.forEach(s=>{s.suspendedScrollY!==void 0&&window.scrollTo(0,s.suspendedScrollY)})}ms=!1,ps=!1,Je.forEach(e=>e.complete(gs)),Je.clear()}function jr(){Je.forEach(e=>{e.readKeyframes(),e.needsMeasurement&&(ms=!0)})}function sd(){gs=!0,jr(),Rr(),gs=!1}class Xs{constructor(t,n,s,i,r,o=!1){this.state="pending",this.isAsync=!1,this.needsMeasurement=!1,this.unresolvedKeyframes=[...t],this.onComplete=n,this.name=s,this.motionValue=i,this.element=r,this.isAsync=o}scheduleResolve(){this.state="scheduled",this.isAsync?(Je.add(this),ps||(ps=!0,te.read(jr),te.resolveKeyframes(Rr))):(this.readKeyframes(),this.complete())}readKeyframes(){const{unresolvedKeyframes:t,name:n,element:s,motionValue:i}=this;if(t[0]===null){const r=i?.get(),o=t[t.length-1];if(r!==void 0)t[0]=r;else if(s&&n){const a=s.readValue(n,o);a!=null&&(t[0]=a)}t[0]===void 0&&(t[0]=o),i&&r===void 0&&i.set(t[0])}qc(t)}setFinalKeyframe(){}measureInitialState(){}renderEndStyles(){}measureEndState(){}complete(t=!1){this.state="complete",this.onComplete(this.unresolvedKeyframes,this.finalKeyframe,t),Je.delete(this)}cancel(){this.state==="scheduled"&&(Je.delete(this),this.state="pending")}resume(){this.state==="pending"&&this.scheduleResolve()}}const id=e=>e.startsWith("--");function Lr(e,t,n){id(t)?e.style.setProperty(t,n):e.style[t]=n}const od={};function Nr(e,t){const n=cr(e);return()=>od[t]??n()}const rd=Nr(()=>window.ScrollTimeline!==void 0,"scrollTimeline"),Vr=Nr(()=>{try{document.createElement("div").animate({opacity:0},{easing:"linear(0, 1)"})}catch{return!1}return!0},"linearEasing"),vt=([e,t,n,s])=>`cubic-bezier(${e}, ${t}, ${n}, ${s})`,ji={linear:"linear",ease:"ease",easeIn:"ease-in",easeOut:"ease-out",easeInOut:"ease-in-out",circIn:vt([0,.65,.55,1]),circOut:vt([.55,0,1,.45]),backIn:vt([.31,.01,.66,-.59]),backOut:vt([.33,1.53,.69,.99])};function Ir(e,t){if(e)return typeof e=="function"?Vr()?Dr(e,t):"ease-out":xr(e)?vt(e):Array.isArray(e)?e.map(n=>Ir(n,t)||ji.easeOut):ji[e]}function ad(e,t,n,{delay:s=0,duration:i=300,repeat:r=0,repeatType:o="loop",ease:a="easeOut",times:c}={},l=void 0){const d={[t]:n};c&&(d.offset=c);const f=Ir(a,i);Array.isArray(f)&&(d.easing=f);const u={delay:s,duration:i,easing:Array.isArray(f)?"linear":f,fill:"both",iterations:r+1,direction:o==="reverse"?"alternate":"normal"};return l&&(u.pseudoElement=l),e.animate(d,u)}function Br(e){return typeof e=="function"&&"applyToOptions"in e}function ld({type:e,...t}){return Br(e)&&Vr()?e.applyToOptions(t):(t.duration??(t.duration=300),t.ease??(t.ease="easeOut"),t)}class $r extends qs{constructor(t){if(super(),this.finishedTime=null,this.isStopped=!1,this.manualStartTime=null,!t)return;const{element:n,name:s,keyframes:i,pseudoElement:r,allowFlatten:o=!1,finalKeyframe:a,onComplete:c}=t;this.isPseudoElement=!!r,this.allowFlatten=o,this.options=t,Tn(typeof t.type!="string");const l=ld(t);this.animation=ad(n,s,i,l,r),l.autoplay===!1&&this.animation.pause(),this.animation.onfinish=()=>{if(this.finishedTime=this.time,!r){const d=Sn(i,this.options,a,this.speed);this.updateMotionValue&&this.updateMotionValue(d),Lr(n,s,d),this.animation.cancel()}c?.(),this.notifyFinished()}}play(){this.isStopped||(this.manualStartTime=null,this.animation.play(),this.state==="finished"&&this.updateFinished())}pause(){this.animation.pause()}complete(){this.animation.finish?.()}cancel(){try{this.animation.cancel()}catch{}}stop(){if(this.isStopped)return;this.isStopped=!0;const{state:t}=this;t==="idle"||t==="finished"||(this.updateMotionValue?this.updateMotionValue():this.commitStyles(),this.isPseudoElement||this.cancel())}commitStyles(){const t=this.options?.element;!this.isPseudoElement&&t?.isConnected&&this.animation.commitStyles?.()}get duration(){const t=this.animation.effect?.getComputedTiming?.().duration||0;return Ce(Number(t))}get iterationDuration(){const{delay:t=0}=this.options||{};return this.duration+Ce(t)}get time(){return Ce(Number(this.animation.currentTime)||0)}set time(t){const n=this.finishedTime!==null;this.manualStartTime=null,this.finishedTime=null,this.animation.currentTime=Pe(t),n&&this.animation.pause()}get speed(){return this.animation.playbackRate}set speed(t){t<0&&(this.finishedTime=null),this.animation.playbackRate=t}get state(){return this.finishedTime!==null?"finished":this.animation.playState}get startTime(){return this.manualStartTime??Number(this.animation.startTime)}set startTime(t){this.manualStartTime=this.animation.startTime=t}attachTimeline({timeline:t,rangeStart:n,rangeEnd:s,observe:i}){return this.allowFlatten&&this.animation.effect?.updateTiming({easing:"linear"}),this.animation.onfinish=null,t&&rd()?(this.animation.timeline=t,n&&(this.animation.rangeStart=n),s&&(this.animation.rangeEnd=s),Ae):i(this)}}const Fr={anticipate:gr,backInOut:mr,circInOut:wr};function cd(e){return e in Fr}function dd(e){typeof e.ease=="string"&&cd(e.ease)&&(e.ease=Fr[e.ease])}const Bn=10;class hd extends $r{constructor(t){dd(t),Or(t),super(t),t.startTime!==void 0&&t.autoplay!==!1&&(this.startTime=t.startTime),this.options=t}updateMotionValue(t){const{motionValue:n,onUpdate:s,onComplete:i,element:r,...o}=this.options;if(!n)return;if(t!==void 0){n.set(t);return}const a=new gn({...o,autoplay:!1}),c=Math.max(Bn,we.now()-this.startTime),l=$e(0,Bn,c-Bn),d=a.sample(c).value,{name:f}=this.options;r&&f&&Lr(r,f,d),n.setWithVelocity(a.sample(Math.max(0,c-l)).value,d,l),a.stop()}}const Li=(e,t)=>t==="zIndex"?!1:!!(typeof e=="number"||Array.isArray(e)||typeof e=="string"&&(Re.test(e)||e==="0")&&!e.startsWith("url("));function ud(e){const t=e[0];if(e.length===1)return!0;for(let n=0;n<e.length;n++)if(e[n]!==t)return!0}function fd(e,t,n,s){const i=e[0];if(i===null)return!1;if(t==="display"||t==="visibility")return!0;const r=e[e.length-1],o=Li(i,t),a=Li(r,t);return!o||!a?!1:ud(e)||(n==="spring"||Br(n))&&s}function ys(e){e.duration=0,e.type="keyframes"}const _r=new Set(["opacity","clipPath","filter","transform","backgroundColor"]),pd=/^(?:oklch|oklab|lab|lch|color|color-mix|light-dark)\(/;function md(e){for(let t=0;t<e.length;t++)if(typeof e[t]=="string"&&pd.test(e[t]))return!0;return!1}const gd=new Set(["color","backgroundColor","outlineColor","fill","stroke","borderColor","borderTopColor","borderRightColor","borderBottomColor","borderLeftColor"]),yd=cr(()=>Object.hasOwnProperty.call(Element.prototype,"animate"));function wd(e){const{motionValue:t,name:n,repeatDelay:s,repeatType:i,damping:r,type:o,keyframes:a}=e,c=t?.owner?.current;if(!(c instanceof HTMLElement)&&!(c instanceof SVGElement))return!1;const{onUpdate:l,transformTemplate:d}=t.owner.getProps();return yd()&&n&&(_r.has(n)||gd.has(n)&&md(a))&&(n!=="transform"||!d)&&!l&&!s&&i!=="mirror"&&r!==0&&o!=="inertia"}const bd=40;class xd extends qs{constructor({autoplay:t=!0,delay:n=0,type:s="keyframes",repeat:i=0,repeatDelay:r=0,repeatType:o="loop",keyframes:a,name:c,motionValue:l,element:d,...f}){super(),this.stop=()=>{this._animation&&(this._animation.stop(),this.stopTimeline?.()),this.keyframeResolver?.cancel()},this.createdAt=we.now();const u={autoplay:t,delay:n,type:s,repeat:i,repeatDelay:r,repeatType:o,name:c,motionValue:l,element:d,...f},m=d?.KeyframeResolver||Xs;this.keyframeResolver=new m(a,(y,b,w)=>this.onKeyframesResolved(y,b,u,!w),c,l,d),this.keyframeResolver?.scheduleResolve()}onKeyframesResolved(t,n,s,i){this.keyframeResolver=void 0;const{name:r,type:o,velocity:a,delay:c,isHandoff:l,onUpdate:d}=s;this.resolvedAt=we.now();let f=!0;fd(t,r,o,a)||(f=!1,(Ue.instantAnimations||!c)&&d?.(Sn(t,s,n)),t[0]=t[t.length-1],ys(s),s.repeat=0);const m={startTime:i?this.resolvedAt?this.resolvedAt-this.createdAt>bd?this.resolvedAt:this.createdAt:this.createdAt:void 0,finalKeyframe:n,...s,keyframes:t},y=f&&!l&&wd(m),b=m.motionValue?.owner?.current;let w;if(y)try{w=new hd({...m,element:b})}catch{w=new gn(m)}else w=new gn(m);w.finished.then(()=>{this.notifyFinished()}).catch(Ae),this.pendingTimeline&&(this.stopTimeline=w.attachTimeline(this.pendingTimeline),this.pendingTimeline=void 0),this._animation=w}get finished(){return this._animation?this.animation.finished:this._finished}then(t,n){return this.finished.finally(t).then(()=>{})}get animation(){return this._animation||(this.keyframeResolver?.resume(),sd()),this._animation}get duration(){return this.animation.duration}get iterationDuration(){return this.animation.iterationDuration}get time(){return this.animation.time}set time(t){this.animation.time=t}get speed(){return this.animation.speed}get state(){return this.animation.state}set speed(t){this.animation.speed=t}get startTime(){return this.animation.startTime}attachTimeline(t){return this._animation?this.stopTimeline=this.animation.attachTimeline(t):this.pendingTimeline=t,()=>this.stop()}play(){this.animation.play()}pause(){this.animation.pause()}complete(){this.animation.complete()}cancel(){this._animation&&this.animation.cancel(),this.keyframeResolver?.cancel()}}function Hr(e,t,n,s=0,i=1){const r=Array.from(e).sort((l,d)=>l.sortNodePosition(d)).indexOf(t),o=e.size,a=(o-1)*s;return typeof n=="function"?n(r,o):i===1?r*s:a-r*s}const Ni=30,vd=e=>!isNaN(parseFloat(e));class kd{constructor(t,n={}){this.canTrackVelocity=null,this.events={},this.updateAndNotify=s=>{const i=we.now();if(this.updatedAt!==i&&this.setPrevFrameValue(),this.prev=this.current,this.setCurrent(s),this.current!==this.prev&&(this.events.change?.notify(this.current),this.dependents))for(const r of this.dependents)r.dirty()},this.hasAnimated=!1,this.setCurrent(t),this.owner=n.owner}setCurrent(t){this.current=t,this.updatedAt=we.now(),this.canTrackVelocity===null&&t!==void 0&&(this.canTrackVelocity=vd(this.current))}setPrevFrameValue(t=this.current){this.prevFrameValue=t,this.prevUpdatedAt=this.updatedAt}onChange(t){return this.on("change",t)}on(t,n){this.events[t]||(this.events[t]=new Fs);const s=this.events[t].add(n);return t==="change"?()=>{s(),te.read(()=>{this.events.change.getSize()||this.stop()})}:s}clearListeners(){for(const t in this.events)this.events[t].clear()}attach(t,n){this.passiveEffect=t,this.stopPassiveEffect=n}set(t){this.passiveEffect?this.passiveEffect(t,this.updateAndNotify):this.updateAndNotify(t)}setWithVelocity(t,n,s){this.set(n),this.prev=void 0,this.prevFrameValue=t,this.prevUpdatedAt=this.updatedAt-s}jump(t,n=!0){this.updateAndNotify(t),this.prev=t,this.prevUpdatedAt=this.prevFrameValue=void 0,n&&this.stop(),this.stopPassiveEffect&&this.stopPassiveEffect()}dirty(){this.events.change?.notify(this.current)}addDependent(t){this.dependents||(this.dependents=new Set),this.dependents.add(t)}removeDependent(t){this.dependents&&this.dependents.delete(t)}get(){return this.current}getPrevious(){return this.prev}getVelocity(){const t=we.now();if(!this.canTrackVelocity||this.prevFrameValue===void 0||t-this.updatedAt>Ni)return 0;const n=Math.min(this.updatedAt-this.prevUpdatedAt,Ni);return dr(parseFloat(this.current)-parseFloat(this.prevFrameValue),n)}start(t){return this.stop(),new Promise(n=>{this.hasAnimated=!0,this.animation=t(n),this.events.animationStart&&this.events.animationStart.notify()}).then(()=>{this.events.animationComplete&&this.events.animationComplete.notify(),this.clearAnimation()})}stop(){this.animation&&(this.animation.stop(),this.events.animationCancel&&this.events.animationCancel.notify()),this.clearAnimation()}isAnimating(){return!!this.animation}clearAnimation(){delete this.animation}destroy(){this.dependents?.clear(),this.events.destroy?.notify(),this.clearListeners(),this.stop(),this.stopPassiveEffect&&this.stopPassiveEffect()}}function ft(e,t){return new kd(e,t)}function Wr(e,t){if(e?.inherit&&t){const{inherit:n,...s}=e;return{...t,...s}}return e}function Ys(e,t){const n=e?.[t]??e?.default??e;return n!==e?Wr(n,e):n}const Td={type:"spring",stiffness:500,damping:25,restSpeed:10},Sd=e=>({type:"spring",stiffness:550,damping:e===0?2*Math.sqrt(550):30,restSpeed:10}),Cd={type:"keyframes",duration:.8},Ad={type:"keyframes",ease:[.25,.1,.35,1],duration:.3},Pd=(e,{keyframes:t})=>t.length>2?Cd:gt.has(e)?e.startsWith("scale")?Sd(t[1]):Td:Ad,Ed=new Set(["when","delay","delayChildren","staggerChildren","staggerDirection","repeat","repeatType","repeatDelay","from","elapsed"]);function Md(e){for(const t in e)if(!Ed.has(t))return!0;return!1}const Zs=(e,t,n,s={},i,r)=>o=>{const a=Ys(s,e)||{},c=a.delay||s.delay||0;let{elapsed:l=0}=s;l=l-Pe(c);const d={keyframes:Array.isArray(n)?n:[null,n],ease:"easeOut",velocity:t.getVelocity(),...a,delay:-l,onUpdate:u=>{t.set(u),a.onUpdate&&a.onUpdate(u)},onComplete:()=>{o(),a.onComplete&&a.onComplete()},name:e,motionValue:t,element:r?void 0:i};Md(a)||Object.assign(d,Pd(e,d)),d.duration&&(d.duration=Pe(d.duration)),d.repeatDelay&&(d.repeatDelay=Pe(d.repeatDelay)),d.from!==void 0&&(d.keyframes[0]=d.from);let f=!1;if((d.type===!1||d.duration===0&&!d.repeatDelay)&&(ys(d),d.delay===0&&(f=!0)),(Ue.instantAnimations||Ue.skipAnimations||i?.shouldSkipAnimations||a.skipAnimations)&&(f=!0,ys(d),d.delay=0),d.allowFlatten=!a.type&&!a.ease,f&&!r&&t.get()!==void 0){const u=Sn(d.keyframes,a);if(u!==void 0){te.update(()=>{d.onUpdate(u),d.onComplete()});return}}return a.isSync?new gn(d):new xd(d)},Dd=/^var\(--(?:([\w-]+)|([\w-]+), ?([a-zA-Z\d ()%#.,-]+))\)/u;function Od(e){const t=Dd.exec(e);if(!t)return[,];const[,n,s,i]=t;return[`--${n??s}`,i]}function zr(e,t,n=1){const[s,i]=Od(e);if(!s)return;const r=window.getComputedStyle(t).getPropertyValue(s);if(r){const o=r.trim();return rr(o)?parseFloat(o):o}return Ws(i)?zr(i,t,n+1):i}function Vi(e){const t=[{},{}];return e?.values.forEach((n,s)=>{t[0][s]=n.get(),t[1][s]=n.getVelocity()}),t}function Js(e,t,n,s){if(typeof t=="function"){const[i,r]=Vi(s);t=t(n!==void 0?n:e.custom,i,r)}if(typeof t=="string"&&(t=e.variants&&e.variants[t]),typeof t=="function"){const[i,r]=Vi(s);t=t(n!==void 0?n:e.custom,i,r)}return t}function et(e,t,n){const s=e.getProps();return Js(s,t,n!==void 0?n:s.custom,e)}const Ur=new Set(["width","height","top","left","right","bottom",...mt]),ws=e=>Array.isArray(e);function Rd(e,t,n){e.hasValue(t)?e.getValue(t).set(n):e.addValue(t,ft(n))}function jd(e){return ws(e)?e[e.length-1]||0:e}function Ld(e,t){const n=et(e,t);let{transitionEnd:s={},transition:i={},...r}=n||{};r={...r,...s};for(const o in r){const a=jd(r[o]);Rd(e,o,a)}}const me=e=>!!(e&&e.getVelocity);function Nd(e){return!!(me(e)&&e.add)}function bs(e,t){const n=e.getValue("willChange");if(Nd(n))return n.add(t);if(!n&&Ue.WillChange){const s=new Ue.WillChange("auto");e.addValue("willChange",s),s.add(t)}}function ei(e){return e.replace(/([A-Z])/g,t=>`-${t.toLowerCase()}`)}const Vd="framerAppearId",Gr="data-"+ei(Vd);function Kr(e){return e.props[Gr]}const Id=typeof window<"u";function Bd({protectedKeys:e,needsAnimating:t},n){const s=e.hasOwnProperty(n)&&t[n]!==!0;return t[n]=!1,s}function Qr(e,t,{delay:n=0,transitionOverride:s,type:i}={}){let{transition:r,transitionEnd:o,...a}=t;const c=e.getDefaultTransition();r=r?Wr(r,c):c;const l=r?.reduceMotion,d=r?.skipAnimations;s&&(r=s);const f=[],u=i&&e.animationState&&e.animationState.getState()[i],m=r?.path;m&&m.animateVisualElement(e,a,r,n,f);for(const y in a){const b=e.getValue(y,e.latestValues[y]??null),w=a[y];if(w===void 0||u&&Bd(u,y))continue;const x={delay:n,...Ys(r||{},y)};d&&(x.skipAnimations=!0);const S=b.get();if(S!==void 0&&!b.isAnimating()&&!Array.isArray(w)&&w===S&&!x.velocity){te.update(()=>b.set(w));continue}let v=!1;if(Id&&window.MotionHandoffAnimation){const P=Kr(e);if(P){const C=window.MotionHandoffAnimation(P,y,te);C!==null&&(x.startTime=C,v=!0)}}bs(e,y);const g=l??e.shouldReduceMotion;b.start(Zs(y,b,w,g&&Ur.has(y)?{type:!1}:x,e,v));const k=b.animation;k&&f.push(k)}if(o){const y=()=>te.update(()=>{o&&Ld(e,o)});f.length?Promise.all(f).then(y):y()}return f}function xs(e,t,n={}){const s=et(e,t,n.type==="exit"?e.presenceContext?.custom:void 0);let{transition:i=e.getDefaultTransition()||{}}=s||{};n.transitionOverride&&(i=n.transitionOverride);const r=s?()=>Promise.all(Qr(e,s,n)):()=>Promise.resolve(),o=e.variantChildren&&e.variantChildren.size?(c=0)=>{const{delayChildren:l=0,staggerChildren:d,staggerDirection:f}=i;return $d(e,t,c,l,d,f,n)}:()=>Promise.resolve(),{when:a}=i;if(a){const[c,l]=a==="beforeChildren"?[r,o]:[o,r];return c().then(()=>l())}else return Promise.all([r(),o(n.delay)])}function $d(e,t,n=0,s=0,i=0,r=1,o){const a=[];for(const c of e.variantChildren)c.notify("AnimationStart",t),a.push(xs(c,t,{...o,delay:n+(typeof s=="function"?0:s)+Hr(e.variantChildren,c,s,i,r)}).then(()=>c.notify("AnimationComplete",t)));return Promise.all(a)}function Fd(e,t,n={}){e.notify("AnimationStart",t);let s;if(Array.isArray(t)){const i=t.map(r=>xs(e,r,n));s=Promise.all(i)}else if(typeof t=="string")s=xs(e,t,n);else{const i=typeof t=="function"?et(e,t,n.custom):t;s=Promise.all(Qr(e,i,n))}return s.then(()=>{e.notify("AnimationComplete",t)})}const _d={test:e=>e==="auto",parse:e=>e},qr=e=>t=>t.test(e),Xr=[pt,L,Be,Fe,hc,dc,_d],Ii=e=>Xr.find(qr(e));function Hd(e){return typeof e=="number"?e===0:e!==null?e==="none"||e==="0"||lr(e):!0}const Wd=new Set(["brightness","contrast","saturate","opacity"]);function zd(e){const[t,n]=e.slice(0,-1).split("(");if(t==="drop-shadow")return e;const[s]=n.match(zs)||[];if(!s)return e;const i=n.replace(s,"");let r=Wd.has(t)?1:0;return s!==n&&(r*=100),t+"("+r+i+")"}const Ud=/\b([a-z-]*)\(.*?\)/gu,vs={...Re,getAnimatableNone:e=>{const t=e.match(Ud);return t?t.map(zd).join(" "):e}},ks={...Re,getAnimatableNone:e=>{const t=Re.parse(e);return Re.createTransformer(e)(t.map(s=>typeof s=="number"?0:typeof s=="object"?{...s,alpha:1}:s))}},Bi={...pt,transform:Math.round},Gd={rotate:Fe,pathRotation:Fe,rotateX:Fe,rotateY:Fe,rotateZ:Fe,scale:Ut,scaleX:Ut,scaleY:Ut,scaleZ:Ut,skew:Fe,skewX:Fe,skewY:Fe,distance:L,translateX:L,translateY:L,translateZ:L,x:L,y:L,z:L,perspective:L,transformPerspective:L,opacity:Rt,originX:Si,originY:Si,originZ:L},yn={borderWidth:L,borderTopWidth:L,borderRightWidth:L,borderBottomWidth:L,borderLeftWidth:L,borderRadius:L,borderTopLeftRadius:L,borderTopRightRadius:L,borderBottomRightRadius:L,borderBottomLeftRadius:L,width:L,maxWidth:L,height:L,maxHeight:L,top:L,right:L,bottom:L,left:L,inset:L,insetBlock:L,insetBlockStart:L,insetBlockEnd:L,insetInline:L,insetInlineStart:L,insetInlineEnd:L,padding:L,paddingTop:L,paddingRight:L,paddingBottom:L,paddingLeft:L,paddingBlock:L,paddingBlockStart:L,paddingBlockEnd:L,paddingInline:L,paddingInlineStart:L,paddingInlineEnd:L,margin:L,marginTop:L,marginRight:L,marginBottom:L,marginLeft:L,marginBlock:L,marginBlockStart:L,marginBlockEnd:L,marginInline:L,marginInlineStart:L,marginInlineEnd:L,fontSize:L,backgroundPositionX:L,backgroundPositionY:L,...Gd,zIndex:Bi,fillOpacity:Rt,strokeOpacity:Rt,numOctaves:Bi},Kd={...yn,color:re,backgroundColor:re,outlineColor:re,fill:re,stroke:re,borderColor:re,borderTopColor:re,borderRightColor:re,borderBottomColor:re,borderLeftColor:re,filter:vs,WebkitFilter:vs,mask:ks,WebkitMask:ks},Yr=e=>Kd[e],Qd=new Set([vs,ks]);function Zr(e,t){let n=Yr(e);return Qd.has(n)||(n=Re),n.getAnimatableNone?n.getAnimatableNone(t):void 0}const qd=new Set(["auto","none","0"]);function Xd(e,t,n){let s=0,i;for(;s<e.length&&!i;){const r=e[s];typeof r=="string"&&!qd.has(r)&&ut(r).values.length&&(i=e[s]),s++}if(i&&n)for(const r of t)e[r]=Zr(n,i)}class Yd extends Xs{constructor(t,n,s,i,r){super(t,n,s,i,r,!0)}readKeyframes(){const{unresolvedKeyframes:t,element:n,name:s}=this;if(!n||!n.current)return;super.readKeyframes();for(let d=0;d<t.length;d++){let f=t[d];if(typeof f=="string"&&(f=f.trim(),Ws(f))){const u=zr(f,n.current);u!==void 0&&(t[d]=u),d===t.length-1&&(this.finalKeyframe=f)}}if(this.resolveNoneKeyframes(),!Ur.has(s)||t.length!==2)return;const[i,r]=t,o=Ii(i),a=Ii(r),c=Ti(i),l=Ti(r);if(c!==l&&ze[s]){this.needsMeasurement=!0;return}if(o!==a)if(Ri(o)&&Ri(a))for(let d=0;d<t.length;d++){const f=t[d];typeof f=="string"&&(t[d]=parseFloat(f))}else ze[s]&&(this.needsMeasurement=!0)}resolveNoneKeyframes(){const{unresolvedKeyframes:t,name:n}=this,s=[];for(let i=0;i<t.length;i++)(t[i]===null||Hd(t[i]))&&s.push(i);s.length&&Xd(t,s,n)}measureInitialState(){const{element:t,unresolvedKeyframes:n,name:s}=this;if(!t||!t.current)return;s==="height"&&(this.suspendedScrollY=window.pageYOffset),this.measuredOrigin=ze[s](t.measureViewportBox(),window.getComputedStyle(t.current)),n[0]=this.measuredOrigin;const i=n[n.length-1];i!==void 0&&t.getValue(s,i).jump(i,!1)}measureEndState(){const{element:t,name:n,unresolvedKeyframes:s}=this;if(!t||!t.current)return;const i=t.getValue(n);i&&i.jump(this.measuredOrigin,!1);const r=s.length-1,o=s[r];s[r]=ze[n](t.measureViewportBox(),window.getComputedStyle(t.current)),o!==null&&this.finalKeyframe===void 0&&(this.finalKeyframe=o),this.removedTransforms?.length&&this.removedTransforms.forEach(([a,c])=>{t.getValue(a).set(c)}),this.resolveNoneKeyframes()}}const ti=["borderTopLeftRadius","borderTopRightRadius","borderBottomRightRadius","borderBottomLeftRadius"];function Jr(e,t,n){if(e==null)return[];if(e instanceof EventTarget)return[e];if(typeof e=="string"){let s=document;const i=n?.[e]??s.querySelectorAll(e);return i?Array.from(i):[]}return Array.from(e).filter(s=>s!=null)}const Ts=(e,t)=>t&&typeof e=="number"?t.transform(e):e;function sn(e){return ar(e)&&"offsetHeight"in e&&!("ownerSVGElement"in e)}const{schedule:ni}=vr(queueMicrotask,!1),Oe={x:!1,y:!1};function ea(){return Oe.x||Oe.y}function Zd(e){return e==="x"||e==="y"?Oe[e]?null:(Oe[e]=!0,()=>{Oe[e]=!1}):Oe.x||Oe.y?null:(Oe.x=Oe.y=!0,()=>{Oe.x=Oe.y=!1})}function ta(e,t){const n=Jr(e),s=new AbortController,i={passive:!0,...t,signal:s.signal};return[n,i,()=>s.abort()]}function Jd(e){return!(e.pointerType==="touch"||ea())}function eh(e,t,n={}){const[s,i,r]=ta(e,n);return s.forEach(o=>{let a=!1,c=!1,l;const d=()=>{o.removeEventListener("pointerleave",y)},f=w=>{l&&(l(w),l=void 0),d()},u=w=>{a=!1,window.removeEventListener("pointerup",u),window.removeEventListener("pointercancel",u),c&&(c=!1,f(w))},m=()=>{a=!0,window.addEventListener("pointerup",u,i),window.addEventListener("pointercancel",u,i)},y=w=>{if(w.pointerType!=="touch"){if(a){c=!0;return}f(w)}},b=w=>{if(!Jd(w))return;c=!1;const x=t(o,w);typeof x=="function"&&(l=x,o.addEventListener("pointerleave",y,i))};o.addEventListener("pointerenter",b,i),o.addEventListener("pointerdown",m,i)}),r}const na=(e,t)=>t?e===t?!0:na(e,t.parentElement):!1,si=e=>e.pointerType==="mouse"?typeof e.button!="number"||e.button<=0:e.isPrimary!==!1,th=new Set(["BUTTON","INPUT","SELECT","TEXTAREA","A"]);function nh(e){return th.has(e.tagName)||e.isContentEditable===!0}const sh=new Set(["INPUT","SELECT","TEXTAREA"]);function ih(e){return sh.has(e.tagName)||e.isContentEditable===!0}const on=new WeakSet;function $i(e){return t=>{t.key==="Enter"&&e(t)}}function $n(e,t){e.dispatchEvent(new PointerEvent("pointer"+t,{isPrimary:!0,bubbles:!0}))}const oh=(e,t)=>{const n=e.currentTarget;if(!n)return;const s=$i(()=>{if(on.has(n))return;$n(n,"down");const i=$i(()=>{$n(n,"up")}),r=()=>$n(n,"cancel");n.addEventListener("keyup",i,t),n.addEventListener("blur",r,t)});n.addEventListener("keydown",s,t),n.addEventListener("blur",()=>n.removeEventListener("keydown",s),t)};function Fi(e){return si(e)&&!ea()}const _i=new WeakSet;function rh(e,t,n={}){const[s,i,r]=ta(e,n),o=a=>{const c=a.currentTarget;if(!Fi(a)||_i.has(a))return;on.add(c),n.stopPropagation&&_i.add(a);const l=t(c,a),d={...i,capture:!0},f=(y,b)=>{window.removeEventListener("pointerup",u,d),window.removeEventListener("pointercancel",m,d),on.has(c)&&on.delete(c),Fi(y)&&typeof l=="function"&&l(y,{success:b})},u=y=>{f(y,c===window||c===document||n.useGlobalTarget||na(c,y.target))},m=y=>{f(y,!1)};window.addEventListener("pointerup",u,d),window.addEventListener("pointercancel",m,d)};return s.forEach(a=>{(n.useGlobalTarget?window:a).addEventListener("pointerdown",o,i),sn(a)&&(a.addEventListener("focus",l=>oh(l,i)),!nh(a)&&!a.hasAttribute("tabindex")&&(a.tabIndex=0))}),r}function ii(e){return ar(e)&&"ownerSVGElement"in e}const rn=new WeakMap;let an;const sa=(e,t,n)=>(s,i)=>i&&i[0]?i[0][e+"Size"]:ii(s)&&"getBBox"in s?s.getBBox()[t]:s[n],ah=sa("inline","width","offsetWidth"),lh=sa("block","height","offsetHeight");function ch({target:e,borderBoxSize:t}){rn.get(e)?.forEach(n=>{n(e,{get width(){return ah(e,t)},get height(){return lh(e,t)}})})}function dh(e){e.forEach(ch)}function hh(){typeof ResizeObserver>"u"||(an=new ResizeObserver(dh))}function uh(e,t){an||hh();const n=Jr(e);return n.forEach(s=>{let i=rn.get(s);i||(i=new Set,rn.set(s,i)),i.add(t),an?.observe(s)}),()=>{n.forEach(s=>{const i=rn.get(s);i?.delete(t),i?.size||an?.unobserve(s)})}}const ln=new Set;let dt;function fh(){dt=()=>{const e={get width(){return window.innerWidth},get height(){return window.innerHeight}};ln.forEach(t=>t(e))},window.addEventListener("resize",dt)}function ph(e){return ln.add(e),dt||fh(),()=>{ln.delete(e),!ln.size&&typeof dt=="function"&&(window.removeEventListener("resize",dt),dt=void 0)}}function Hi(e,t){return typeof e=="function"?ph(e):uh(e,t)}function mh(e){return ii(e)&&e.tagName==="svg"}const gh=[...Xr,re,Re],yh=e=>gh.find(qr(e)),Wi=()=>({translate:0,scale:1,origin:0,originPoint:0}),ht=()=>({x:Wi(),y:Wi()}),zi=()=>({min:0,max:0}),ce=()=>({x:zi(),y:zi()}),wh=new WeakMap;function Cn(e){return e!==null&&typeof e=="object"&&typeof e.start=="function"}function jt(e){return typeof e=="string"||Array.isArray(e)}const oi=["animate","whileInView","whileFocus","whileHover","whileTap","whileDrag","exit"],ri=["initial",...oi];function An(e){return Cn(e.animate)||ri.some(t=>jt(e[t]))}function ia(e){return!!(An(e)||e.variants)}function bh(e,t,n){for(const s in t){const i=t[s],r=n[s];if(me(i))e.addValue(s,i);else if(me(r))e.addValue(s,ft(i,{owner:e}));else if(r!==i)if(e.hasValue(s)){const o=e.getValue(s);o.liveStyle===!0?o.jump(i):o.hasAnimated||o.set(i)}else{const o=e.getStaticValue(s);e.addValue(s,ft(o!==void 0?o:i,{owner:e}))}}for(const s in n)t[s]===void 0&&e.removeValue(s);return t}const Ss={current:null},oa={current:!1},xh=typeof window<"u";function vh(){if(oa.current=!0,!!xh)if(window.matchMedia){const e=window.matchMedia("(prefers-reduced-motion)"),t=()=>Ss.current=e.matches;e.addEventListener("change",t),t()}else Ss.current=!1}const Ui=["AnimationStart","AnimationComplete","Update","BeforeLayoutMeasure","LayoutMeasure","LayoutAnimationStart","LayoutAnimationComplete"];let wn={};function ra(e){wn=e}function kh(){return wn}class Th{scrapeMotionValuesFromProps(t,n,s){return{}}constructor({parent:t,props:n,presenceContext:s,reducedMotionConfig:i,skipAnimations:r,blockInitialAnimation:o,visualState:a},c={}){this.current=null,this.children=new Set,this.isVariantNode=!1,this.isControllingVariants=!1,this.shouldReduceMotion=null,this.shouldSkipAnimations=!1,this.values=new Map,this.KeyframeResolver=Xs,this.features={},this.valueSubscriptions=new Map,this.prevMotionValues={},this.hasBeenMounted=!1,this.events={},this.propEventSubscriptions={},this.notifyUpdate=()=>this.notify("Update",this.latestValues),this.render=()=>{this.current&&(this.triggerBuild(),this.renderInstance(this.current,this.renderState,this.props.style,this.projection))},this.renderScheduledAt=0,this.scheduleRender=()=>{const m=we.now();this.renderScheduledAt<m&&(this.renderScheduledAt=m,te.render(this.render,!1,!0))};const{latestValues:l,renderState:d}=a;this.latestValues=l,this.baseTarget={...l},this.initialValues=n.initial?{...l}:{},this.renderState=d,this.parent=t,this.props=n,this.presenceContext=s,this.depth=t?t.depth+1:0,this.reducedMotionConfig=i,this.skipAnimationsConfig=r,this.options=c,this.blockInitialAnimation=!!o,this.isControllingVariants=An(n),this.isVariantNode=ia(n),this.isVariantNode&&(this.variantChildren=new Set),this.manuallyAnimateOnMount=!!(t&&t.current);const{willChange:f,...u}=this.scrapeMotionValuesFromProps(n,{},this);for(const m in u){const y=u[m];l[m]!==void 0&&me(y)&&y.set(l[m])}}mount(t){if(this.hasBeenMounted)for(const n in this.initialValues)this.values.get(n)?.jump(this.initialValues[n]),this.latestValues[n]=this.initialValues[n];this.current=t,wh.set(t,this),this.projection&&!this.projection.instance&&this.projection.mount(t),this.parent&&this.isVariantNode&&!this.isControllingVariants&&(this.removeFromVariantTree=this.parent.addVariantChild(this)),this.values.forEach((n,s)=>this.bindToMotionValue(s,n)),this.reducedMotionConfig==="never"?this.shouldReduceMotion=!1:this.reducedMotionConfig==="always"?this.shouldReduceMotion=!0:(oa.current||vh(),this.shouldReduceMotion=Ss.current),this.shouldSkipAnimations=this.skipAnimationsConfig??!1,this.parent?.addChild(this),this.update(this.props,this.presenceContext),this.hasBeenMounted=!0}unmount(){this.projection&&this.projection.unmount(),Ge(this.notifyUpdate),Ge(this.render),this.valueSubscriptions.forEach(t=>t()),this.valueSubscriptions.clear(),this.removeFromVariantTree&&this.removeFromVariantTree(),this.parent?.removeChild(this);for(const t in this.events)this.events[t].clear();for(const t in this.features){const n=this.features[t];n&&(n.unmount(),n.isMounted=!1)}this.current=null}addChild(t){this.children.add(t),this.enteringChildren??(this.enteringChildren=new Set),this.enteringChildren.add(t)}removeChild(t){this.children.delete(t),this.enteringChildren&&this.enteringChildren.delete(t)}bindToMotionValue(t,n){if(this.valueSubscriptions.has(t)&&this.valueSubscriptions.get(t)(),n.accelerate&&_r.has(t)&&this.current instanceof HTMLElement){const{factory:o,keyframes:a,times:c,ease:l,duration:d}=n.accelerate,f=new $r({element:this.current,name:t,keyframes:a,times:c,ease:l,duration:Pe(d)}),u=o(f);this.valueSubscriptions.set(t,()=>{u(),f.cancel()});return}const s=gt.has(t);s&&this.onBindTransform&&this.onBindTransform();const i=n.on("change",o=>{this.latestValues[t]=o,this.props.onUpdate&&te.preRender(this.notifyUpdate),s&&this.projection&&(this.projection.isTransformDirty=!0),this.scheduleRender()});let r;typeof window<"u"&&window.MotionCheckAppearSync&&(r=window.MotionCheckAppearSync(this,t,n)),this.valueSubscriptions.set(t,()=>{i(),r&&r()})}sortNodePosition(t){return!this.current||!this.sortInstanceNodePosition||this.type!==t.type?0:this.sortInstanceNodePosition(this.current,t.current)}updateFeatures(){let t="animation";for(t in wn){const n=wn[t];if(!n)continue;const{isEnabled:s,Feature:i}=n;if(!this.features[t]&&i&&s(this.props)&&(this.features[t]=new i(this)),this.features[t]){const r=this.features[t];r.isMounted?r.update():(r.mount(),r.isMounted=!0)}}}triggerBuild(){this.build(this.renderState,this.latestValues,this.props)}measureViewportBox(){return this.current?this.measureInstanceViewportBox(this.current,this.props):ce()}getStaticValue(t){return this.latestValues[t]}setStaticValue(t,n){this.latestValues[t]=n}update(t,n){(t.transformTemplate||this.props.transformTemplate)&&this.scheduleRender(),this.prevProps=this.props,this.props=t,this.prevPresenceContext=this.presenceContext,this.presenceContext=n;for(let s=0;s<Ui.length;s++){const i=Ui[s];this.propEventSubscriptions[i]&&(this.propEventSubscriptions[i](),delete this.propEventSubscriptions[i]);const r="on"+i,o=t[r];o&&(this.propEventSubscriptions[i]=this.on(i,o))}this.prevMotionValues=bh(this,this.scrapeMotionValuesFromProps(t,this.prevProps||{},this),this.prevMotionValues),this.handleChildMotionValue&&this.handleChildMotionValue()}getProps(){return this.props}getVariant(t){return this.props.variants?this.props.variants[t]:void 0}getDefaultTransition(){return this.props.transition}getTransformPagePoint(){return this.props.transformPagePoint}getClosestVariantNode(){return this.isVariantNode?this:this.parent?this.parent.getClosestVariantNode():void 0}addVariantChild(t){const n=this.getClosestVariantNode();if(n)return n.variantChildren&&n.variantChildren.add(t),()=>n.variantChildren.delete(t)}addValue(t,n){const s=this.values.get(t);n!==s&&(s&&this.removeValue(t),this.bindToMotionValue(t,n),this.values.set(t,n),this.latestValues[t]=n.get())}removeValue(t){this.values.delete(t);const n=this.valueSubscriptions.get(t);n&&(n(),this.valueSubscriptions.delete(t)),delete this.latestValues[t],this.removeValueFromRenderState(t,this.renderState)}hasValue(t){return this.values.has(t)}getValue(t,n){if(this.props.values&&this.props.values[t])return this.props.values[t];let s=this.values.get(t);return s===void 0&&n!==void 0&&(s=ft(n===null?void 0:n,{owner:this}),this.addValue(t,s)),s}readValue(t,n){let s=this.latestValues[t]!==void 0||!this.current?this.latestValues[t]:this.getBaseTargetFromProps(this.props,t)??this.readValueFromInstance(this.current,t,this.options);return s!=null&&(typeof s=="string"&&(rr(s)||lr(s))?s=parseFloat(s):!yh(s)&&Re.test(n)&&(s=Zr(t,n)),this.setBaseTarget(t,me(s)?s.get():s)),me(s)?s.get():s}setBaseTarget(t,n){this.baseTarget[t]=n}getBaseTarget(t){const{initial:n}=this.props;let s;if(typeof n=="string"||typeof n=="object"){const r=Js(this.props,n,this.presenceContext?.custom);r&&(s=r[t])}if(n&&s!==void 0)return s;const i=this.getBaseTargetFromProps(this.props,t);return i!==void 0&&!me(i)?i:this.initialValues[t]!==void 0&&s===void 0?void 0:this.baseTarget[t]}on(t,n){return this.events[t]||(this.events[t]=new Fs),this.events[t].add(n)}notify(t,...n){this.events[t]&&this.events[t].notify(...n)}scheduleRenderMicrotask(){ni.render(this.render)}}class aa extends Th{constructor(){super(...arguments),this.KeyframeResolver=Yd}sortInstanceNodePosition(t,n){return t.compareDocumentPosition(n)&2?1:-1}getBaseTargetFromProps(t,n){const s=t.style;return s?s[n]:void 0}removeValueFromRenderState(t,{vars:n,style:s}){delete n[t],delete s[t]}handleChildMotionValue(){this.childSubscription&&(this.childSubscription(),delete this.childSubscription);const{children:t}=this.props;me(t)&&(this.childSubscription=t.on("change",n=>{this.current&&(this.current.textContent=`${n}`)}))}}class Ke{constructor(t){this.isMounted=!1,this.node=t}update(){}}function la({top:e,left:t,right:n,bottom:s}){return{x:{min:t,max:n},y:{min:e,max:s}}}function Sh({x:e,y:t}){return{top:t.min,right:e.max,bottom:t.max,left:e.min}}function Ch(e,t){if(!t)return e;const n=t({x:e.left,y:e.top}),s=t({x:e.right,y:e.bottom});return{top:n.y,left:n.x,bottom:s.y,right:s.x}}function Fn(e){return e===void 0||e===1}function Cs({scale:e,scaleX:t,scaleY:n}){return!Fn(e)||!Fn(t)||!Fn(n)}function Xe(e){return Cs(e)||ca(e)||e.z||e.rotate||e.rotateX||e.rotateY||e.skewX||e.skewY}function ca(e){return Gi(e.x)||Gi(e.y)}function Gi(e){return e&&e!=="0%"}function bn(e,t,n){const s=e-n,i=t*s;return n+i}function Ki(e,t,n,s,i){return i!==void 0&&(e=bn(e,i,s)),bn(e,n,s)+t}function As(e,t=0,n=1,s,i){e.min=Ki(e.min,t,n,s,i),e.max=Ki(e.max,t,n,s,i)}function da(e,{x:t,y:n}){As(e.x,t.translate,t.scale,t.originPoint),As(e.y,n.translate,n.scale,n.originPoint)}const Qi=.999999999999,qi=1.0000000000001;function Ah(e,t,n,s=!1){const i=n.length;if(!i)return;t.x=t.y=1;let r,o;for(let a=0;a<i;a++){r=n[a],o=r.projectionDelta;const{visualElement:c}=r.options;c&&c.props.style&&c.props.style.display==="contents"||(s&&r.options.layoutScroll&&r.scroll&&r!==r.root&&(Ve(e.x,-r.scroll.offset.x),Ve(e.y,-r.scroll.offset.y)),o&&(t.x*=o.x.scale,t.y*=o.y.scale,da(e,o)),s&&Xe(r.latestValues)&&cn(e,r.latestValues,r.layout?.layoutBox))}t.x<qi&&t.x>Qi&&(t.x=1),t.y<qi&&t.y>Qi&&(t.y=1)}function Ve(e,t){e.min+=t,e.max+=t}function Xi(e,t,n,s,i=.5){const r=ee(e.min,e.max,i);As(e,t,n,r,s)}function Yi(e,t){return typeof e=="string"?parseFloat(e)/100*(t.max-t.min):e}function cn(e,t,n){const s=n??e;Xi(e.x,Yi(t.x,s.x),t.scaleX,t.scale,t.originX),Xi(e.y,Yi(t.y,s.y),t.scaleY,t.scale,t.originY)}function ha(e,t){return la(Ch(e.getBoundingClientRect(),t))}function Ph(e,t,n){const s=ha(e,n),{scroll:i}=t;return i&&(Ve(s.x,i.offset.x),Ve(s.y,i.offset.y)),s}const Eh={x:"translateX",y:"translateY",z:"translateZ",transformPerspective:"perspective"},Mh=mt.length;function Dh(e,t,n){let s="",i=!0;for(let o=0;o<Mh;o++){const a=mt[o],c=e[a];if(c===void 0)continue;let l=!0;if(typeof c=="number")l=c===(a.startsWith("scale")?1:0);else{const d=parseFloat(c);l=a.startsWith("scale")?d===1:d===0}if(!l||n){const d=Ts(c,yn[a]);if(!l){i=!1;const f=Eh[a]||a;s+=`${f}(${d}) `}n&&(t[a]=d)}}const r=e.pathRotation;return r&&(i=!1,s+=`rotate(${Ts(r,yn.pathRotation)}) `),s=s.trim(),n?s=n(t,i?"":s):i&&(s="none"),s}function ai(e,t,n){const{style:s,vars:i,transformOrigin:r}=e;let o=!1,a=!1;for(const c in t){const l=t[c];if(gt.has(c)){o=!0;continue}else if(Tr(c)){i[c]=l;continue}else{const d=Ts(l,yn[c]);c.startsWith("origin")?(a=!0,r[c]=d):s[c]=d}}if(t.transform||(o||n?s.transform=Dh(t,e.transform,n):s.transform&&(s.transform="none")),a){const{originX:c="50%",originY:l="50%",originZ:d=0}=r;s.transformOrigin=`${c} ${l} ${d}`}}function ua(e,{style:t,vars:n},s,i){const r=e.style;let o;for(o in t)r[o]=t[o];i?.applyProjectionStyles(r,s);for(o in n)r.setProperty(o,n[o])}function Zi(e,t){return t.max===t.min?0:e/(t.max-t.min)*100}const wt={correct:(e,t)=>{if(!t.target)return e;if(typeof e=="string")if(L.test(e))e=parseFloat(e);else return e;const n=Zi(e,t.target.x),s=Zi(e,t.target.y);return`${n}% ${s}%`}},Oh={correct:(e,{treeScale:t,projectionDelta:n})=>{const s=e,i=Re.parse(e);if(i.length>5)return s;const r=Re.createTransformer(e),o=typeof i[0]!="number"?1:0,a=n.x.scale*t.x,c=n.y.scale*t.y;i[0+o]/=a,i[1+o]/=c;const l=ee(a,c,.5);return typeof i[2+o]=="number"&&(i[2+o]/=l),typeof i[3+o]=="number"&&(i[3+o]/=l),r(i)}},Ps={borderRadius:{...wt,applyTo:[...ti]},borderTopLeftRadius:wt,borderTopRightRadius:wt,borderBottomLeftRadius:wt,borderBottomRightRadius:wt,boxShadow:Oh};function fa(e,{layout:t,layoutId:n}){return gt.has(e)||e.startsWith("origin")||(t||n!==void 0)&&(!!Ps[e]||e==="opacity")}function li(e,t,n){const s=e.style,i=t?.style,r={};if(!s)return r;for(const o in s)(me(s[o])||i&&me(i[o])||fa(o,e)||n?.getValue(o)?.liveStyle!==void 0)&&(r[o]=s[o]);return r}function Rh(e){return window.getComputedStyle(e)}class jh extends aa{constructor(){super(...arguments),this.type="html",this.renderInstance=ua}mount(t){Tn(!!t.style),super.mount(t)}readValueFromInstance(t,n){if(gt.has(n))return this.projection?.isProjecting?us(n):Zc(t,n);{const s=Rh(t),i=(Tr(n)?s.getPropertyValue(n):s[n])||0;return typeof i=="string"?i.trim():i}}measureInstanceViewportBox(t,{transformPagePoint:n}){return ha(t,n)}build(t,n,s){ai(t,n,s.transformTemplate)}scrapeMotionValuesFromProps(t,n,s){return li(t,n,s)}}const Lh={offset:"stroke-dashoffset",array:"stroke-dasharray"},Nh={offset:"strokeDashoffset",array:"strokeDasharray"};function Vh(e,t,n=1,s=0,i=!0){e.pathLength=1;const r=i?Lh:Nh;e[r.offset]=`${-s}`,e[r.array]=`${t} ${n}`}const pa=["transform","opacity","offsetDistance","offsetPath","offsetRotate","offsetAnchor"];function ma(e,{attrX:t,attrY:n,attrScale:s,pathLength:i,pathSpacing:r=1,pathOffset:o=0,...a},c,l,d){if(ai(e,a,l),c){e.style.viewBox&&(e.attrs.viewBox=e.style.viewBox);return}e.attrs=e.style,e.style={};const{attrs:f,style:u}=e;for(const m of pa)f[m]!==void 0&&(u[m]=f[m],delete f[m]);(u.transform||f.transformOrigin)&&(u.transformOrigin=f.transformOrigin??"50% 50%",delete f.transformOrigin),u.transform&&(u.transformBox=d?.transformBox??"fill-box",delete f.transformBox),t!==void 0&&(f.x=t),n!==void 0&&(f.y=n),s!==void 0&&(f.scale=s),i!==void 0&&Vh(f,i,r,o,!1)}const ga=new Set(["baseFrequency","diffuseConstant","kernelMatrix","kernelUnitLength","keySplines","keyTimes","limitingConeAngle","markerHeight","markerWidth","numOctaves","targetX","targetY","surfaceScale","specularConstant","specularExponent","stdDeviation","tableValues","viewBox","gradientTransform","pathLength","startOffset","textLength","lengthAdjust"]),ya=e=>typeof e=="string"&&e.toLowerCase()==="svg";function Ih(e,t,n,s){ua(e,t,void 0,s);for(const i in t.attrs)e.setAttribute(ga.has(i)?i:ei(i),t.attrs[i])}function wa(e,t,n){const s=li(e,t,n);for(const i in e)if(me(e[i])||me(t[i])){const r=mt.indexOf(i)!==-1?"attr"+i.charAt(0).toUpperCase()+i.substring(1):i;s[r]=e[i]}return s}class Bh extends aa{constructor(){super(...arguments),this.type="svg",this.isSVGTag=!1,this.measureInstanceViewportBox=ce}getBaseTargetFromProps(t,n){return t[n]}readValueFromInstance(t,n){if(gt.has(n)){const s=Yr(n);return s&&s.default||0}if(pa.includes(n)){const i=getComputedStyle(t)[n];if(typeof i=="string"&&i)return i.trim()}return n=ga.has(n)?n:ei(n),t.getAttribute(n)}scrapeMotionValuesFromProps(t,n,s){return wa(t,n,s)}build(t,n,s){ma(t,n,this.isSVGTag,s.transformTemplate,s.style)}renderInstance(t,n,s,i){Ih(t,n,s,i)}mount(t){this.isSVGTag=ya(t.tagName),super.mount(t)}}const $h=ri.length;function ba(e){if(!e)return;if(!e.isControllingVariants){const n=e.parent?ba(e.parent)||{}:{};return e.props.initial!==void 0&&(n.initial=e.props.initial),n}const t={};for(let n=0;n<$h;n++){const s=ri[n],i=e.props[s];(jt(i)||i===!1)&&(t[s]=i)}return t}function xa(e,t){if(!Array.isArray(t))return!1;const n=t.length;if(n!==e.length)return!1;for(let s=0;s<n;s++)if(t[s]!==e[s])return!1;return!0}const Fh=[...oi].reverse(),_h=oi.length;function Hh(e){return t=>Promise.all(t.map(({animation:n,options:s})=>Fd(e,n,s)))}function Wh(e){let t=Hh(e),n=Ji(),s=!0,i=!1;const r=l=>(d,f)=>{const u=et(e,f,l==="exit"?e.presenceContext?.custom:void 0);if(u){const{transition:m,transitionEnd:y,...b}=u;d={...d,...b,...y}}return d};function o(l){t=l(e)}function a(l){const{props:d}=e,f=ba(e.parent)||{},u=[],m=new Set;let y={},b=1/0;for(let x=0;x<_h;x++){const S=Fh[x],v=n[S],g=d[S]!==void 0?d[S]:f[S],k=jt(g),P=S===l?v.isActive:null;P===!1&&(b=x);let C=g===f[S]&&g!==d[S]&&k;if(C&&(s||i)&&e.manuallyAnimateOnMount&&(C=!1),v.protectedKeys={...y},!v.isActive&&P===null||!g&&!v.prevProp||Cn(g)||typeof g=="boolean")continue;if(S==="exit"&&v.isActive&&P!==!0){v.prevResolvedValues&&(y={...y,...v.prevResolvedValues});continue}const E=zh(v.prevProp,g);let N=E||S===l&&v.isActive&&!C&&k||x>b&&k,z=!1;const _=Array.isArray(g)?g:[g];let I=_.reduce(r(S),{});P===!1&&(I={});const{prevResolvedValues:R={}}=v,H={...R,...I},Z=O=>{N=!0,m.has(O)&&(z=!0,m.delete(O)),v.needsAnimating[O]=!0;const B=e.getValue(O);B&&(B.liveStyle=!1)};for(const O in H){const B=I[O],M=R[O];if(y.hasOwnProperty(O))continue;let q=!1;ws(B)&&ws(M)?q=!xa(B,M)||E:q=B!==M,q?B!=null?Z(O):m.add(O):B!==void 0&&m.has(O)?Z(O):v.protectedKeys[O]=!0}v.prevProp=g,v.prevResolvedValues=I,v.isActive&&(y={...y,...I}),(s||i)&&e.blockInitialAnimation&&(N=!1);const ne=C&&E;N&&(!ne||z)&&u.push(..._.map(O=>{const B={type:S};if(typeof O=="string"&&(s||i)&&!ne&&e.manuallyAnimateOnMount&&e.parent){const{parent:M}=e,q=et(M,O);if(M.enteringChildren&&q){const{delayChildren:ge}=q.transition||{};B.delay=Hr(M.enteringChildren,e,ge)}}return{animation:O,options:B}}))}if(m.size){const x={};if(typeof d.initial!="boolean"){const S=et(e,Array.isArray(d.initial)?d.initial[0]:d.initial);S&&S.transition&&(x.transition=S.transition)}m.forEach(S=>{const v=e.getBaseTarget(S),g=e.getValue(S);g&&(g.liveStyle=!0),x[S]=v??null}),u.push({animation:x})}let w=!!u.length;return s&&(d.initial===!1||d.initial===d.animate)&&!e.manuallyAnimateOnMount&&(w=!1),s=!1,i=!1,w?t(u):Promise.resolve()}function c(l,d){if(n[l].isActive===d)return Promise.resolve();e.variantChildren?.forEach(u=>u.animationState?.setActive(l,d)),n[l].isActive=d;const f=a(l);for(const u in n)n[u].protectedKeys={};return f}return{animateChanges:a,setActive:c,setAnimateFunction:o,getState:()=>n,reset:()=>{n=Ji(),i=!0}}}function zh(e,t){return typeof t=="string"?t!==e:Array.isArray(t)?!xa(t,e):!1}function qe(e=!1){return{isActive:e,protectedKeys:{},needsAnimating:{},prevResolvedValues:{}}}function Ji(){return{animate:qe(!0),whileInView:qe(),whileHover:qe(),whileTap:qe(),whileDrag:qe(),whileFocus:qe(),exit:qe()}}function Es(e,t){e.min=t.min,e.max=t.max}function De(e,t){Es(e.x,t.x),Es(e.y,t.y)}function eo(e,t){e.translate=t.translate,e.scale=t.scale,e.originPoint=t.originPoint,e.origin=t.origin}const va=1e-4,Uh=1-va,Gh=1+va,ka=.01,Kh=0-ka,Qh=0+ka;function be(e){return e.max-e.min}function qh(e,t,n){return Math.abs(e-t)<=n}function to(e,t,n,s=.5){e.origin=s,e.originPoint=ee(t.min,t.max,e.origin),e.scale=be(n)/be(t),e.translate=ee(n.min,n.max,e.origin)-e.originPoint,(e.scale>=Uh&&e.scale<=Gh||isNaN(e.scale))&&(e.scale=1),(e.translate>=Kh&&e.translate<=Qh||isNaN(e.translate))&&(e.translate=0)}function At(e,t,n,s){to(e.x,t.x,n.x,s?s.originX:void 0),to(e.y,t.y,n.y,s?s.originY:void 0)}function no(e,t,n,s=0){const i=s?ee(n.min,n.max,s):n.min;e.min=i+t.min,e.max=e.min+be(t)}function Xh(e,t,n,s){no(e.x,t.x,n.x,s?.x),no(e.y,t.y,n.y,s?.y)}function so(e,t,n,s=0){const i=s?ee(n.min,n.max,s):n.min;e.min=t.min-i,e.max=e.min+be(t)}function xn(e,t,n,s){so(e.x,t.x,n.x,s?.x),so(e.y,t.y,n.y,s?.y)}function io(e,t,n,s,i){return e-=t,e=bn(e,1/n,s),i!==void 0&&(e=bn(e,1/i,s)),e}function Yh(e,t=0,n=1,s=.5,i,r=e,o=e){if(Be.test(t)&&(t=parseFloat(t),t=ee(o.min,o.max,t/100)-o.min),typeof t!="number")return;let a=ee(r.min,r.max,s);e===r&&(a-=t),e.min=io(e.min,t,n,a,i),e.max=io(e.max,t,n,a,i)}function oo(e,t,[n,s,i],r,o){Yh(e,t[n],t[s],t[i],t.scale,r,o)}const Zh=["x","scaleX","originX"],Jh=["y","scaleY","originY"];function ro(e,t,n,s){oo(e.x,t,Zh,n?n.x:void 0,s?s.x:void 0),oo(e.y,t,Jh,n?n.y:void 0,s?s.y:void 0)}function ao(e){return e.translate===0&&e.scale===1}function Ta(e){return ao(e.x)&&ao(e.y)}function lo(e,t){return e.min===t.min&&e.max===t.max}function eu(e,t){return lo(e.x,t.x)&&lo(e.y,t.y)}function co(e,t){return Math.round(e.min)===Math.round(t.min)&&Math.round(e.max)===Math.round(t.max)}function Sa(e,t){return co(e.x,t.x)&&co(e.y,t.y)}function ho(e){return be(e.x)/be(e.y)}function uo(e,t){return e.translate===t.translate&&e.scale===t.scale&&e.originPoint===t.originPoint}function Ne(e){return[e("x"),e("y")]}function tu(e,t,n){let s="";const i=e.x.translate/t.x,r=e.y.translate/t.y,o=n?.z||0;if((i||r||o)&&(s=`translate3d(${i}px, ${r}px, ${o}px) `),(t.x!==1||t.y!==1)&&(s+=`scale(${1/t.x}, ${1/t.y}) `),n){const{transformPerspective:l,rotate:d,pathRotation:f,rotateX:u,rotateY:m,skewX:y,skewY:b}=n;l&&(s=`perspective(${l}px) ${s}`),d&&(s+=`rotate(${d}deg) `),f&&(s+=`rotate(${f}deg) `),u&&(s+=`rotateX(${u}deg) `),m&&(s+=`rotateY(${m}deg) `),y&&(s+=`skewX(${y}deg) `),b&&(s+=`skewY(${b}deg) `)}const a=e.x.scale*t.x,c=e.y.scale*t.y;return(a!==1||c!==1)&&(s+=`scale(${a}, ${c})`),s||"none"}const nu=ti.length,fo=e=>typeof e=="string"?parseFloat(e):e,po=e=>typeof e=="number"||L.test(e);function su(e,t,n,s,i,r){i?(e.opacity=ee(0,n.opacity??1,iu(s)),e.opacityExit=ee(t.opacity??1,0,ou(s))):r&&(e.opacity=ee(t.opacity??1,n.opacity??1,s));for(let o=0;o<nu;o++){const a=ti[o];let c=mo(t,a),l=mo(n,a);if(c===void 0&&l===void 0)continue;c||(c=0),l||(l=0),c===0||l===0||po(c)===po(l)?(e[a]=Math.max(ee(fo(c),fo(l),s),0),(Be.test(l)||Be.test(c))&&(e[a]+="%")):e[a]=l}(t.rotate||n.rotate)&&(e.rotate=ee(t.rotate||0,n.rotate||0,s))}function mo(e,t){return e[t]!==void 0?e[t]:e.borderRadius}const iu=Ca(0,.5,yr),ou=Ca(.5,.95,Ae);function Ca(e,t,n){return s=>s<e?0:s>t?1:n(Ot(e,t,s))}function ru(e,t,n){const s=me(e)?e:ft(e);return s.start(Zs("",s,t,n)),s.animation}function Lt(e,t,n,s={passive:!0}){return e.addEventListener(t,n,s),()=>e.removeEventListener(t,n,s)}const au=(e,t)=>e.depth-t.depth;class lu{constructor(){this.children=[],this.isDirty=!1}add(t){$s(this.children,t),this.isDirty=!0}remove(t){fn(this.children,t),this.isDirty=!0}forEach(t){this.isDirty&&this.children.sort(au),this.isDirty=!1,this.children.forEach(t)}}function cu(e,t){const n=we.now(),s=({timestamp:i})=>{const r=i-n;r>=t&&(Ge(s),e(r-t))};return te.setup(s,!0),()=>Ge(s)}function dn(e){return me(e)?e.get():e}class du{constructor(){this.members=[]}add(t){$s(this.members,t);for(let n=this.members.length-1;n>=0;n--){const s=this.members[n];if(s===t||s===this.lead||s===this.prevLead)continue;const i=s.instance;(!i||i.isConnected===!1)&&!s.snapshot&&(fn(this.members,s),s.unmount())}t.scheduleRender()}remove(t){if(fn(this.members,t),t===this.prevLead&&(this.prevLead=void 0),t===this.lead){const n=this.members[this.members.length-1];n&&this.promote(n)}}relegate(t){for(let n=this.members.indexOf(t)-1;n>=0;n--){const s=this.members[n];if(s.isPresent!==!1&&s.instance?.isConnected!==!1)return this.promote(s),!0}return!1}promote(t,n){const s=this.lead;if(t!==s&&(this.prevLead=s,this.lead=t,t.show(),s)){s.updateSnapshot(),t.scheduleRender();const{layoutDependency:i}=s.options,{layoutDependency:r}=t.options;(i===void 0||i!==r)&&(t.resumeFrom=s,n&&(s.preserveOpacity=!0),s.snapshot&&(t.snapshot=s.snapshot,t.snapshot.latestValues=s.animationValues||s.latestValues),t.root?.isUpdating&&(t.isLayoutDirty=!0)),t.options.crossfade===!1&&s.hide()}}exitAnimationComplete(){this.members.forEach(t=>{t.options.onExitComplete?.(),t.resumingFrom?.options.onExitComplete?.()})}scheduleRender(){this.members.forEach(t=>t.instance&&t.scheduleRender(!1))}removeLeadSnapshot(){this.lead?.snapshot&&(this.lead.snapshot=void 0)}}const hn={hasAnimatedSinceResize:!0,hasEverUpdated:!1},_n=["","X","Y","Z"],hu=1e3;let uu=0;function Hn(e,t,n,s){const{latestValues:i}=t;i[e]&&(n[e]=i[e],t.setStaticValue(e,0),s&&(s[e]=0))}function Aa(e){if(e.hasCheckedOptimisedAppear=!0,e.root===e)return;const{visualElement:t}=e.options;if(!t)return;const n=Kr(t);if(window.MotionHasOptimisedAnimation(n,"transform")){const{layout:i,layoutId:r}=e.options;window.MotionCancelOptimisedAnimation(n,"transform",te,!(i||r))}const{parent:s}=e;s&&!s.hasCheckedOptimisedAppear&&Aa(s)}function Pa({attachResizeListener:e,defaultParent:t,measureScroll:n,checkIsScrollRoot:s,resetTransform:i}){return class{constructor(o={},a=t?.()){this.id=uu++,this.animationId=0,this.animationCommitId=0,this.children=new Set,this.options={},this.isTreeAnimating=!1,this.isAnimationBlocked=!1,this.isLayoutDirty=!1,this.isProjectionDirty=!1,this.isSharedProjectionDirty=!1,this.isTransformDirty=!1,this.updateManuallyBlocked=!1,this.updateBlockedByResize=!1,this.isUpdating=!1,this.isSVG=!1,this.needsReset=!1,this.shouldResetTransform=!1,this.hasCheckedOptimisedAppear=!1,this.treeScale={x:1,y:1},this.eventHandlers=new Map,this.hasTreeAnimated=!1,this.layoutVersion=0,this.updateScheduled=!1,this.scheduleUpdate=()=>this.update(),this.projectionUpdateScheduled=!1,this.checkUpdateFailed=()=>{this.isUpdating&&(this.isUpdating=!1,this.clearAllSnapshots())},this.updateProjection=()=>{this.projectionUpdateScheduled=!1,this.nodes.forEach(mu),this.nodes.forEach(vu),this.nodes.forEach(ku),this.nodes.forEach(gu)},this.resolvedRelativeTargetAt=0,this.linkedParentVersion=0,this.hasProjected=!1,this.isVisible=!0,this.animationProgress=0,this.sharedNodes=new Map,this.latestValues=o,this.root=a?a.root||a:this,this.path=a?[...a.path,a]:[],this.parent=a,this.depth=a?a.depth+1:0;for(let c=0;c<this.path.length;c++)this.path[c].shouldResetTransform=!0;this.root===this&&(this.nodes=new lu)}addEventListener(o,a){return this.eventHandlers.has(o)||this.eventHandlers.set(o,new Fs),this.eventHandlers.get(o).add(a)}notifyListeners(o,...a){const c=this.eventHandlers.get(o);c&&c.notify(...a)}hasListeners(o){return this.eventHandlers.has(o)}mount(o){if(this.instance)return;this.isSVG=ii(o)&&!mh(o),this.instance=o;const{layoutId:a,layout:c,visualElement:l}=this.options;if(l&&!l.current&&l.mount(o),this.root.nodes.add(this),this.parent&&this.parent.children.add(this),this.root.hasTreeAnimated&&(c||a)&&(this.isLayoutDirty=!0),e){let d,f=0;const u=()=>this.root.updateBlockedByResize=!1;te.read(()=>{f=window.innerWidth}),e(o,()=>{const m=window.innerWidth;m!==f&&(f=m,this.root.updateBlockedByResize=!0,d&&d(),d=cu(u,250),hn.hasAnimatedSinceResize&&(hn.hasAnimatedSinceResize=!1,this.nodes.forEach(wo)))})}a&&this.root.registerSharedNode(a,this),this.options.animate!==!1&&l&&(a||c)&&this.addEventListener("didUpdate",({delta:d,hasLayoutChanged:f,hasRelativeLayoutChanged:u,layout:m})=>{if(this.isTreeAnimationBlocked()){this.target=void 0,this.relativeTarget=void 0;return}const y=this.options.transition||l.getDefaultTransition()||Pu,{onLayoutAnimationStart:b,onLayoutAnimationComplete:w}=l.getProps(),x=!this.targetLayout||!Sa(this.targetLayout,m),S=!f&&u;if(this.options.layoutRoot||this.resumeFrom||S||f&&(x||!this.currentAnimation)){this.resumeFrom&&(this.resumingFrom=this.resumeFrom,this.resumingFrom.resumingFrom=void 0);const v={...Ys(y,"layout"),onPlay:b,onComplete:w};(l.shouldReduceMotion||this.options.layoutRoot)&&(v.delay=0,v.type=!1),this.startAnimation(v),this.setAnimationOrigin(d,S,v.path)}else f||wo(this),this.isLead()&&this.options.onExitComplete&&this.options.onExitComplete();this.targetLayout=m})}unmount(){this.options.layoutId&&this.willUpdate(),this.root.nodes.remove(this);const o=this.getStack();o&&o.remove(this),this.parent&&this.parent.children.delete(this),this.instance=void 0,this.eventHandlers.clear(),Ge(this.updateProjection)}blockUpdate(){this.updateManuallyBlocked=!0}unblockUpdate(){this.updateManuallyBlocked=!1}isUpdateBlocked(){return this.updateManuallyBlocked||this.updateBlockedByResize}isTreeAnimationBlocked(){return this.isAnimationBlocked||this.parent&&this.parent.isTreeAnimationBlocked()||!1}startUpdate(){this.isUpdateBlocked()||(this.isUpdating=!0,this.nodes&&this.nodes.forEach(Tu),this.animationId++)}getTransformTemplate(){const{visualElement:o}=this.options;return o&&o.getProps().transformTemplate}willUpdate(o=!0){if(this.root.hasTreeAnimated=!0,this.root.isUpdateBlocked()){this.options.onExitComplete&&this.options.onExitComplete();return}if(window.MotionCancelOptimisedAnimation&&!this.hasCheckedOptimisedAppear&&Aa(this),!this.root.isUpdating&&this.root.startUpdate(),this.isLayoutDirty)return;this.isLayoutDirty=!0;for(let d=0;d<this.path.length;d++){const f=this.path[d];f.shouldResetTransform=!0,(typeof f.latestValues.x=="string"||typeof f.latestValues.y=="string")&&(f.isLayoutDirty=!0),f.updateScroll("snapshot"),f.options.layoutRoot&&f.willUpdate(!1)}const{layoutId:a,layout:c}=this.options;if(a===void 0&&!c)return;const l=this.getTransformTemplate();this.prevTransformTemplateValue=l?l(this.latestValues,""):void 0,this.updateSnapshot(),o&&this.notifyListeners("willUpdate")}update(){if(this.updateScheduled=!1,this.isUpdateBlocked()){const c=this.updateBlockedByResize;this.unblockUpdate(),this.updateBlockedByResize=!1,this.clearAllSnapshots(),c&&this.nodes.forEach(wu),this.nodes.forEach(go);return}if(this.animationId<=this.animationCommitId){this.nodes.forEach(yo);return}this.animationCommitId=this.animationId,this.isUpdating?(this.isUpdating=!1,this.nodes.forEach(bu),this.nodes.forEach(xu),this.nodes.forEach(fu),this.nodes.forEach(pu)):this.nodes.forEach(yo),this.clearAllSnapshots();const a=we.now();pe.delta=$e(0,1e3/60,a-pe.timestamp),pe.timestamp=a,pe.isProcessing=!0,jn.update.process(pe),jn.preRender.process(pe),jn.render.process(pe),pe.isProcessing=!1}didUpdate(){this.updateScheduled||(this.updateScheduled=!0,ni.read(this.scheduleUpdate))}clearAllSnapshots(){this.nodes.forEach(yu),this.sharedNodes.forEach(Su)}scheduleUpdateProjection(){this.projectionUpdateScheduled||(this.projectionUpdateScheduled=!0,te.preRender(this.updateProjection,!1,!0))}scheduleCheckAfterUnmount(){te.postRender(()=>{this.isLayoutDirty?this.root.didUpdate():this.root.checkUpdateFailed()})}updateSnapshot(){this.snapshot||!this.instance||(this.snapshot=this.measure(),this.snapshot&&!be(this.snapshot.measuredBox.x)&&!be(this.snapshot.measuredBox.y)&&(this.snapshot=void 0))}updateLayout(){if(!this.instance||(this.updateScroll(),!(this.options.alwaysMeasureLayout&&this.isLead())&&!this.isLayoutDirty))return;if(this.resumeFrom&&!this.resumeFrom.instance)for(let c=0;c<this.path.length;c++)this.path[c].updateScroll();const o=this.layout;this.layout=this.measure(!1),this.layoutVersion++,this.layoutCorrected||(this.layoutCorrected=ce()),this.isLayoutDirty=!1,this.projectionDelta=void 0,this.notifyListeners("measure",this.layout.layoutBox);const{visualElement:a}=this.options;a&&a.notify("LayoutMeasure",this.layout.layoutBox,o?o.layoutBox:void 0)}updateScroll(o="measure"){let a=!!(this.options.layoutScroll&&this.instance);if(this.scroll&&this.scroll.animationId===this.root.animationId&&this.scroll.phase===o&&(a=!1),a&&this.instance){const c=s(this.instance);this.scroll={animationId:this.root.animationId,phase:o,isRoot:c,offset:n(this.instance),wasRoot:this.scroll?this.scroll.isRoot:c}}}resetTransform(){if(!i)return;const o=this.isLayoutDirty||this.shouldResetTransform||this.options.alwaysMeasureLayout,a=this.projectionDelta&&!Ta(this.projectionDelta),c=this.getTransformTemplate(),l=c?c(this.latestValues,""):void 0,d=l!==this.prevTransformTemplateValue;o&&this.instance&&(a||Xe(this.latestValues)||d)&&(i(this.instance,l),this.shouldResetTransform=!1,this.scheduleRender())}measure(o=!0){const a=this.measurePageBox();let c=this.removeElementScroll(a);return o&&(c=this.removeTransform(c)),Eu(c),{animationId:this.root.animationId,measuredBox:a,layoutBox:c,latestValues:{},source:this.id}}measurePageBox(){const{visualElement:o}=this.options;if(!o)return ce();const a=o.measureViewportBox();if(!(this.scroll?.wasRoot||this.path.some(Mu))){const{scroll:l}=this.root;l&&(Ve(a.x,l.offset.x),Ve(a.y,l.offset.y))}return a}removeElementScroll(o){const a=ce();if(De(a,o),this.scroll?.wasRoot)return a;for(let c=0;c<this.path.length;c++){const l=this.path[c],{scroll:d,options:f}=l;l!==this.root&&d&&f.layoutScroll&&(d.wasRoot&&De(a,o),Ve(a.x,d.offset.x),Ve(a.y,d.offset.y))}return a}applyTransform(o,a=!1,c){const l=c||ce();De(l,o);for(let d=0;d<this.path.length;d++){const f=this.path[d];!a&&f.options.layoutScroll&&f.scroll&&f!==f.root&&(Ve(l.x,-f.scroll.offset.x),Ve(l.y,-f.scroll.offset.y)),Xe(f.latestValues)&&cn(l,f.latestValues,f.layout?.layoutBox)}return Xe(this.latestValues)&&cn(l,this.latestValues,this.layout?.layoutBox),l}removeTransform(o){const a=ce();De(a,o);for(let c=0;c<this.path.length;c++){const l=this.path[c];if(!Xe(l.latestValues))continue;let d;l.instance&&(Cs(l.latestValues)&&l.updateSnapshot(),d=ce(),De(d,l.measurePageBox())),ro(a,l.latestValues,l.snapshot?.layoutBox,d)}return Xe(this.latestValues)&&ro(a,this.latestValues),a}setTargetDelta(o){this.targetDelta=o,this.root.scheduleUpdateProjection(),this.isProjectionDirty=!0}setOptions(o){this.options={...this.options,...o,crossfade:o.crossfade!==void 0?o.crossfade:!0}}clearMeasurements(){this.scroll=void 0,this.layout=void 0,this.snapshot=void 0,this.prevTransformTemplateValue=void 0,this.targetDelta=void 0,this.target=void 0,this.isLayoutDirty=!1}forceRelativeParentToResolveTarget(){this.relativeParent&&this.relativeParent.resolvedRelativeTargetAt!==pe.timestamp&&this.relativeParent.resolveTargetDelta(!0)}resolveTargetDelta(o=!1){const a=this.getLead();this.isProjectionDirty||(this.isProjectionDirty=a.isProjectionDirty),this.isTransformDirty||(this.isTransformDirty=a.isTransformDirty),this.isSharedProjectionDirty||(this.isSharedProjectionDirty=a.isSharedProjectionDirty);const c=!!this.resumingFrom||this!==a;if(!(o||c&&this.isSharedProjectionDirty||this.isProjectionDirty||this.parent?.isProjectionDirty||this.attemptToResolveRelativeTarget||this.root.updateBlockedByResize))return;const{layout:d,layoutId:f}=this.options;if(!this.layout||!(d||f))return;this.resolvedRelativeTargetAt=pe.timestamp;const u=this.getClosestProjectingParent();u&&this.linkedParentVersion!==u.layoutVersion&&!u.options.layoutRoot&&this.removeRelativeTarget(),!this.targetDelta&&!this.relativeTarget&&(this.options.layoutAnchor!==!1&&u&&u.layout?this.createRelativeTarget(u,this.layout.layoutBox,u.layout.layoutBox):this.removeRelativeTarget()),!(!this.relativeTarget&&!this.targetDelta)&&(this.target||(this.target=ce(),this.targetWithTransforms=ce()),this.relativeTarget&&this.relativeTargetOrigin&&this.relativeParent&&this.relativeParent.target?(this.forceRelativeParentToResolveTarget(),Xh(this.target,this.relativeTarget,this.relativeParent.target,this.options.layoutAnchor||void 0)):this.targetDelta?(this.resumingFrom?this.applyTransform(this.layout.layoutBox,!1,this.target):De(this.target,this.layout.layoutBox),da(this.target,this.targetDelta)):De(this.target,this.layout.layoutBox),this.attemptToResolveRelativeTarget&&(this.attemptToResolveRelativeTarget=!1,this.options.layoutAnchor!==!1&&u&&!!u.resumingFrom==!!this.resumingFrom&&!u.options.layoutScroll&&u.target&&this.animationProgress!==1?this.createRelativeTarget(u,this.target,u.target):this.relativeParent=this.relativeTarget=void 0))}getClosestProjectingParent(){if(!(!this.parent||Cs(this.parent.latestValues)||ca(this.parent.latestValues)))return this.parent.isProjecting()?this.parent:this.parent.getClosestProjectingParent()}isProjecting(){return!!((this.relativeTarget||this.targetDelta||this.options.layoutRoot)&&this.layout)}createRelativeTarget(o,a,c){this.relativeParent=o,this.linkedParentVersion=o.layoutVersion,this.forceRelativeParentToResolveTarget(),this.relativeTarget=ce(),this.relativeTargetOrigin=ce(),xn(this.relativeTargetOrigin,a,c,this.options.layoutAnchor||void 0),De(this.relativeTarget,this.relativeTargetOrigin)}removeRelativeTarget(){this.relativeParent=this.relativeTarget=void 0}calcProjection(){const o=this.getLead(),a=!!this.resumingFrom||this!==o;let c=!0;if((this.isProjectionDirty||this.parent?.isProjectionDirty)&&(c=!1),a&&(this.isSharedProjectionDirty||this.isTransformDirty)&&(c=!1),this.resolvedRelativeTargetAt===pe.timestamp&&(c=!1),c)return;const{layout:l,layoutId:d}=this.options;if(this.isTreeAnimating=!!(this.parent&&this.parent.isTreeAnimating||this.currentAnimation||this.pendingAnimation),this.isTreeAnimating||(this.targetDelta=this.relativeTarget=void 0),!this.layout||!(l||d))return;De(this.layoutCorrected,this.layout.layoutBox);const f=this.treeScale.x,u=this.treeScale.y;Ah(this.layoutCorrected,this.treeScale,this.path,a),o.layout&&!o.target&&(this.treeScale.x!==1||this.treeScale.y!==1)&&(o.target=o.layout.layoutBox,o.targetWithTransforms=ce());const{target:m}=o;if(!m){this.prevProjectionDelta&&(this.createProjectionDeltas(),this.scheduleRender());return}!this.projectionDelta||!this.prevProjectionDelta?this.createProjectionDeltas():(eo(this.prevProjectionDelta.x,this.projectionDelta.x),eo(this.prevProjectionDelta.y,this.projectionDelta.y)),At(this.projectionDelta,this.layoutCorrected,m,this.latestValues),(this.treeScale.x!==f||this.treeScale.y!==u||!uo(this.projectionDelta.x,this.prevProjectionDelta.x)||!uo(this.projectionDelta.y,this.prevProjectionDelta.y))&&(this.hasProjected=!0,this.scheduleRender(),this.notifyListeners("projectionUpdate",m))}hide(){this.isVisible=!1}show(){this.isVisible=!0}scheduleRender(o=!0){if(this.options.visualElement?.scheduleRender(),o){const a=this.getStack();a&&a.scheduleRender()}this.resumingFrom&&!this.resumingFrom.instance&&(this.resumingFrom=void 0)}createProjectionDeltas(){this.prevProjectionDelta=ht(),this.projectionDelta=ht(),this.projectionDeltaWithTransform=ht()}setAnimationOrigin(o,a=!1,c){const l=this.snapshot,d=l?l.latestValues:{},f={...this.latestValues},u=ht();(!this.relativeParent||!this.relativeParent.options.layoutRoot)&&(this.relativeTarget=this.relativeTargetOrigin=void 0),this.attemptToResolveRelativeTarget=!a;const m=ce(),y=l?l.source:void 0,b=this.layout?this.layout.source:void 0,w=y!==b,x=this.getStack(),S=!x||x.members.length<=1,v=!!(w&&!S&&this.options.crossfade===!0&&!this.path.some(Au));this.animationProgress=0;let g;const k=c?.interpolateProjection(o);this.mixTargetDelta=P=>{const C=P/1e3,E=k?.(C);E?(u.x.translate=E.x,u.x.scale=ee(o.x.scale,1,C),u.x.origin=o.x.origin,u.x.originPoint=o.x.originPoint,u.y.translate=E.y,u.y.scale=ee(o.y.scale,1,C),u.y.origin=o.y.origin,u.y.originPoint=o.y.originPoint):(bo(u.x,o.x,C),bo(u.y,o.y,C)),this.setTargetDelta(u),this.relativeTarget&&this.relativeTargetOrigin&&this.layout&&this.relativeParent&&this.relativeParent.layout&&(xn(m,this.layout.layoutBox,this.relativeParent.layout.layoutBox,this.options.layoutAnchor||void 0),Cu(this.relativeTarget,this.relativeTargetOrigin,m,C),g&&eu(this.relativeTarget,g)&&(this.isProjectionDirty=!1),g||(g=ce()),De(g,this.relativeTarget)),w&&(this.animationValues=f,su(f,d,this.latestValues,C,v,S)),E&&E.rotate!==void 0&&(this.animationValues||(this.animationValues=f),this.animationValues.pathRotation=E.rotate),this.root.scheduleUpdateProjection(),this.scheduleRender(),this.animationProgress=C},this.mixTargetDelta(this.options.layoutRoot?1e3:0)}startAnimation(o){this.notifyListeners("animationStart"),this.currentAnimation?.stop(),this.resumingFrom?.currentAnimation?.stop(),this.pendingAnimation&&(Ge(this.pendingAnimation),this.pendingAnimation=void 0),this.pendingAnimation=te.update(()=>{hn.hasAnimatedSinceResize=!0,this.motionValue||(this.motionValue=ft(0)),this.motionValue.jump(0,!1),this.currentAnimation=ru(this.motionValue,[0,1e3],{...o,velocity:0,isSync:!0,onUpdate:a=>{this.mixTargetDelta(a),o.onUpdate&&o.onUpdate(a)},onComplete:()=>{o.onComplete&&o.onComplete(),this.completeAnimation()}}),this.resumingFrom&&(this.resumingFrom.currentAnimation=this.currentAnimation),this.pendingAnimation=void 0})}completeAnimation(){this.resumingFrom&&(this.resumingFrom.currentAnimation=void 0,this.resumingFrom.preserveOpacity=void 0);const o=this.getStack();o&&o.exitAnimationComplete(),this.resumingFrom=this.currentAnimation=this.animationValues=void 0,this.notifyListeners("animationComplete")}finishAnimation(){this.currentAnimation&&(this.mixTargetDelta&&this.mixTargetDelta(hu),this.currentAnimation.stop()),this.completeAnimation()}applyTransformsToTarget(){const o=this.getLead();let{targetWithTransforms:a,target:c,layout:l,latestValues:d}=o;if(!(!a||!c||!l)){if(this!==o&&this.layout&&l&&Ea(this.options.animationType,this.layout.layoutBox,l.layoutBox)){c=this.target||ce();const f=be(this.layout.layoutBox.x);c.x.min=o.target.x.min,c.x.max=c.x.min+f;const u=be(this.layout.layoutBox.y);c.y.min=o.target.y.min,c.y.max=c.y.min+u}De(a,c),cn(a,d),At(this.projectionDeltaWithTransform,this.layoutCorrected,a,d)}}registerSharedNode(o,a){this.sharedNodes.has(o)||this.sharedNodes.set(o,new du),this.sharedNodes.get(o).add(a);const l=a.options.initialPromotionConfig;a.promote({transition:l?l.transition:void 0,preserveFollowOpacity:l&&l.shouldPreserveFollowOpacity?l.shouldPreserveFollowOpacity(a):void 0})}isLead(){const o=this.getStack();return o?o.lead===this:!0}getLead(){const{layoutId:o}=this.options;return o?this.getStack()?.lead||this:this}getPrevLead(){const{layoutId:o}=this.options;return o?this.getStack()?.prevLead:void 0}getStack(){const{layoutId:o}=this.options;if(o)return this.root.sharedNodes.get(o)}promote({needsReset:o,transition:a,preserveFollowOpacity:c}={}){const l=this.getStack();l&&l.promote(this,c),o&&(this.projectionDelta=void 0,this.needsReset=!0),a&&this.setOptions({transition:a})}relegate(){const o=this.getStack();return o?o.relegate(this):!1}resetSkewAndRotation(){const{visualElement:o}=this.options;if(!o)return;let a=!1;const{latestValues:c}=o;if((c.z||c.rotate||c.rotateX||c.rotateY||c.rotateZ||c.skewX||c.skewY)&&(a=!0),!a)return;const l={};c.z&&Hn("z",o,l,this.animationValues);for(let d=0;d<_n.length;d++)Hn(`rotate${_n[d]}`,o,l,this.animationValues),Hn(`skew${_n[d]}`,o,l,this.animationValues);o.render();for(const d in l)o.setStaticValue(d,l[d]),this.animationValues&&(this.animationValues[d]=l[d]);o.scheduleRender()}applyProjectionStyles(o,a){if(!this.instance||this.isSVG)return;if(!this.isVisible){o.visibility="hidden";return}const c=this.getTransformTemplate();if(this.needsReset){this.needsReset=!1,o.visibility="",o.opacity="",o.pointerEvents=dn(a?.pointerEvents)||"",o.transform=c?c(this.latestValues,""):"none";return}const l=this.getLead();if(!this.projectionDelta||!this.layout||!l.target){this.options.layoutId&&(o.opacity=this.latestValues.opacity!==void 0?this.latestValues.opacity:1,o.pointerEvents=dn(a?.pointerEvents)||""),this.hasProjected&&!Xe(this.latestValues)&&(o.transform=c?c({},""):"none",this.hasProjected=!1);return}o.visibility="";const d=l.animationValues||l.latestValues;this.applyTransformsToTarget();let f=tu(this.projectionDeltaWithTransform,this.treeScale,d);c&&(f=c(d,f)),o.transform=f;const{x:u,y:m}=this.projectionDelta;o.transformOrigin=`${u.origin*100}% ${m.origin*100}% 0`,l.animationValues?o.opacity=l===this?d.opacity??this.latestValues.opacity??1:this.preserveOpacity?this.latestValues.opacity:d.opacityExit:o.opacity=l===this?d.opacity!==void 0?d.opacity:"":d.opacityExit!==void 0?d.opacityExit:0;for(const y in Ps){if(d[y]===void 0)continue;const{correct:b,applyTo:w,isCSSVariable:x}=Ps[y],S=f==="none"?d[y]:b(d[y],l);if(w){const v=w.length;for(let g=0;g<v;g++)o[w[g]]=S}else x?this.options.visualElement.renderState.vars[y]=S:o[y]=S}this.options.layoutId&&(o.pointerEvents=l===this?dn(a?.pointerEvents)||"":"none")}clearSnapshot(){this.resumeFrom=this.snapshot=void 0}resetTree(){this.root.nodes.forEach(o=>o.currentAnimation?.stop()),this.root.nodes.forEach(go),this.root.sharedNodes.clear()}}}function fu(e){e.updateLayout()}function pu(e){const t=e.resumeFrom?.snapshot||e.snapshot;if(e.isLead()&&e.layout&&t&&e.hasListeners("didUpdate")){const{layoutBox:n,measuredBox:s}=e.layout,{animationType:i}=e.options,r=t.source!==e.layout.source;if(i==="size")Ne(d=>{const f=r?t.measuredBox[d]:t.layoutBox[d],u=be(f);f.min=n[d].min,f.max=f.min+u});else if(i==="x"||i==="y"){const d=i==="x"?"y":"x";Es(r?t.measuredBox[d]:t.layoutBox[d],n[d])}else Ea(i,t.layoutBox,n)&&Ne(d=>{const f=r?t.measuredBox[d]:t.layoutBox[d],u=be(n[d]);f.max=f.min+u,e.relativeTarget&&!e.currentAnimation&&(e.isProjectionDirty=!0,e.relativeTarget[d].max=e.relativeTarget[d].min+u)});const o=ht();At(o,n,t.layoutBox);const a=ht();r?At(a,e.applyTransform(s,!0),t.measuredBox):At(a,n,t.layoutBox);const c=!Ta(o);let l=!1;if(!e.resumeFrom){const d=e.getClosestProjectingParent();if(d&&!d.resumeFrom){const{snapshot:f,layout:u}=d;if(f&&u){const m=e.options.layoutAnchor||void 0,y=ce();xn(y,t.layoutBox,f.layoutBox,m);const b=ce();xn(b,n,u.layoutBox,m),Sa(y,b)||(l=!0),d.options.layoutRoot&&(e.relativeTarget=b,e.relativeTargetOrigin=y,e.relativeParent=d)}}}e.notifyListeners("didUpdate",{layout:n,snapshot:t,delta:a,layoutDelta:o,hasLayoutChanged:c,hasRelativeLayoutChanged:l})}else if(e.isLead()){const{onExitComplete:n}=e.options;n&&n()}e.options.transition=void 0}function mu(e){e.parent&&(e.isProjecting()||(e.isProjectionDirty=e.parent.isProjectionDirty),e.isSharedProjectionDirty||(e.isSharedProjectionDirty=!!(e.isProjectionDirty||e.parent.isProjectionDirty||e.parent.isSharedProjectionDirty)),e.isTransformDirty||(e.isTransformDirty=e.parent.isTransformDirty))}function gu(e){e.isProjectionDirty=e.isSharedProjectionDirty=e.isTransformDirty=!1}function yu(e){e.clearSnapshot()}function go(e){e.clearMeasurements()}function wu(e){e.isLayoutDirty=!0,e.updateLayout()}function yo(e){e.isLayoutDirty=!1}function bu(e){e.isAnimationBlocked&&e.layout&&!e.isLayoutDirty&&(e.snapshot=e.layout,e.isLayoutDirty=!0)}function xu(e){const{visualElement:t}=e.options;t&&t.getProps().onBeforeLayoutMeasure&&t.notify("BeforeLayoutMeasure"),e.resetTransform()}function wo(e){e.finishAnimation(),e.targetDelta=e.relativeTarget=e.target=void 0,e.isProjectionDirty=!0}function vu(e){e.resolveTargetDelta()}function ku(e){e.calcProjection()}function Tu(e){e.resetSkewAndRotation()}function Su(e){e.removeLeadSnapshot()}function bo(e,t,n){e.translate=ee(t.translate,0,n),e.scale=ee(t.scale,1,n),e.origin=t.origin,e.originPoint=t.originPoint}function xo(e,t,n,s){e.min=ee(t.min,n.min,s),e.max=ee(t.max,n.max,s)}function Cu(e,t,n,s){xo(e.x,t.x,n.x,s),xo(e.y,t.y,n.y,s)}function Au(e){return e.animationValues&&e.animationValues.opacityExit!==void 0}const Pu={duration:.45,ease:[.4,0,.1,1]},vo=e=>typeof navigator<"u"&&navigator.userAgent&&navigator.userAgent.toLowerCase().includes(e),ko=vo("applewebkit/")&&!vo("chrome/")?Math.round:Ae;function To(e){e.min=ko(e.min),e.max=ko(e.max)}function Eu(e){To(e.x),To(e.y)}function Ea(e,t,n){return e==="position"||e==="preserve-aspect"&&!qh(ho(t),ho(n),.2)}function Mu(e){return e!==e.root&&e.scroll?.wasRoot}const Du=Pa({attachResizeListener:(e,t)=>Lt(e,"resize",t),measureScroll:()=>({x:document.documentElement.scrollLeft||document.body?.scrollLeft||0,y:document.documentElement.scrollTop||document.body?.scrollTop||0}),checkIsScrollRoot:()=>!0}),Wn={current:void 0},Ma=Pa({measureScroll:e=>({x:e.scrollLeft,y:e.scrollTop}),defaultParent:()=>{if(!Wn.current){const e=new Du({});e.mount(window),e.setOptions({layoutScroll:!0}),Wn.current=e}return Wn.current},resetTransform:(e,t)=>{e.style.transform=t!==void 0?t:"none"},checkIsScrollRoot:e=>window.getComputedStyle(e).position==="fixed"}),ci=p.createContext({transformPagePoint:e=>e,isStatic:!1,reducedMotion:"never"});function So(e,t){if(typeof e=="function")return e(t);e!=null&&(e.current=t)}function Ou(...e){return t=>{let n=!1;const s=e.map(i=>{const r=So(i,t);return!n&&typeof r=="function"&&(n=!0),r});if(n)return()=>{for(let i=0;i<s.length;i++){const r=s[i];typeof r=="function"?r():So(e[i],null)}}}}function Ru(...e){return p.useCallback(Ou(...e),e)}class ju extends p.Component{getSnapshotBeforeUpdate(t){const n=this.props.childRef.current;if(sn(n)&&t.isPresent&&!this.props.isPresent&&this.props.pop!==!1){const s=n.offsetParent,i=sn(s)&&s.offsetWidth||0,r=sn(s)&&s.offsetHeight||0,o=getComputedStyle(n),a=this.props.sizeRef.current;a.height=parseFloat(o.height),a.width=parseFloat(o.width),a.top=n.offsetTop,a.left=n.offsetLeft,a.right=i-a.width-a.left,a.bottom=r-a.height-a.top,a.direction=o.direction}return null}componentDidUpdate(){}render(){return this.props.children}}function Lu({children:e,isPresent:t,anchorX:n,anchorY:s,root:i,pop:r}){const o=p.useId(),a=p.useRef(null),c=p.useRef({width:0,height:0,top:0,left:0,right:0,bottom:0,direction:"ltr"}),{nonce:l}=p.useContext(ci),d=r!==!1?e.props?.ref??e?.ref:void 0,f=Ru(a,d);return p.useInsertionEffect(()=>{const{width:u,height:m,top:y,left:b,right:w,bottom:x,direction:S}=c.current;if(t||r===!1||!a.current||!u||!m)return;const v=S==="rtl",g=n==="left"?v?`right: ${w}`:`left: ${b}`:v?`left: ${b}`:`right: ${w}`,k=s==="bottom"?`bottom: ${x}`:`top: ${y}`;a.current.dataset.motionPopId=o;const P=document.createElement("style");l&&(P.nonce=l);const C=i??document.head;return C.appendChild(P),P.sheet&&P.sheet.insertRule(`
        ...
        `),()=>{a.current?.removeAttribute("data-motion-pop-id"),C.contains(P)&&C.removeChild(P)}},[t]),h.jsx(ju,{isPresent:t,childRef:a,sizeRef:c,pop:r,children:r===!1?e:p.cloneElement(e,{ref:f})})}const Nu=({children:e,initial:t,isPresent:n,onExitComplete:s,custom:i,presenceAffectsLayout:r,mode:o,anchorX:a,anchorY:c,root:l})=>{const d=Bs(Vu),f=p.useId(),u=p.useRef(n),m=p.useRef(s);un(()=>{u.current=n,m.current=s});let y=!0,b=p.useMemo(()=>(y=!1,{id:f,initial:t,isPresent:n,custom:i,onExitComplete:w=>{d.set(w,!0);for(const x of d.values())if(!x)return;s&&s()},register:w=>(d.set(w,!1),()=>{d.delete(w),!u.current&&!d.size&&m.current?.()})}),[n,d,s]);return r&&y&&(b={...b}),p.useMemo(()=>{d.forEach((w,x)=>d.set(x,!1))},[n]),p.useEffect(()=>{!n&&!d.size&&s&&s()},[n]),e=h.jsx(Lu,{pop:o==="popLayout",isPresent:n,anchorX:a,anchorY:c,root:l,children:e}),h.jsx(kn.Provider,{value:b,children:e})};function Vu(){return new Map}function Da(e=!0){const t=p.useContext(kn);if(t===null)return[!0,null];const{isPresent:n,onExitComplete:s,register:i}=t,r=p.useId();p.useEffect(()=>{if(e)return i(r)},[e]);const o=p.useCallback(()=>e&&s&&s(r),[r,s,e]);return!n&&s?[!1,o]:[!0]}const Gt=e=>e.key||"";function Co(e){const t=[];return p.Children.forEach(e,n=>{p.isValidElement(n)&&t.push(n)}),t}const Iu=({children:e,custom:t,initial:n=!0,onExitComplete:s,presenceAffectsLayout:i=!0,mode:r="sync",propagate:o=!1,anchorX:a="left",anchorY:c="top",root:l})=>{const[d,f]=Da(o),u=p.useMemo(()=>Co(e),[e]),m=o&&!d?[]:u.map(Gt),y=p.useRef(!0),b=p.useRef(u),w=Bs(()=>new Map),x=p.useRef(new Set),[S,v]=p.useState(u),[g,k]=p.useState(u);un(()=>{o&&!d&&!g.length&&f?.()},[d,o,g.length,f]),un(()=>{y.current=!1,b.current=u;for(let E=0;E<g.length;E++){const N=Gt(g[E]);m.includes(N)?(w.delete(N),x.current.delete(N)):w.get(N)!==!0&&w.set(N,!1)}},[g,m.length,m.join("-")]);const P=[];if(u!==S){let E=[...u],N=0;for(const z of g){const _=m.indexOf(Gt(z));_===-1?(E.splice(N++,0,z),P.push(z)):N=_+P.length+1}return r==="wait"&&P.length&&(E=P),k(Co(E)),v(u),null}const{forceRender:C}=p.useContext(Is);return h.jsx(h.Fragment,{children:g.map(E=>{const N=Gt(E),z=o&&!d?!1:u===g||m.includes(N),_=()=>{if(x.current.has(N))return;if(w.has(N))x.current.add(N),w.set(N,!0);else return;let I=!0;w.forEach(R=>{R||(I=!1)}),I&&(C?.(),k(b.current),o&&f?.(),s&&s())};return h.jsx(Nu,{isPresent:z,initial:!y.current||n?void 0:!1,custom:t,presenceAffectsLayout:i,mode:r,root:l,onExitComplete:z?void 0:_,anchorX:a,anchorY:c,children:E},N)})})},Oa=p.createContext({strict:!1}),Ao={animation:["animate","variants","whileHover","whileTap","exit","whileInView","whileFocus","whileDrag"],exit:["exit"],drag:["drag","dragControls"],focus:["whileFocus"],hover:["whileHover","onHoverStart","onHoverEnd"],tap:["whileTap","onTap","onTapStart","onTapCancel"],pan:["onPan","onPanStart","onPanSessionStart","onPanEnd"],inView:["whileInView","onViewportEnter","onViewportLeave"],layout:["layout","layoutId"]};let Po=!1;function Bu(){if(Po)return;const e={};for(const t in Ao)e[t]={isEnabled:n=>Ao[t].some(s=>!!n[s])};ra(e),Po=!0}function Ra(){return Bu(),kh()}function $u(e){const t=Ra();for(const n in e)t[n]={...t[n],...e[n]};ra(t)}const Pn=p.createContext({});function Fu(e,t){if(An(e)){const{initial:n,animate:s}=e;return{initial:n===!1||jt(n)?n:void 0,animate:jt(s)?s:void 0}}return e.inherit!==!1?t:{}}function _u(e){const{initial:t,animate:n}=Fu(e,p.useContext(Pn));return p.useMemo(()=>({initial:t,animate:n}),[Eo(t),Eo(n)])}function Eo(e){return Array.isArray(e)?e.join(" "):e}const di=()=>({style:{},transform:{},transformOrigin:{},vars:{}});function ja(e,t,n){for(const s in t)!me(t[s])&&!fa(s,n)&&(e[s]=t[s])}function Hu({transformTemplate:e},t){return p.useMemo(()=>{const n=di();return ai(n,t,e),Object.assign({},n.vars,n.style)},[t])}function Wu(e,t){const n=e.style||{},s={};return ja(s,n,e),Object.assign(s,Hu(e,t)),s}function zu(e,t){const n={},s=Wu(e,t);return e.drag&&e.dragListener!==!1&&(n.draggable=!1,s.userSelect=s.WebkitUserSelect=s.WebkitTouchCallout="none",s.touchAction=e.drag===!0?"none":`pan-${e.drag==="x"?"y":"x"}`),e.tabIndex===void 0&&(e.onTap||e.onTapStart||e.whileTap)&&(n.tabIndex=0),n.style=s,n}const La=()=>({...di(),attrs:{}});function Uu(e,t,n,s){const i=p.useMemo(()=>{const r=La();return ma(r,t,ya(s),e.transformTemplate,e.style),{...r.attrs,style:{...r.style}}},[t]);if(e.style){const r={};ja(r,e.style,e),i.style={...r,...i.style}}return i}const Gu=new Set(["animate","exit","variants","initial","style","values","variants","transition","transformTemplate","custom","inherit","onBeforeLayoutMeasure","onAnimationStart","onAnimationComplete","onUpdate","onDragStart","onDrag","onDragEnd","onMeasureDragConstraints","onDirectionLock","onDragTransitionEnd","_dragX","_dragY","onHoverStart","onHoverEnd","onViewportEnter","onViewportLeave","globalTapTarget","propagate","ignoreStrict","viewport"]);function vn(e){return e.startsWith("while")||e.startsWith("drag")&&e!=="draggable"||e.startsWith("layout")||e.startsWith("onTap")||e.startsWith("onPan")||e.startsWith("onLayout")||Gu.has(e)}function Ku(e,t){return e.startsWith("on")?!vn(e):t?.(e)??!vn(e)}function Qu(e,t,n,s){const i={};for(const r in e)r==="values"&&typeof e.values=="object"||me(e[r])||(Ku(r,s)||n===!0&&vn(r)||!t&&!vn(r)||e.draggable&&r.startsWith("onDrag"))&&(i[r]=e[r]);return i}const qu=["animate","circle","defs","desc","ellipse","g","image","line","filter","marker","mask","metadata","path","pattern","polygon","polyline","rect","stop","switch","symbol","svg","text","tspan","use","view"];function hi(e){return typeof e!="string"||e.includes("-")?!1:!!(qu.indexOf(e)>-1||/[A-Z]/u.test(e))}function Xu(e,t,n,{latestValues:s},i,r=!1,o,a){const l=(o??hi(e)?Uu:zu)(t,s,i,e),d=Qu(t,typeof e=="string",r,a),f=e!==p.Fragment?{...d,...l,ref:n}:{},{children:u}=t,m=p.useMemo(()=>me(u)?u.get():u,[u]);return p.createElement(e,{...f,children:m})}function Yu({scrapeMotionValuesFromProps:e,createRenderState:t},n,s,i){return{latestValues:Zu(n,s,i,e),renderState:t()}}function Zu(e,t,n,s){const i={},r=s(e,{});for(const u in r)i[u]=dn(r[u]);let{initial:o,animate:a}=e;const c=An(e),l=ia(e);t&&l&&!c&&e.inherit!==!1&&(o===void 0&&(o=t.initial),a===void 0&&(a=t.animate));let d=n?n.initial===!1:!1;d=d||o===!1;const f=d?a:o;if(f&&typeof f!="boolean"&&!Cn(f)){const u=Array.isArray(f)?f:[f];for(let m=0;m<u.length;m++){const y=Js(e,u[m]);if(y){const{transitionEnd:b,transition:w,...x}=y;for(const S in x){let v=x[S];if(Array.isArray(v)){const g=d?v.length-1:0;v=v[g]}v!==null&&(i[S]=v)}for(const S in b)i[S]=b[S]}}}return i}const Na=e=>(t,n)=>{const s=p.useContext(Pn),i=p.useContext(kn),r=()=>Yu(e,t,s,i);return n?r():Bs(r)},Ju=Na({scrapeMotionValuesFromProps:li,createRenderState:di}),ef=Na({scrapeMotionValuesFromProps:wa,createRenderState:La}),tf=Symbol.for("motionComponentSymbol");function nf(e,t,n){const s=p.useRef(n);p.useInsertionEffect(()=>{s.current=n});const i=p.useRef(null);return p.useCallback(r=>{r&&e.onMount?.(r),t&&(r?t.mount(r):t.unmount());const o=s.current;if(typeof o=="function")if(r){const a=o(r);typeof a=="function"&&(i.current=a)}else i.current?(i.current(),i.current=null):o(r);else o&&(o.current=r)},[t])}const Va=p.createContext({});function lt(e){return e&&typeof e=="object"&&Object.prototype.hasOwnProperty.call(e,"current")}function sf(e,t,n,s,i,r){const{visualElement:o}=p.useContext(Pn),a=p.useContext(Oa),c=p.useContext(kn),l=p.useContext(ci),d=l.reducedMotion,f=l.skipAnimations,u=p.useRef(null),m=p.useRef(!1);s=s||a.renderer,!u.current&&s&&(u.current=s(e,{visualState:t,parent:o,props:n,presenceContext:c,blockInitialAnimation:c?c.initial===!1:!1,reducedMotionConfig:d,skipAnimations:f,isSVG:r}),m.current&&u.current&&(u.current.manuallyAnimateOnMount=!0));const y=u.current,b=p.useContext(Va);y&&!y.projection&&i&&(y.type==="html"||y.type==="svg")&&of(u.current,n,i,b);const w=p.useRef(!1);p.useInsertionEffect(()=>{y&&w.current&&y.update(n,c)});const x=n[Gr],S=p.useRef(!!x&&typeof window<"u"&&!window.MotionHandoffIsComplete?.(x)&&window.MotionHasOptimisedAnimation?.(x));return un(()=>{m.current=!0,y&&(w.current=!0,window.MotionIsMounted=!0,y.updateFeatures(),y.scheduleRenderMicrotask(),S.current&&y.animationState&&y.animationState.animateChanges())}),p.useEffect(()=>{y&&(!S.current&&y.animationState&&y.animationState.animateChanges(),S.current&&(queueMicrotask(()=>{window.MotionHandoffMarkAsComplete?.(x)}),S.current=!1),y.enteringChildren=void 0)}),y}function of(e,t,n,s){const{layoutId:i,layout:r,drag:o,dragConstraints:a,layoutScroll:c,layoutRoot:l,layoutAnchor:d,layoutCrossfade:f}=t;e.projection=new n(e.latestValues,t["data-framer-portal-id"]?void 0:Ia(e.parent)),e.projection.setOptions({layoutId:i,layout:r,alwaysMeasureLayout:!!o||a&&lt(a),visualElement:e,animationType:typeof r=="string"?r:"both",initialPromotionConfig:s,crossfade:f,layoutScroll:c,layoutRoot:l,layoutAnchor:d})}function Ia(e){if(e)return e.options.allowProjection!==!1?e.projection:Ia(e.parent)}function zn(e,{forwardMotionProps:t=!1,type:n}={},s,i){s&&$u(s);const r=n?n==="svg":hi(e),o=r?ef:Ju;function a(l,d){let f;const u={...p.useContext(ci),...l,layoutId:rf(l)},{isStatic:m,isValidProp:y}=u,b=_u(l),w=o(l,m);if(!m&&typeof window<"u"){af();const x=lf(u);f=x.MeasureLayout,b.visualElement=sf(e,w,u,i,x.ProjectionNode,r)}return h.jsxs(Pn.Provider,{value:b,children:[f&&b.visualElement?h.jsx(f,{visualElement:b.visualElement,...u}):null,Xu(e,l,nf(w,b.visualElement,d),w,m,t,r,y)]})}a.displayName=`motion.${typeof e=="string"?e:`create(${e.displayName??e.name??""})`}`;const c=p.forwardRef(a);return c[tf]=e,c}function rf({layoutId:e}){const t=p.useContext(Is).id;return t&&e!==void 0?t+"-"+e:e}function af(e,t){p.useContext(Oa).strict}function lf(e){const t=Ra(),{drag:n,layout:s}=t;if(!n&&!s)return{};const i={...n,...s};return{MeasureLayout:n?.isEnabled(e)||s?.isEnabled(e)?i.MeasureLayout:void 0,ProjectionNode:i.ProjectionNode}}function cf(e,t){if(typeof Proxy>"u")return zn;const n=new Map,s=(r,o)=>zn(r,o,e,t),i=(r,o)=>s(r,o);return new Proxy(i,{get:(r,o)=>o==="create"?s:(n.has(o)||n.set(o,zn(o,void 0,e,t)),n.get(o))})}const df=(e,t)=>t.isSVG??hi(e)?new Bh(t):new jh(t,{allowProjection:e!==p.Fragment});class hf extends Ke{constructor(t){super(t),t.animationState||(t.animationState=Wh(t))}updateAnimationControlsSubscription(){const{animate:t}=this.node.getProps();Cn(t)&&(this.unmountControls=t.subscribe(this.node))}mount(){this.updateAnimationControlsSubscription()}update(){const{animate:t}=this.node.getProps(),{animate:n}=this.node.prevProps||{};t!==n&&this.updateAnimationControlsSubscription()}unmount(){this.node.animationState.reset(),this.unmountControls?.()}}let uf=0;class ff extends Ke{constructor(){super(...arguments),this.id=uf++,this.isExitComplete=!1}update(){if(!this.node.presenceContext)return;const{isPresent:t,onExitComplete:n}=this.node.presenceContext,{isPresent:s}=this.node.prevPresenceContext||{};if(!this.node.animationState||t===s)return;if(t&&s===!1){if(this.isExitComplete){const{initial:r,custom:o}=this.node.getProps();if(typeof r=="string"||typeof r=="object"&&r!==null&&!Array.isArray(r)){const a=et(this.node,r,o);if(a){const{transition:c,transitionEnd:l,...d}=a;for(const f in d)this.node.getValue(f)?.jump(d[f])}}this.node.animationState.reset(),this.node.animationState.animateChanges()}else this.node.animationState.setActive("exit",!1);this.isExitComplete=!1;return}const i=this.node.animationState.setActive("exit",!t);n&&!t&&i.then(()=>{this.isExitComplete=!0,n(this.id)})}mount(){const{register:t,onExitComplete:n}=this.node.presenceContext||{};n&&n(this.id),t&&(this.unmount=t(this.id))}unmount(){}}const pf={animation:{Feature:hf},exit:{Feature:ff}};function Bt(e){return{point:{x:e.pageX,y:e.pageY}}}const mf=e=>t=>si(t)&&e(t,Bt(t));function Pt(e,t,n,s){return Lt(e,t,mf(n),s)}const Ba=({current:e})=>e?e.ownerDocument.defaultView:null,Mo=(e,t)=>Math.abs(e-t);function gf(e,t){const n=Mo(e.x,t.x),s=Mo(e.y,t.y);return Math.sqrt(n**2+s**2)}const Do=new Set(["auto","scroll"]);class $a{constructor(t,n,{transformPagePoint:s,contextWindow:i=window,dragSnapToOrigin:r=!1,distanceThreshold:o=3,element:a}={}){if(this.startEvent=null,this.lastMoveEvent=null,this.lastMoveEventInfo=null,this.lastRawMoveEventInfo=null,this.handlers={},this.contextWindow=window,this.scrollPositions=new Map,this.removeScrollListeners=null,this.onElementScroll=y=>{this.handleScroll(y.target)},this.onWindowScroll=()=>{this.handleScroll(window)},this.updatePoint=()=>{if(!(this.lastMoveEvent&&this.lastMoveEventInfo))return;this.lastRawMoveEventInfo&&(this.lastMoveEventInfo=Kt(this.lastRawMoveEventInfo,this.transformPagePoint));const y=Un(this.lastMoveEventInfo,this.history),b=this.startEvent!==null,w=gf(y.offset,{x:0,y:0})>=this.distanceThreshold;if(!b&&!w)return;const{point:x}=y,{timestamp:S}=pe;this.history.push({...x,timestamp:S});const{onStart:v,onMove:g}=this.handlers;b||(v&&v(this.lastMoveEvent,y),this.startEvent=this.lastMoveEvent),g&&g(this.lastMoveEvent,y)},this.handlePointerMove=(y,b)=>{this.lastMoveEvent=y,this.lastRawMoveEventInfo=b,this.lastMoveEventInfo=Kt(b,this.transformPagePoint),te.update(this.updatePoint,!0)},this.handlePointerUp=(y,b)=>{this.end();const{onEnd:w,onSessionEnd:x,resumeAnimation:S}=this.handlers;if((this.dragSnapToOrigin||!this.startEvent)&&S&&S(),!(this.lastMoveEvent&&this.lastMoveEventInfo))return;const v=Un(y.type==="pointercancel"?this.lastMoveEventInfo:Kt(b,this.transformPagePoint),this.history);this.startEvent&&w&&w(y,v),x&&x(y,v)},!si(t))return;this.dragSnapToOrigin=r,this.handlers=n,this.transformPagePoint=s,this.distanceThreshold=o,this.contextWindow=i||window;const c=Bt(t),l=Kt(c,this.transformPagePoint),{point:d}=l,{timestamp:f}=pe;this.history=[{...d,timestamp:f}];const{onSessionStart:u}=n;u&&u(t,Un(l,this.history));const m={passive:!0,capture:!0};this.removeListeners=Nt(Pt(this.contextWindow,"pointermove",this.handlePointerMove,m),Pt(this.contextWindow,"pointerup",this.handlePointerUp,m),Pt(this.contextWindow,"pointercancel",this.handlePointerUp,m)),a&&this.startScrollTracking(a)}startScrollTracking(t){let n=t.parentElement;for(;n;){const s=getComputedStyle(n);(Do.has(s.overflowX)||Do.has(s.overflowY))&&this.scrollPositions.set(n,{x:n.scrollLeft,y:n.scrollTop}),n=n.parentElement}this.scrollPositions.set(window,{x:window.scrollX,y:window.scrollY}),window.addEventListener("scroll",this.onElementScroll,{capture:!0}),window.addEventListener("scroll",this.onWindowScroll),this.removeScrollListeners=()=>{window.removeEventListener("scroll",this.onElementScroll,{capture:!0}),window.removeEventListener("scroll",this.onWindowScroll)}}handleScroll(t){const n=this.scrollPositions.get(t);if(!n)return;const s=t===window,i=s?{x:window.scrollX,y:window.scrollY}:{x:t.scrollLeft,y:t.scrollTop},r={x:i.x-n.x,y:i.y-n.y};r.x===0&&r.y===0||(s?this.lastMoveEventInfo&&(this.lastMoveEventInfo.point.x+=r.x,this.lastMoveEventInfo.point.y+=r.y):this.history.length>0&&(this.history[0].x-=r.x,this.history[0].y-=r.y),this.scrollPositions.set(t,i),te.update(this.updatePoint,!0))}updateHandlers(t){this.handlers=t}end(){this.removeListeners&&this.removeListeners(),this.removeScrollListeners&&this.removeScrollListeners(),this.scrollPositions.clear(),Ge(this.updatePoint)}}function Kt(e,t){return t?{point:t(e.point)}:e}function Oo(e,t){return{x:e.x-t.x,y:e.y-t.y}}function Un({point:e},t){return{point:e,delta:Oo(e,Fa(t)),offset:Oo(e,yf(t)),velocity:wf(t,.1)}}function yf(e){return e[0]}function Fa(e){return e[e.length-1]}function wf(e,t){if(e.length<2)return{x:0,y:0};let n=e.length-1,s=null;const i=Fa(e);for(;n>=0&&(s=e[n],!(i.timestamp-s.timestamp>Pe(t)));)n--;if(!s)return{x:0,y:0};s===e[0]&&e.length>2&&i.timestamp-s.timestamp>Pe(t)*2&&(s=e[1]);const r=Ce(i.timestamp-s.timestamp);if(r===0)return{x:0,y:0};const o={x:(i.x-s.x)/r,y:(i.y-s.y)/r};return o.x===1/0&&(o.x=0),o.y===1/0&&(o.y=0),o}function bf(e,{min:t,max:n},s){return t!==void 0&&e<t?e=s?ee(t,e,s.min):Math.max(e,t):n!==void 0&&e>n&&(e=s?ee(n,e,s.max):Math.min(e,n)),e}function Ro(e,t,n){return{min:t!==void 0?e.min+t:void 0,max:n!==void 0?e.max+n-(e.max-e.min):void 0}}function xf(e,{top:t,left:n,bottom:s,right:i}){return{x:Ro(e.x,n,i),y:Ro(e.y,t,s)}}function jo(e,t){let n=t.min-e.min,s=t.max-e.max;return t.max-t.min<e.max-e.min&&([n,s]=[s,n]),{min:n,max:s}}function vf(e,t){return{x:jo(e.x,t.x),y:jo(e.y,t.y)}}function kf(e,t){let n=.5;const s=be(e),i=be(t);return i>s?n=Ot(t.min,t.max-s,e.min):s>i&&(n=Ot(e.min,e.max-i,t.min)),$e(0,1,n)}function Tf(e,t){const n={};return t.min!==void 0&&(n.min=t.min-e.min),t.max!==void 0&&(n.max=t.max-e.min),n}const Ms=.35;function Sf(e=Ms){return e===!1?e=0:e===!0&&(e=Ms),{x:Lo(e,"left","right"),y:Lo(e,"top","bottom")}}function Lo(e,t,n){return{min:No(e,t),max:No(e,n)}}function No(e,t){return typeof e=="number"?e:e[t]||0}const Cf=new WeakMap;class Af{constructor(t){this.openDragLock=null,this.isDragging=!1,this.currentDirection=null,this.originPoint={x:0,y:0},this.constraints=!1,this.hasMutatedConstraints=!1,this.elastic=ce(),this.latestPointerEvent=null,this.latestPanInfo=null,this.visualElement=t}start(t,{snapToCursor:n=!1,distanceThreshold:s}={}){const{presenceContext:i}=this.visualElement;if(i&&i.isPresent===!1)return;const r=f=>{n&&this.snapToCursor(Bt(f).point),this.stopAnimation()},o=(f,u)=>{const{drag:m,dragPropagation:y,onDragStart:b}=this.getProps();if(m&&!y&&(this.openDragLock&&this.openDragLock(),this.openDragLock=Zd(m),!this.openDragLock))return;this.latestPointerEvent=f,this.latestPanInfo=u,this.isDragging=!0,this.currentDirection=null,this.resolveConstraints(),this.visualElement.projection&&(this.visualElement.projection.isAnimationBlocked=!0,this.visualElement.projection.target=void 0),Ne(x=>{let S=this.getAxisMotionValue(x).get()||0;if(Be.test(S)){const{projection:v}=this.visualElement;if(v&&v.layout){const g=v.layout.layoutBox[x];g&&(S=be(g)*(parseFloat(S)/100))}}this.originPoint[x]=S}),b&&te.update(()=>b(f,u),!1,!0),bs(this.visualElement,"transform");const{animationState:w}=this.visualElement;w&&w.setActive("whileDrag",!0)},a=(f,u)=>{this.latestPointerEvent=f,this.latestPanInfo=u;const{dragPropagation:m,dragDirectionLock:y,onDirectionLock:b,onDrag:w}=this.getProps();if(!m&&!this.openDragLock)return;const{offset:x}=u;if(y&&this.currentDirection===null){this.currentDirection=Ef(x),this.currentDirection!==null&&b&&b(this.currentDirection);return}this.updateAxis("x",u.point,x),this.updateAxis("y",u.point,x),this.visualElement.render(),w&&te.update(()=>w(f,u),!1,!0)},c=(f,u)=>{this.latestPointerEvent=f,this.latestPanInfo=u,this.stop(f,u),this.latestPointerEvent=null,this.latestPanInfo=null},l=()=>{const{dragSnapToOrigin:f}=this.getProps();(f||this.constraints)&&this.startAnimation({x:0,y:0})},{dragSnapToOrigin:d}=this.getProps();this.panSession=new $a(t,{onSessionStart:r,onStart:o,onMove:a,onSessionEnd:c,resumeAnimation:l},{transformPagePoint:this.visualElement.getTransformPagePoint(),dragSnapToOrigin:d,distanceThreshold:s,contextWindow:Ba(this.visualElement),element:this.visualElement.current})}stop(t,n){const s=t||this.latestPointerEvent,i=n||this.latestPanInfo,r=this.isDragging;if(this.cancel(),!r||!i||!s)return;const{velocity:o}=i;this.startAnimation(o);const{onDragEnd:a}=this.getProps();a&&te.postRender(()=>a(s,i))}cancel(){this.isDragging=!1;const{projection:t,animationState:n}=this.visualElement;t&&(t.isAnimationBlocked=!1),this.endPanSession();const{dragPropagation:s}=this.getProps();!s&&this.openDragLock&&(this.openDragLock(),this.openDragLock=null),n&&n.setActive("whileDrag",!1)}endPanSession(){this.panSession&&this.panSession.end(),this.panSession=void 0}updateAxis(t,n,s){const{drag:i}=this.getProps();if(!s||!Qt(t,i,this.currentDirection))return;const r=this.getAxisMotionValue(t);let o=this.originPoint[t]+s[t];this.constraints&&this.constraints[t]&&(o=bf(o,this.constraints[t],this.elastic[t])),r.set(o)}resolveConstraints(){const{dragConstraints:t,dragElastic:n}=this.getProps(),s=this.visualElement.projection&&!this.visualElement.projection.layout?this.visualElement.projection.measure(!1):this.visualElement.projection?.layout,i=this.constraints;t&&lt(t)?this.constraints||(this.constraints=this.resolveRefConstraints()):t&&s?this.constraints=xf(s.layoutBox,t):this.constraints=!1,this.elastic=Sf(n),i!==this.constraints&&!lt(t)&&s&&this.constraints&&!this.hasMutatedConstraints&&Ne(r=>{this.constraints!==!1&&this.getAxisMotionValue(r)&&(this.constraints[r]=Tf(s.layoutBox[r],this.constraints[r]))})}resolveRefConstraints(){const{dragConstraints:t,onMeasureDragConstraints:n}=this.getProps();if(!t||!lt(t))return!1;const s=t.current,{projection:i}=this.visualElement;if(!i||!i.layout)return!1;i.root&&(i.root.scroll=void 0,i.root.updateScroll());const r=Ph(s,i.root,this.visualElement.getTransformPagePoint());let o=vf(i.layout.layoutBox,r);if(n){const a=n(Sh(o));this.hasMutatedConstraints=!!a,a&&(o=la(a))}return o}startAnimation(t){const{drag:n,dragMomentum:s,dragElastic:i,dragTransition:r,dragSnapToOrigin:o,onDragTransitionEnd:a}=this.getProps(),c=this.constraints||{},l=Ne(d=>{if(!Qt(d,n,this.currentDirection))return;let f=c&&c[d]||{};(o===!0||o===d)&&(f={min:0,max:0});const u=i?200:1e6,m=i?40:1e7,y={type:"inertia",velocity:s?t[d]:0,bounceStiffness:u,bounceDamping:m,timeConstant:750,restDelta:1,restSpeed:10,...r,...f};return this.startAxisValueAnimation(d,y)});return Promise.all(l).then(a)}startAxisValueAnimation(t,n){const s=this.getAxisMotionValue(t);return bs(this.visualElement,t),s.start(Zs(t,s,0,n,this.visualElement,!1))}stopAnimation(){Ne(t=>this.getAxisMotionValue(t).stop())}getAxisMotionValue(t){const n=`_drag${t.toUpperCase()}`,i=this.visualElement.getProps()[n];return i||this.visualElement.getValue(t,this.visualElement.latestValues[t]??0)}snapToCursor(t){Ne(n=>{const{drag:s}=this.getProps();if(!Qt(n,s,this.currentDirection))return;const{projection:i}=this.visualElement,r=this.getAxisMotionValue(n);if(i&&i.layout){const{min:o,max:a}=i.layout.layoutBox[n],c=r.get()||0;r.set(t[n]-ee(o,a,.5)+c)}})}scalePositionWithinConstraints(){if(!this.visualElement.current)return;const{drag:t,dragConstraints:n}=this.getProps(),{projection:s}=this.visualElement;if(!lt(n)||!s||!this.constraints)return;this.stopAnimation();const i={x:0,y:0};Ne(o=>{const a=this.getAxisMotionValue(o);if(a&&this.constraints!==!1){const c=a.get();i[o]=kf({min:c,max:c},this.constraints[o])}});const{transformTemplate:r}=this.visualElement.getProps();this.visualElement.current.style.transform=r?r({},""):"none",s.root&&s.root.updateScroll(),s.updateLayout(),this.constraints=!1,this.resolveConstraints(),Ne(o=>{if(!Qt(o,t,null))return;const a=this.getAxisMotionValue(o),{min:c,max:l}=this.constraints[o];a.set(ee(c,l,i[o]))}),this.visualElement.render()}addListeners(){if(!this.visualElement.current)return;Cf.set(this.visualElement,this);const t=this.visualElement.current,n=Pt(t,"pointerdown",l=>{const{drag:d,dragListener:f=!0}=this.getProps(),u=l.target,m=u!==t&&ih(u);d&&f&&!m&&this.start(l)});let s;const i=()=>{const{dragConstraints:l}=this.getProps();lt(l)&&l.current&&(this.constraints=this.resolveRefConstraints(),s||(s=Pf(t,l.current,()=>this.scalePositionWithinConstraints())))},{projection:r}=this.visualElement,o=r.addEventListener("measure",i);r&&!r.layout&&(r.root&&r.root.updateScroll(),r.updateLayout()),te.read(i);const a=Lt(window,"resize",()=>this.scalePositionWithinConstraints()),c=r.addEventListener("didUpdate",(({delta:l,hasLayoutChanged:d})=>{this.isDragging&&d&&(Ne(f=>{const u=this.getAxisMotionValue(f);u&&(this.originPoint[f]+=l[f].translate,u.set(u.get()+l[f].translate))}),this.visualElement.render())}));return()=>{a(),n(),o(),c&&c(),s&&s()}}getProps(){const t=this.visualElement.getProps(),{drag:n=!1,dragDirectionLock:s=!1,dragPropagation:i=!1,dragConstraints:r=!1,dragElastic:o=Ms,dragMomentum:a=!0}=t;return{...t,drag:n,dragDirectionLock:s,dragPropagation:i,dragConstraints:r,dragElastic:o,dragMomentum:a}}}function Vo(e){let t=!0;return()=>{if(t){t=!1;return}e()}}function Pf(e,t,n){const s=Hi(e,Vo(n)),i=Hi(t,Vo(n));return()=>{s(),i()}}function Qt(e,t,n){return(t===!0||t===e)&&(n===null||n===e)}function Ef(e,t=10){let n=null;return Math.abs(e.y)>t?n="y":Math.abs(e.x)>t&&(n="x"),n}class Mf extends Ke{constructor(t){super(t),this.removeGroupControls=Ae,this.removeListeners=Ae,this.controls=new Af(t)}mount(){const{dragControls:t}=this.node.getProps();t&&(this.removeGroupControls=t.subscribe(this.controls)),this.removeListeners=this.controls.addListeners()||Ae}update(){const{dragControls:t}=this.node.getProps(),{dragControls:n}=this.node.prevProps||{};t!==n&&(this.removeGroupControls(),t&&(this.removeGroupControls=t.subscribe(this.controls)))}unmount(){this.removeGroupControls(),this.removeListeners(),this.controls.isDragging||this.controls.endPanSession()}}const Gn=e=>(t,n)=>{e&&te.update(()=>e(t,n),!1,!0)};class Df extends Ke{constructor(){super(...arguments),this.removePointerDownListener=Ae}onPointerDown(t){this.session=new $a(t,this.createPanHandlers(),{transformPagePoint:this.node.getTransformPagePoint(),contextWindow:Ba(this.node)})}createPanHandlers(){const{onPanSessionStart:t,onPanStart:n,onPan:s,onPanEnd:i}=this.node.getProps();return{onSessionStart:Gn(t),onStart:Gn(n),onMove:Gn(s),onEnd:(r,o)=>{delete this.session,i&&te.postRender(()=>i(r,o))}}}mount(){this.removePointerDownListener=Pt(this.node.current,"pointerdown",t=>this.onPointerDown(t))}update(){this.session&&this.session.updateHandlers(this.createPanHandlers())}unmount(){this.removePointerDownListener(),this.session&&this.session.end()}}let Kn=!1;class Of extends p.Component{componentDidMount(){const{visualElement:t,layoutGroup:n,switchLayoutGroup:s,layoutId:i}=this.props,{projection:r}=t;r&&(n.group&&n.group.add(r),s&&s.register&&i&&s.register(r),Kn&&r.root.didUpdate(),r.addEventListener("animationComplete",()=>{this.safeToRemove()}),r.setOptions({...r.options,layoutDependency:this.props.layoutDependency,onExitComplete:()=>this.safeToRemove()})),hn.hasEverUpdated=!0}getSnapshotBeforeUpdate(t){const{layoutDependency:n,visualElement:s,drag:i,isPresent:r}=this.props,{projection:o}=s;return o&&(o.isPresent=r,t.layoutDependency!==n&&o.setOptions({...o.options,layoutDependency:n}),Kn=!0,i||t.layoutDependency!==n||n===void 0||t.isPresent!==r?o.willUpdate():this.safeToRemove(),t.isPresent!==r&&(r?o.promote():o.relegate()||te.postRender(()=>{const a=o.getStack();(!a||!a.members.length)&&this.safeToRemove()}))),null}componentDidUpdate(){const{visualElement:t,layoutAnchor:n}=this.props,{projection:s}=t;s&&(s.options.layoutAnchor=n,s.root.didUpdate(),ni.postRender(()=>{!s.currentAnimation&&s.isLead()&&this.safeToRemove()}))}componentWillUnmount(){const{visualElement:t,layoutGroup:n,switchLayoutGroup:s}=this.props,{projection:i}=t;Kn=!0,i&&(i.scheduleCheckAfterUnmount(),n&&n.group&&n.group.remove(i),s&&s.deregister&&s.deregister(i))}safeToRemove(){const{safeToRemove:t}=this.props;t&&t()}render(){return null}}function _a(e){const[t,n]=Da(),s=p.useContext(Is);return h.jsx(Of,{...e,layoutGroup:s,switchLayoutGroup:p.useContext(Va),isPresent:t,safeToRemove:n})}const Rf={pan:{Feature:Df},drag:{Feature:Mf,ProjectionNode:Ma,MeasureLayout:_a}};function Io(e,t,n){const{props:s}=e;e.animationState&&s.whileHover&&e.animationState.setActive("whileHover",n==="Start");const i="onHover"+n,r=s[i];r&&te.postRender(()=>r(t,Bt(t)))}class jf extends Ke{mount(){const{current:t}=this.node;t&&(this.unmount=eh(t,(n,s)=>(Io(this.node,s,"Start"),i=>Io(this.node,i,"End"))))}unmount(){}}class Lf extends Ke{constructor(){super(...arguments),this.isActive=!1}onFocus(){let t=!1;try{t=this.node.current.matches(":focus-visible")}catch{t=!0}!t||!this.node.animationState||(this.node.animationState.setActive("whileFocus",!0),this.isActive=!0)}onBlur(){!this.isActive||!this.node.animationState||(this.node.animationState.setActive("whileFocus",!1),this.isActive=!1)}mount(){this.unmount=Nt(Lt(this.node.current,"focus",()=>this.onFocus()),Lt(this.node.current,"blur",()=>this.onBlur()))}unmount(){}}function Bo(e,t,n){const{props:s}=e;if(e.current instanceof HTMLButtonElement&&e.current.disabled)return;e.animationState&&s.whileTap&&e.animationState.setActive("whileTap",n==="Start");const i="onTap"+(n==="End"?"":n),r=s[i];r&&te.postRender(()=>r(t,Bt(t)))}class Nf extends Ke{mount(){const{current:t}=this.node;if(!t)return;const{globalTapTarget:n,propagate:s}=this.node.props;this.unmount=rh(t,(i,r)=>(Bo(this.node,r,"Start"),(o,{success:a})=>Bo(this.node,o,a?"End":"Cancel")),{useGlobalTarget:n,stopPropagation:s?.tap===!1})}unmount(){}}const Ds=new WeakMap,Qn=new WeakMap,Vf=e=>{const t=Ds.get(e.target);t&&t(e)},If=e=>{e.forEach(Vf)};function Bf({root:e,...t}){const n=e||document;Qn.has(n)||Qn.set(n,{});const s=Qn.get(n),i=JSON.stringify(t);return s[i]||(s[i]=new IntersectionObserver(If,{root:e,...t})),s[i]}function $f(e,t,n){const s=Bf(t);return Ds.set(e,n),s.observe(e),()=>{Ds.delete(e),s.unobserve(e)}}const Ff={some:0,all:1};class _f extends Ke{constructor(){super(...arguments),this.hasEnteredView=!1,this.isInView=!1}startObserver(){this.stopObserver?.();const{viewport:t={}}=this.node.getProps(),{root:n,margin:s,amount:i="some",once:r}=t,o={root:n?n.current:void 0,rootMargin:s,threshold:typeof i=="number"?i:Ff[i]},a=c=>{const{isIntersecting:l}=c;if(this.isInView===l||(this.isInView=l,r&&!l&&this.hasEnteredView))return;l&&(this.hasEnteredView=!0),this.node.animationState&&this.node.animationState.setActive("whileInView",l);const{onViewportEnter:d,onViewportLeave:f}=this.node.getProps(),u=l?d:f;u&&u(c)};this.stopObserver=$f(this.node.current,o,a)}mount(){this.startObserver()}update(){if(typeof IntersectionObserver>"u")return;const{props:t,prevProps:n}=this.node;["amount","margin","root"].some(Hf(t,n))&&this.startObserver()}unmount(){this.stopObserver?.(),this.hasEnteredView=!1,this.isInView=!1}}function Hf({viewport:e={}},{viewport:t={}}={}){return n=>e[n]!==t[n]}const Wf={inView:{Feature:_f},tap:{Feature:Nf},focus:{Feature:Lf},hover:{Feature:jf}},zf={layout:{ProjectionNode:Ma,MeasureLayout:_a}},Uf={...pf,...Wf,...Rf,...zf},Gf=cf(Uf,df),Kf=Gf;function qt(e){throw new Error('Could not dynamically require "'+e+'". Please configure the dynamicRequireTargets or/and ignoreDynamicRequires option of @rollup/plugin-commonjs appropriately for this require call to work.')}var qn={exports:{}},$o;function Qf(){return $o||($o=1,(function(e,t){(function(n){e.exports=n()})(function(){return(function(){function n(s,i,r){function o(l,d){if(!i[l]){if(!s[l]){var f=typeof qt=="function"&&qt;if(!d&&f)return f(l,!0);if(a)return a(l,!0);var u=new Error("Cannot find module '"+l+"'");throw u.code="MODULE_NOT_FOUND",u}var m=i[l]={exports:{}};s[l][0].call(m.exports,function(y){var b=s[l][1][y];return o(b||y)},m,m.exports,n,s,i,r)}return i[l].exports}for(var a=typeof qt=="function"&&qt,c=0;c<r.length;c++)o(r[c]);return o}return n})()({1:[function(n,s,i){Object.defineProperty(i,"__esModule",{value:!0}),i.default=void 0;function r(u){"@babel/helpers - typeof";return r=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(m){return typeof m}:function(m){return m&&typeof Symbol=="function"&&m.constructor===Symbol&&m!==Symbol.prototype?"symbol":typeof m},r(u)}function o(u,m){if(!(u instanceof m))throw new TypeError("Cannot call a class as a function")}function a(u,m){for(var y=0;y<m.length;y++){var b=m[y];b.enumerable=b.enumerable||!1,b.configurable=!0,"value"in b&&(b.writable=!0),Object.defineProperty(u,l(b.key),b)}}function c(u,m,y){return m&&a(u.prototype,m),Object.defineProperty(u,"prototype",{writable:!1}),u}function l(u){var m=d(u,"string");return r(m)=="symbol"?m:m+""}function d(u,m){if(r(u)!="object"||!u)return u;var y=u[Symbol.toPrimitive];if(y!==void 0){var b=y.call(u,m);if(r(b)!="object")return b;throw new TypeError("@@toPrimitive must return a primitive value.")}return String(u)}i.default=(function(){function u(){var m=this,y=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{},b=y.defaultLayoutOptions,w=b===void 0?{}:b,x=y.algorithms,S=x===void 0?["layered","stress","mrtree","radial","force","disco","sporeOverlap","sporeCompaction","rectpacking"]:x,v=y.workerFactory,g=y.workerUrl;if(o(this,u),this.defaultLayoutOptions=w,this.initialized=!1,typeof g>"u"&&typeof v>"u")throw new Error("Cannot construct an ELK without both 'workerUrl' and 'workerFactory'.");var k=v;typeof g<"u"&&typeof v>"u"&&(k=function(E){return new Worker(E)});var P=k(g);if(typeof P.postMessage!="function")throw new TypeError("Created worker does not provide the required 'postMessage' function.");this.worker=new f(P),this.worker.postMessage({cmd:"register",algorithms:S}).then(function(C){return m.initialized=!0}).catch(console.err)}return c(u,[{key:"layout",value:function(y){var b=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},w=b.layoutOptions,x=w===void 0?this.defaultLayoutOptions:w,S=b.logging,v=S===void 0?!1:S,g=b.measureExecutionTime,k=g===void 0?!1:g;return y?this.worker.postMessage({cmd:"layout",graph:y,layoutOptions:x,options:{logging:v,measureExecutionTime:k}}):Promise.reject(new Error("Missing mandatory parameter 'graph'."))}},{key:"knownLayoutAlgorithms",value:function(){return this.worker.postMessage({cmd:"algorithms"})}},{key:"knownLayoutOptions",value:function(){return this.worker.postMessage({cmd:"options"})}},{key:"knownLayoutCategories",value:function(){return this.worker.postMessage({cmd:"categories"})}},{key:"terminateWorker",value:function(){this.worker&&this.worker.terminate()}}])})();var f=(function(){function u(m){var y=this;if(o(this,u),m===void 0)throw new Error("Missing mandatory parameter 'worker'.");this.resolvers={},this.worker=m,this.worker.onmessage=function(b){setTimeout(function(){y.receive(y,b)},0)}}return c(u,[{key:"postMessage",value:function(y){var b=this.id||0;this.id=b+1,y.id=b;var w=this;return new Promise(function(x,S){w.resolvers[b]=function(v,g){v?(w.convertGwtStyleError(v),S(v)):x(g)},w.worker.postMessage(y)})}},{key:"receive",value:function(y,b){var w=b.data,x=y.resolvers[w.id];x&&(delete y.resolvers[w.id],w.error?x(w.error):x(null,w.data))}},{key:"terminate",value:function(){this.worker&&this.worker.terminate()}},{key:"convertGwtStyleError",value:function(y){if(y){var b=y.__java$exception;b&&(b.cause&&b.cause.backingJsObject&&(y.cause=b.cause.backingJsObject,this.convertGwtStyleError(y.cause)),delete y.__java$exception)}}}])})()},{}],2:[function(n,s,i){var r=n("./elk-api.js").default;Object.defineProperty(s.exports,"__esModule",{value:!0}),s.exports=r,r.default=r},{"./elk-api.js":1}]},{},[2])(2)})})(qn)),qn.exports}var qf=Qf();const Xf=Tl(qf),Yf="/dynamic-model-var-docs/assets/elk-worker.min-r_yRvuMO.js";class Zf{elk=null;ensure(){return this.elk||(this.elk=new Xf({workerUrl:Yf})),this.elk}async layout(t,n={}){const{direction:s="DOWN",nodeSpacing:i=32,layerSpacing:r=56,usePartitions:o=!1,extraLayoutOptions:a={}}=n,c={id:"root",layoutOptions:{"elk.algorithm":"layered","elk.direction":s,"elk.spacing.nodeNode":String(i),"elk.layered.spacing.nodeNodeBetweenLayers":String(r),"elk.edgeRouting":"ORTHOGONAL","elk.layered.considerModelOrder.strategy":"NODES_AND_EDGES",...o?{"elk.partitioning.activate":"true"}:{},...a},children:t.nodes.map(w=>({id:w.id,width:w.width,height:w.height,...w.ports?.length?{ports:w.ports.map(x=>({id:x.id,x:x.x,y:x.y,width:0,height:0}))}:{},...o&&w.partition!==void 0||w.ports?.length?{layoutOptions:{...o&&w.partition!==void 0?{"elk.partitioning.partition":String(w.partition)}:{},...w.ports?.length?{"elk.portConstraints":"FIXED_POS"}:{}}}:{}})),edges:t.edges.filter(w=>w.source!==w.target).map(w=>({id:w.id,sources:[w.sourcePort??w.source],targets:[w.targetPort??w.target]}))},l=new Map(t.edges.map(w=>[w.id,w]));this.elk;const d=performance.now(),f=await this.ensure().layout(c);performance.now()-d,t.nodes.length,t.edges.length;const u=(f.children??[]).map(w=>({id:w.id,x:w.x??0,y:w.y??0,width:w.width??0,height:w.height??0})),m=(f.edges??[]).map(w=>{const x=l.get(w.id);if(!x)throw new Error(`ELK returned unknown edge id: ${w.id}`);return{id:w.id,source:x.source,target:x.target,sections:w.sections}}),y=Math.max(0,...u.map(w=>w.x+w.width)),b=Math.max(0,...u.map(w=>w.y+w.height));return{nodes:u,edges:m,width:y,height:b}}cancel(){this.elk&&(this.elk.terminateWorker(),this.elk=null)}dispose(){this.cancel()}}function Xt(e){if(!e?.length)return[];const t=e[0];return[t.startPoint,...t.bendPoints??[],t.endPoint]}function Fo(e,t,n){const s=t.x-e.x,i=t.y-e.y,r=Math.hypot(s,i);if(r<1e-6)return{...e};const o=Math.min(n,r/2)/r;return{x:e.x+s*o,y:e.y+i*o}}function Jf(e,t){if(e.length<2)return ep(e);let n=`M${e[0].x},${e[0].y}`;for(let i=1;i<e.length-1;i++){const r=Fo(e[i],e[i-1],t),o=Fo(e[i],e[i+1],t);n+=`L${r.x},${r.y}Q${e[i].x},${e[i].y} ${o.x},${o.y}`}const s=e[e.length-1];return`${n}L${s.x},${s.y}`}function ep(e){return e.length?e.map((t,n)=>`${n===0?"M":"L"}${t.x},${t.y}`).join(""):""}function tp(e,t){let n=0,s=e.length-1,i=e[e.length-1];for(let r=e.length-1;r>0;r--){const o=Math.hypot(e[r].x-e[r-1].x,e[r].y-e[r-1].y);if(n+o>=t){const a=(t-n)/o;i={x:e[r].x+(e[r-1].x-e[r].x)*a,y:e[r].y+(e[r-1].y-e[r].y)*a},s=r-1;break}n+=o,s=r-1}return{cut:s,cutPoint:i}}function np(e,t,n,s){if(e.length<2||n<=0)return s(e);const{cut:i,cutPoint:r}=tp(e,n),o=e.slice(0,i+1),a=o[o.length-1],c=a&&Math.abs(a.x-r.x)<1e-6&&Math.abs(a.y-r.y)<1e-6;return s([...o,...c?[]:[r],t])}function sp(e,t=1.5){if(e.length<3)return e;const n=[e[0]];for(let s=1;s<e.length-1;s++){const i=n[n.length-1],r=e[s],o=e[s+1],a=o.x-i.x,c=o.y-i.y,l=Math.hypot(a,c);(l<1e-6?Math.hypot(r.x-i.x,r.y-i.y):Math.abs(c*r.x-a*r.y+o.x*i.y-o.y*i.x)/l)>t&&n.push(r)}return n.push(e[e.length-1]),n}function ip(e,t,n,s){const i=Math.hypot(t.x,t.y)||1,r=t.x/i,o=t.y/i,a=-o,c=r,l=n/2,d={x:e.x+a*l,y:e.y+c*l},f={x:e.x-a*l,y:e.y-c*l},u={x:e.x+r*s,y:e.y+o*s};return`M${d.x},${d.y}L${u.x},${u.y}L${f.x},${f.y}Z`}function op(e,t,n,s,i=16){const r={x:e.x+n.x*i,y:e.y+n.y*i},o={x:t.x+s.x*i,y:t.y+s.y*i},a=[e,r];if(Math.abs(n.x)>.5){const c=(r.x+o.x)/2;Math.abs(r.y-o.y)>.5&&a.push({x:c,y:r.y},{x:c,y:o.y})}else{const c=(r.y+o.y)/2;Math.abs(r.x-o.x)>.5&&a.push({x:r.x,y:c},{x:o.x,y:c})}return a.push(o,t),sp(a)}function rp(e,t={}){const n=p.useRef(null);n.current||(n.current=new Zf);const[s,i]=p.useState(null),[r,o]=p.useState(!1),a=JSON.stringify(t);p.useEffect(()=>{const d=n.current;if(!e||e.nodes.length===0){i(null),o(!1);return}let f=!1;return o(!0),d.layout(e,JSON.parse(a)).then(u=>{f||(i({spec:e,layout:u}),o(!1))},u=>{f||(o(!1),console.error("graph-core layout failed:",u))}),()=>{f=!0,d.cancel()}},[e,a]),p.useEffect(()=>()=>n.current?.dispose(),[]);const c=!!e&&e.nodes.length>0,l=!s||s.spec!==e;return{latest:s,inProgress:(r||l)&&c}}const ap=300,lp=100,cp=200,dp=75,hp=250,up=120,fp=200,pp=[.65,0,.35,1],Yt=e=>e/1e3,mp=()=>typeof window<"u"&&typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches,$t=e=>()=>mp()?0:e,Ha=$t(ap),_o=$t(lp),gp=$t(cp),yp=$t(dp),wp=$t(hp),Zt=()=>up,Ho=.5;function bp(e={}){const{min:t=.2,max:n=2}=e,s=p.useRef(null),i=p.useRef(null),r=p.useRef(null),o=p.useRef(1),a=p.useRef({w:0,h:0}),c=p.useRef(null),l=p.useRef(null),d=p.useRef(!0),f=p.useRef(!0),u=p.useCallback(()=>{const v=s.current;return v?{x:v.clientWidth*Ho,y:v.clientHeight*Ho}:{x:0,y:0}},[]),m=p.useCallback(v=>{const g=i.current;if(g){const{x:k,y:P}=u();g.style.transition=v?`width ${v}ms, height ${v}ms`:"",g.style.padding=`${P}px ${k}px`,g.style.width=`${a.current.w*o.current+2*k}px`,g.style.height=`${a.current.h*o.current+2*P}px`}},[u]),y=p.useCallback((v,g)=>{o.current=Math.min(n,Math.max(t,v));const k=g?Ha():0;c.current&&cancelAnimationFrame(c.current),c.current=requestAnimationFrame(()=>{c.current=null;const P=r.current;P&&(P.style.transition=k?`transform ${k}ms`:"",P.style.transform=`scale(${o.current})`)}),l.current&&(clearTimeout(l.current),l.current=null),k?m(k):l.current=setTimeout(()=>{l.current=null,m(0)},100)},[t,n,m]),b=p.useCallback((v,g=!0)=>{d.current=!1,y(v,g)},[y]),w=p.useCallback(v=>b(o.current*v),[b]),x=p.useCallback((v,g)=>{a.current={w:v,h:g};const k=r.current;k&&(k.style.width=`${v}px`,k.style.height=`${g}px`,k.style.transformOrigin="0 0",k.style.transform=`scale(${o.current})`),m(0)},[m]),S=p.useCallback(()=>{const v=s.current,{w:g,h:k}=a.current;if(!v||!g||!k)return;d.current=!0;const P=!f.current;f.current=!1,y(Math.min(v.clientWidth/g,v.clientHeight/k,1),P),requestAnimationFrame(()=>{const{x:C,y:E}=u();typeof v.scrollTo=="function"?v.scrollTo({left:C,top:E,behavior:P?"smooth":"auto"}):(v.scrollLeft=C,v.scrollTop=E)})},[y,u]);return p.useEffect(()=>{const v=s.current;if(!v)return;const g=k=>{!k.ctrlKey&&!k.metaKey||(k.preventDefault(),b(o.current*(1-k.deltaY*.005),!1))};return v.addEventListener("wheel",g,{passive:!1}),()=>v.removeEventListener("wheel",g)},[b]),p.useEffect(()=>{const v=s.current;if(!v)return;let g=!1,k=0,P=0,C=0,E=0,N=!1;const z=H=>H instanceof Element&&!H.closest("[data-pan-ignore]"),_=H=>{H.button!==0||!z(H.target)||(g=!0,N=!1,k=H.clientX,P=H.clientY,C=v.scrollLeft,E=v.scrollTop,v.style.cursor="grabbing")},I=H=>{if(!g)return;const Z=H.clientX-k,ne=H.clientY-P;!N&&Math.hypot(Z,ne)<3||(N||(N=!0,v.setPointerCapture(H.pointerId)),H.preventDefault(),v.scrollLeft=C-Z,v.scrollTop=E-ne)},R=H=>{g&&(g=!1,v.style.cursor="",v.hasPointerCapture(H.pointerId)&&v.releasePointerCapture(H.pointerId))};return v.addEventListener("pointerdown",_),v.addEventListener("pointermove",I),v.addEventListener("pointerup",R),v.addEventListener("pointercancel",R),()=>{v.removeEventListener("pointerdown",_),v.removeEventListener("pointermove",I),v.removeEventListener("pointerup",R),v.removeEventListener("pointercancel",R)}},[]),{containerRef:s,spacerRef:i,wrapperRef:r,applyZoom:b,zoomBy:w,zoomToFit:S,getZoom:()=>o.current,isAutoFit:()=>d.current,setContentSize:x}}const xp=2;function Wa({kind:e,width:t=44,className:n}){const s=p.useId().replace(/:/g,""),i=e==="association"?xe.association:e==="own-bkwd"?xe.ownBkwd:xe.ownFwd,r=e==="own-bkwd",o=e==="association",a=`es-${s}`,c=o?6:1,l=t-6;return h.jsxs("svg",{width:t,height:"14",viewBox:`0 0 ${t} 14`,className:`shrink-0 ${n??""}`,"aria-hidden":!0,children:[h.jsx("defs",{children:h.jsx("marker",{id:a,markerWidth:"5",markerHeight:"5",refX:r?.5:4.5,refY:"2.5",orient:"auto-start-reverse",markerUnits:"userSpaceOnUse",children:h.jsx("path",{d:r?"M5,0 L0,2.5 L5,5 z":"M0,0 L5,2.5 L0,5 z",fill:i})})}),h.jsx("line",{x1:c,y1:"7",x2:l,y2:"7",stroke:i,strokeWidth:xp,strokeDasharray:e==="association"?"5 4":void 0,markerStart:o?`url(#${a})`:void 0,markerEnd:`url(#${a})`})]})}const za={"owned-mine":{side:"left",kind:"own-bkwd"},"owned-theirs":{side:"left",kind:"own-fwd"},"owns-mine":{side:"right",kind:"own-fwd"},"owns-theirs":{side:"right",kind:"own-bkwd"},association:{side:"left",kind:"association"}},vp=300,Os=new Set;let Et;function ui(){Et!==void 0&&(clearTimeout(Et),Et=void 0)}function kt(e){ui();for(const t of Os)t(e)}function Ua(){ui(),Et=setTimeout(()=>{Et=void 0,kt(null)},vp)}function kp({label:e,rows:t,onAdd:n,onRemove:s,onInspect:i,colorOf:r,slotOrder:o,parentOf:a}){const[c,l]=p.useState(null),[d,f]=p.useState(null),u=p.useRef(null),m=p.useRef(null),y=p.useId();p.useEffect(()=>{const k=P=>{P!==y&&(l(null),f(null))};return Os.add(k),()=>{Os.delete(k)}},[y]),p.useEffect(()=>{if(!c)return;const k=C=>{C.target?.closest("[data-relation-bar]")||kt(null)},P=C=>{C.key==="Escape"&&kt(null)};return document.addEventListener("mousedown",k,!0),document.addEventListener("keydown",P),()=>{document.removeEventListener("mousedown",k,!0),document.removeEventListener("keydown",P)}},[c]);const b=k=>t.filter(P=>za[P.position].side===k),w=k=>new Set(b(k).map(P=>P.other)).size,x=w("left"),S=w("right");if(x===0&&S===0)return null;const v=(k,P)=>{const C=P?.getBoundingClientRect();C&&(kt(y),l(k),f({x:C.left,y:C.bottom+2}))},g=(k,P,C)=>{const E=c===k;return h.jsx("button",{ref:C,"data-relation-bar":!0,"data-no-drag":!0,disabled:P===0,"aria-label":k==="left"?`${P} classes ${e} belongs to`:`${P} classes ${e} owns`,onMouseEnter:()=>P>0&&v(k,C.current),onMouseLeave:Ua,onClick:N=>{N.stopPropagation(),P!==0&&(E?kt(null):v(k,C.current))},className:`flex items-center gap-1 px-1.5 py-0.5 rounded text-[10px] leading-none
                    tabular-nums transition-colors
                    ${P===0?"text-gray-300 dark:text-slate-600 cursor-default":E?"bg-sky-200 dark:bg-sky-800 text-sky-900 dark:text-sky-100":"text-sky-800 dark:text-sky-200 hover:bg-sky-100 dark:hover:bg-sky-900"}`,children:k==="left"?h.jsxs(h.Fragment,{children:[h.jsx("span",{"aria-hidden":!0,children:"←"}),P]}):h.jsxs(h.Fragment,{children:[P,h.jsx("span",{"aria-hidden":!0,children:"→"})]})})};return h.jsxs(h.Fragment,{children:[g("left",x,u),h.jsx("span",{className:`flex-1 min-w-0 text-center text-[9px] text-gray-400
                       dark:text-slate-500 truncate select-none`,children:"related"}),g("right",S,m),c&&d&&tr.createPortal(h.jsx(Sp,{anchor:d,side:c,label:e,rows:b(c),onAdd:n,onRemove:s,onInspect:i,colorOf:r,slotOrder:o,parentOf:a}),document.body)]})}function Tp(e){const t=p.useRef(null),[n,s]=p.useState(e);return p.useEffect(()=>{const i=t.current;if(!i)return;const r=i.getBoundingClientRect(),o=8;s({x:Math.max(o,Math.min(e.x,window.innerWidth-r.width-o)),y:Math.max(o,Math.min(e.y,window.innerHeight-r.height-o))})},[e]),{ref:t,pos:n}}function Sp({anchor:e,side:t,label:n,rows:s,onAdd:i,onRemove:r,onInspect:o,colorOf:a,slotOrder:c,parentOf:l}){const{ref:d,pos:f}=Tp(e),u=g=>{const k=c?.indexOf(g.slot)??-1;return k===-1?Number.MAX_SAFE_INTEGER:k},m=[...s].sort((g,k)=>u(g)-u(k)||g.other.localeCompare(k.other)||g.slot.localeCompare(k.slot)),y=new Map,b=new Set;if(l){const g=new Map(m.map(k=>[`${k.slot}|${k.other}`,k]));for(const k of m){const P=l(k.other),C=P===void 0?void 0:g.get(`${k.slot}|${P}`);if(!C||C===k)continue;b.add(k);const E=`${k.slot}|${P}`;y.set(E,[...y.get(E)??[],k])}}const w=[],x=(g,k)=>{w.push({row:g,depth:k});for(const P of y.get(`${g.slot}|${g.other}`)??[])x(P,k+1)};for(const g of m)b.has(g)||x(g,0);const S=m.every(g=>g.drawn),v=[...new Set(m.map(g=>g.other))];return h.jsxs("div",{ref:d,"data-relation-bar":!0,onMouseEnter:ui,onMouseLeave:Ua,style:{left:f.x,top:f.y},className:`fixed z-50 w-max max-w-[min(46rem,calc(100vw-2rem))] max-h-[60vh]
                 overflow-y-auto overflow-x-hidden py-1
                 rounded-md border border-gray-300 dark:border-slate-600
                 bg-white dark:bg-slate-800 shadow-xl
                 text-gray-900 dark:text-gray-100`,children:[h.jsx("div",{className:"px-3 py-1 border-b border-gray-200 dark:border-slate-700",children:h.jsxs("div",{className:"text-[11px] font-semibold",children:[h.jsx("b",{children:n})," ",t==="left"?"belongs to":"owns"," ",v.length," ",v.length===1?"entity":"distinct entities",m.length!==v.length&&h.jsxs("span",{className:"font-normal text-gray-500 dark:text-slate-400",children:[" ","through ",m.length," attributes"]})]})}),h.jsx("button",{onClick:()=>v.forEach(g=>S?r(g):i(g)),className:`block w-full text-left px-3 py-1 text-[11px]
                   text-blue-600 dark:text-blue-400
                   hover:bg-gray-100 dark:hover:bg-slate-700`,children:S?`hide all ${v.length} entities`:`add all ${v.length} entities`}),h.jsx("table",{className:"w-full text-[11px]",children:h.jsx("tbody",{children:w.map(({row:g,depth:k})=>{const P=za[g.position].kind,C=k>0&&h.jsx("span",{"aria-hidden":!0,className:"text-gray-400 dark:text-slate-500 select-none",style:{paddingLeft:`${(k-1)*.75}rem`},children:"↳ "}),E=g.declaredBy===g.other?n:g.declaredBy,N=t==="left"?g.other:E,z=t==="left"?E:g.other;return h.jsxs("tr",{"data-family-depth":k,className:"hover:bg-gray-100 dark:hover:bg-slate-700",children:[h.jsx("td",{className:"pl-2 pr-1 py-0.5",children:h.jsx("button",{onClick:_=>{_.stopPropagation(),(g.drawn?r:i)(g.other)},"aria-label":g.drawn?`Remove ${g.other} from the diagram`:`Add ${g.other} to the diagram`,className:`w-4 h-4 rounded-sm leading-none text-[11px]
                                flex items-center justify-center border
                                ${g.drawn?"border-sky-300 bg-sky-50 text-sky-700 hover:bg-sky-200 dark:border-sky-700 dark:bg-sky-950 dark:text-sky-300":"border-gray-300 text-gray-400 hover:bg-gray-100 hover:text-gray-700 dark:border-slate-600 dark:hover:bg-slate-600"}`,children:g.drawn?"−":"+"})}),h.jsxs("td",{className:"pl-1 pr-2 py-0.5 text-right whitespace-nowrap",children:[t==="left"&&C,h.jsx(Wo,{cls:N,row:g,colorOf:a,onInspect:o})]}),h.jsx("td",{className:`px-2 py-0.5 font-mono text-gray-400 dark:text-slate-500
                               whitespace-nowrap tabular-nums text-right`,children:g.cardinality}),h.jsx("td",{className:"px-1 py-0.5 align-middle",children:h.jsx(Wa,{kind:P,width:30})}),h.jsxs("td",{className:"pr-3 py-0.5 whitespace-nowrap",children:[t==="right"&&C,h.jsx(Wo,{cls:z,row:g,colorOf:a,onInspect:o})]})]},`${g.declaredBy}.${g.slot}->${g.other}`)})})})]})}function Wo({cls:e,row:t,colorOf:n,onInspect:s}){const i=n?.(e),r=e===t.declaredBy,o=i?{color:i.text}:void 0;return h.jsxs("span",{className:"font-mono",children:[s?h.jsx("button",{onClick:a=>{a.stopPropagation(),s(e)},title:`Open ${e}'s details`,className:"hover:underline",style:o,children:e}):h.jsx("span",{style:o,children:e}),r&&h.jsxs("span",{className:i?"opacity-80":"text-gray-500 dark:text-slate-400",style:o,children:[".",t.slot]})]})}const Te={sibs:!0,dir:"RIGHT",merge:"near",legend:!1,cases:!1},Ga=["legend","cases"];function Cp(e,t){if(e.get("panels")!=="0")return t;for(const n of Ga)t[n]=!1;return t.detail=null,t}const Tt={dir:"explore-nl-dir",merge:"explore-nl-merge",sibs:"explore-nl-sibs"},En="~",Ap=["exp","hidden","owners"],Pp=["tour"];let Mt;function Ep(e=window.location.search){return Mt===void 0&&(Mt=new URLSearchParams(e).get("tour")==="1"),Mt}function Mp(e,t){const n=e.get(t);return n?n.split(En).filter(Boolean):[]}function Ka(e){const t=e.get("cat");if(!t)return[];const n=t.split(new RegExp(`[,${En}]`)).filter(Boolean);return[...new Set(n.flatMap(s=>{const i=nr.find(r=>r.id===s);return i?sr(i):[]}))]}function Jt(e){try{return localStorage.getItem(e)}catch{return null}}function Dp(e,t){try{localStorage.setItem(e,t)}catch{}}function en(e,t){return e&&t.includes(e)?e:null}function Ie(e=window.location.search){const t=new URLSearchParams(e),n=en(t.get("dir"),["RIGHT","DOWN"])??en(Jt(Tt.dir),["RIGHT","DOWN"])??Te.dir,s=en(t.get("merge"),["near","far","bend","off"])??en(Jt(Tt.merge),["near","far","bend","off"])??Te.merge,i=t.has("sibs")?t.get("sibs")==="1":Jt(Tt.sibs)!==null?Jt(Tt.sibs)!=="0":Te.sibs,r=Mp(t,"sel"),o=Cp(t,{legend:t.get("legend")==="1",cases:t.get("cases")==="1",detail:t.get("detail")||null});return t.has("legend")&&(o.legend=t.get("legend")==="1"),t.has("cases")&&(o.cases=t.get("cases")==="1"),t.has("detail")&&(o.detail=t.get("detail")||null),{sel:r.length?r:Ka(t),detail:o.detail,roots:t.get("roots")==="1",sibs:i,dir:n,merge:s,legend:o.legend,cases:o.cases}}function Qa(e,{push:t=!1}={}){const n=new URL(window.location.href),s=n.searchParams,i=(o,a)=>{a.length===0?s.delete(o):s.set(o,[...a].sort().join(En))},r=(o,a,c)=>{c?s.delete(o):s.set(o,a)};for(const o of Ap)s.delete(o);Mt===void 0&&s.has("tour")&&(Mt=s.get("tour")==="1");for(const o of Pp)s.delete(o);i("sel",e.sel),e.detail?s.set("detail",e.detail):s.delete("detail"),r("roots","1",!e.roots),r("sibs",e.sibs?"1":"0",e.sibs===Te.sibs),r("dir",e.dir,e.dir===Te.dir),r("merge",e.merge,e.merge===Te.merge),r("legend","1",e.legend===Te.legend),r("cases","1",e.cases===Te.cases),s.delete("panels"),s.delete("cat"),t?window.history.pushState(null,"",n):window.history.replaceState(null,"",n)}function zo(e,t){Dp(Tt[e],typeof t=="boolean"?t?"1":"0":String(t))}function Op(e,t=window.location.href){const n=new URL(t),s=new URLSearchParams,i=(r,o)=>s.set(r,o);return e.sel.length&&i("sel",[...e.sel].sort().join(En)),e.detail&&i("detail",e.detail),e.roots&&i("roots","1"),e.sibs!==Te.sibs&&i("sibs",e.sibs?"1":"0"),e.dir!==Te.dir&&i("dir",e.dir),e.merge!==Te.merge&&i("merge",e.merge),e.legend!==Te.legend&&i("legend","1"),e.cases!==Te.cases&&i("cases","1"),n.search=s.toString(),n.toString()}const ve=240,tt=30,Rp=.6,nt=20,jp=1/0,fi=22,qa=18,rt=28;function Xa(e,t,n=()=>!1){const s=new Map;for(const i of e){if(n(i.other))continue;const r=i.position,o=s.get(r)??new Map,a=o.get(i.other)??[];a.includes(i.slot)||a.push(i.slot),o.set(i.other,a),s.set(r,o)}return Ml.filter(i=>s.has(i)).map(i=>{const r=[...s.get(i)].map(([o,a])=>({other:o,slots:a,drawn:t(o)})).sort((o,a)=>o.other.localeCompare(a.other));return{position:i,label:Dl(i,r.length),items:r}})}function Ya(e,t,n=()=>!1){const s=new Set,i=[];for(const r of e){if(n(r.other))continue;const o=`${r.declaredBy}.${r.slot}->${r.other}:${r.position}`;s.has(o)||(s.add(o),i.push({other:r.other,position:r.position,slot:r.slot,declaredBy:r.declaredBy,cardinality:r.cardinality,drawn:t(r.other)}))}return i}function ae(e){return e.storageDirection==="flipped"?e.target:e.source}function Rs(e){return e.anchorClass??ae(e)}function Lp(e,t,n,s,i){const r=new Map,o=new Map,a=[],c=new Set;for(const u of e.edges)u.type==="isa"?(r.set(u.target,[...r.get(u.target)??[],u.source]),o.set(u.source,(o.get(u.source)??0)+1)):u.isLoop||(a.push(u),c.add(`${ae(u)}|${u.slotName}`));const l=new Set(e.nodes.map(u=>u.id)),d=e.nodes.map(u=>{const m=new Map(n(u.id).map((R,H)=>[R.name,H])),y=(R,H)=>(m.get(R.slot)??Number.MAX_SAFE_INTEGER)-(m.get(H.slot)??Number.MAX_SAFE_INTEGER),b=u.slots.map(R=>({...R,connected:R.isLoop||c.has(`${u.id}|${R.slot}`),rangeColor:s(R.range),targetColor:i(R.range)})).sort(y),w=new Set(b.map(R=>R.slot)),x=n(u.id).filter(R=>!w.has(R.name)).map(R=>({slot:R.name,range:R.range,channel:"plain",flipped:!1,cardinality:Cl(R.required,R.multivalued),isLoop:!1,connected:!1,rangeColor:s(R.range)})),S=b.filter(R=>R.connected),v=[...b.filter(R=>!R.connected),...x].sort(y),g=[...S,...v].slice(0,Math.max(jp,S.length)),k=g.length===S.length+v.length,P=t.has(u.id)||k,C=P?[...S,...v]:g,E=k?0:S.length+v.length-g.length,N=e.hiddenOwners.get(u.id)??[],z=e.hiddenOwned.get(u.id)??[],_=Xa(u.relations,R=>l.has(R),R=>R===u.id),I=Ya(u.relations,R=>l.has(R),R=>R===u.id);return{...u,isaParents:r.get(u.id)??[],subclassCount:o.get(u.id)??0,members:[],hiddenOwners:N,hiddenOwned:z,relationGroups:_,relationRows:I,...Za(_),rows:C,allRows:[...S,...v],hiddenCount:E,expanded:P,height:Ja(C.length,E,_.length>0)}}),f=new Map;for(const u of a){const m=ae(u)===u.source?u.target:u.source,y=i(m);y&&f.set(u.id,y)}return{nodes:d,edges:a,edgeColors:f}}function Za(e){const t=new Map;for(const n of e)for(const s of n.items)t.set(s.other,(t.get(s.other)??!1)||s.drawn);return{relatedCount:t.size,shownCount:[...t.values()].filter(Boolean).length}}function Ja(e,t,n){return tt+(n?fi:0)+e*nt+(t?qa:0)+(e?5:0)}function Np(e,t,n,s,i,r,o){const a=Al(e.nodes.map(x=>x.id),t,n);if(!a.size)return e;const c=new Map(e.nodes.map(x=>[x.id,x])),l=new Set(e.nodes.map(x=>x.id)),d=new Map,f=[],u=new Map;for(const[x,S]of a){const v=Ol(x),g=S.map(M=>({id:M,label:c.get(M)?.label??M,color:Pl(o(M))}));for(const M of g)d.set(M.id,v);const k=c.has(x);k&&d.set(x,v);const P=new Map(g.map(M=>[M.id,M])),C=new Map,E=k?[x,...S]:S;for(const M of E){const q=c.get(M);if(!q)continue;const ge=M===x;for(const de of q.allRows){const Ee=s(M,de.slot),K=Ee!==void 0&&Ee!==M,U=`${ge||K?Ee??x:M}|${de.slot}`,Y=C.get(U),J=P.get(M),se=ge||K?Y?.owners??[]:[...Y?.owners??[],...J?[J]:[]];C.set(U,{...Y??de,connected:(Y?.connected??!1)||de.connected,owners:se,declaringClass:U.slice(0,U.indexOf("|"))})}}const N=new Map;for(const M of C.values())if(M.targetColor)for(const q of M.owners??[])N.has(q.id)||N.set(q.id,M.targetColor);for(const M of g){const q=N.get(M.id);q&&(M.color=q)}for(const[M,q]of C)q.targetColor&&u.set(`${v}|${M}`,q.targetColor);const z=[...C.values()],_=M=>{const q=M.owners?.length?M.owners[0].id:x;return r(q,M.slot)};z.sort((M,q)=>_(M)-_(q));const I=El(z,g,M=>({slot:`::hdr:${M.id}`,range:"",channel:"plain",flipped:!1,cardinality:"",isLoop:!1,connected:!1,rangeColor:"",header:M})),R=M=>!d.has(M)&&!E.includes(M),H=[...new Set(E.flatMap(M=>c.get(M)?.hiddenOwners??[]))].filter(R),Z=[...new Set(E.flatMap(M=>c.get(M)?.hiddenOwned??[]))].filter(R),ne=Xa(E.flatMap(M=>c.get(M)?.relations??[]),M=>l.has(M),M=>!R(M)),fe=Ya(E.flatMap(M=>c.get(M)?.relations??[]),M=>l.has(M),M=>!R(M)),O=c.get(S[0]),B=i(x);f.push({...O,id:v,label:x,description:B.description,abstract:B.abstract,slots:[],members:g,role:E.some(M=>c.get(M)?.role==="selected")?"selected":"context",layer:Math.min(...E.map(M=>c.get(M)?.layer??0)),isaParents:[],subclassCount:g.length,hiddenOwners:H,hiddenOwned:Z,relationGroups:ne,relationRows:fe,...Za(ne),rows:I,allRows:z,hiddenCount:0,expanded:!0,height:Ja(I.length,0,ne.length>0)})}const m=[...e.nodes.filter(x=>!d.has(x.id)),...f],y=new Set,b=e.edges.map(x=>({...x,source:d.get(x.source)??x.source,target:d.get(x.target)??x.target,entityMember:(()=>{if(x.inducedFrom!==void 0)return;const S=ae(x)===x.source?x.target:x.source;return d.has(S)?S:void 0})(),anchorClass:d.has(ae(x))?s(ae(x),x.slotName)??ae(x):ae(x)})).filter(x=>{if(!os(x.source)&&!os(x.target))return!0;const S=`${x.source}|${x.target}|${x.anchorClass}|${x.slotName}|${x.storageDirection}`;return y.has(S)?!1:(y.add(S),!0)}).filter(x=>x.source!==x.target),w=new Map(e.edgeColors);for(const x of b){const S=u.get(`${ae(x)}|${Rs(x)}|${x.slotName}`);S&&w.set(x.id,S)}return{nodes:m,edges:b,edgeColors:w}}function Vp({title:e}){return h.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15","aria-hidden":"false",className:"shrink-0",style:{color:xt.entity},children:[h.jsx("title",{children:e}),h.jsx("path",{d:"M12.33 10.5 A5 5 0 1 1 12.33 5.5",fill:"none",stroke:"currentColor",strokeWidth:"1.8",strokeLinecap:"round"}),h.jsx("path",{d:"M13.7 7.9 L10.6 6.7 L13.7 4.2 Z",fill:"currentColor"})]})}function el(e){return tt+(e.relationGroups.length>0?fi:0)}function tl(e,t,n){const s=e.rows.findIndex(i=>i.slot===t&&!i.header&&(!n||!i.declaringClass||i.declaringClass===n));if(s<0)throw new Error(`No displayed row for ${t} on ${e.id}`);return el(e)+s*nt+nt/2}function Ip(e,t){const n=e.rows.findIndex(s=>s.header?.id===t);if(!(n<0))return el(e)+n*nt+nt/2}function js(e,t){if(e.storageDirection==="flipped"||!t.members.length)return;const n=e.entityMember;return n&&t.members.some(s=>s.id===n)?n:void 0}const Bp=4,$p=10,nl=12,We=nl,Xn=nl*1.5,Yn=0,Uo=.85,sl=1.4,il=2.6,Fp=sl*.75,_p=il*.75;function Go(e,t){return e?t?xe.ownBkwd:xe.ownFwd:xe.association}function Zn(e,t){if(e==="off"||t.length<2)return 0;if(e==="near")return 40;if(e==="far")return 120;const n=t[t.length-1],s=t[t.length-2];return Math.hypot(n.x-s.x,n.y-s.y)}function Ko(e,t){return e<2?0:Math.min(Bp,t/(e-1))}function Hp(e,t){const n=new Map,s=(l,d,f,u)=>{const m=n.get(l.id)??[];return m.some(y=>y.id===d)||(m.push({id:d,x:f,y:u}),n.set(l.id,m)),d},i=new Map(e.nodes.map(l=>[l.id,l])),r=l=>{const d=i.get(ae(l)===l.source?l.target:l.source);return!!d&&js(l,d)!==void 0},o=new Map;for(const l of e.edges){if(r(l))continue;const d=ae(l)===l.source?l.target:l.source,f=`${d}|${d===l.source?"out":"in"}`;o.set(f,(o.get(f)??0)+1)}const a=new Map,c=e.edges.map(l=>{const d=i.get(ae(l)),f=i.get(ae(l)===l.source?l.target:l.source);if(!d||!f)throw new Error(`Edge ${l.id} endpoint missing from subgraph`);const u=l.storageDirection==="flipped",m=tl(d,l.slotName,Rs(l)),y=s(d,`${d.id}::row:${Rs(l)}|${l.slotName}`,u?0:ve,m),b=f.id===l.source,w=`${f.id}|${b?"out":"in"}`,x=js(l,f),S=x!==void 0?Ip(f,x):void 0;let v;if(x!==void 0&&S!==void 0)v=s(f,`${f.id}::mhdr:${b?"out":"in"}:${x}`,t==="RIGHT"?b?ve:0:ve/2,t==="RIGHT"?S:b?f.height:0);else{const g=o.get(w)??1,k=a.get(w)??0;a.set(w,k+1);const P=Ko(g,tt-4),C=tt/2+(k-(g-1)/2)*P;v=t==="RIGHT"?s(f,`${f.id}::hdr:${b?"out":"in"}:${k}`,b?ve:0,C):s(f,`${f.id}::hdr:${b?"out":"in"}:${k}`,ve/2+(k-(g-1)/2)*Ko(g,ve/2),b?f.height:0)}return{id:l.id,source:l.source,target:l.target,sourcePort:u?v:y,targetPort:u?y:v}});return{nodes:e.nodes.map(l=>({id:l.id,width:ve,height:l.height,partition:l.layer,ports:n.get(l.id)})),edges:c}}function Wp(e,t){if(!e?.length)return e;const n=e[0],s=n.bendPoints?.length?n.bendPoints[n.bendPoints.length-1]:n.startPoint,i=n.endPoint.x-s.x,r=n.endPoint.y-s.y,o=Math.hypot(i,r);if(o<1)return e;const a=Math.min(t,o*.8)/o,c={x:n.endPoint.x-i*a,y:n.endPoint.y-r*a};return[{...n,endPoint:c},...e.slice(1)]}function zp(e,t){if(!e?.length)return e;const n=e[0],s=n.bendPoints?.length?n.bendPoints[0]:n.endPoint,i=s.x-n.startPoint.x,r=s.y-n.startPoint.y,o=Math.hypot(i,r);if(o<1)return e;const a=Math.min(t,o*.8)/o,c={x:n.startPoint.x+i*a,y:n.startPoint.y+r*a};return[{...n,startPoint:c},...e.slice(1)]}function Up({dataService:e,selectedIds:t,onNodeClick:n,onAdd:s,onRemove:i,pathToRoot:r=!1,onTogglePathToRoot:o,direction:a,setDirection:c,mergeMode:l,setMergeMode:d}){const f=p.useId().replace(/[^a-zA-Z0-9]/g,""),u=T=>`${T}-${f}`,[m,y]=p.useState(new Set),b=p.useMemo(()=>e.getOwnershipSubgraph([...t].sort(),{pathToRoot:r}),[e,t,r]),w=p.useCallback(T=>e.getTargetColor(T),[e]),x=p.useMemo(()=>new Map(b.nodes.map(T=>[T.id,e.getClassSummary(T.id)?.slots??[]])),[e,b]),S=p.useMemo(()=>Lp(b,m,T=>x.get(T)??[],T=>e.getRangeColor(T),T=>e.getTargetColor(T)),[b,m,x,e]),v=p.useMemo(()=>new Map(b.nodes.map(T=>[T.id,e.getClassSummary(T.id)])),[e,b]),g=p.useMemo(()=>{const T=A=>v.get(A)?.parentId,D=A=>!Rl.has(A),j=(A,V)=>A.range===V.range&&A.multivalued===V.multivalued;return Np(S,T,D,(A,V)=>{const F=e.getClassSummary(A)?.slots.find(le=>le.name===V);if(!F)return;if(!F.inheritedFrom)return A;const X=e.getClassSummary(F.inheritedFrom)?.slots.find(le=>le.name===V);return X&&j(F,X)?F.inheritedFrom:A},A=>{const V=e.getClassSummary(A);return{description:V?.description??"",abstract:V?.isAbstract??!1}},(A,V)=>{const F=e.getClassSummary(A)?.slots.findIndex(X=>X.name===V)??-1;return F<0?Number.MAX_SAFE_INTEGER:F},A=>e.siblingColorIndexOf(A))},[S,v,e]),[k,P]=p.useState(new Map),[C,E]=p.useState(new Map),N=p.useMemo(()=>Hp(g,a),[g,a]),{latest:z,inProgress:_}=rp(N,{direction:a,usePartitions:!0,nodeSpacing:28,layerSpacing:72,extraLayoutOptions:{"elk.spacing.edgeNode":"18","elk.spacing.edgeEdge":"12","elk.layered.spacing.edgeNodeBetweenLayers":"18","elk.layered.spacing.edgeEdgeBetweenLayers":"10"}}),I=z?.spec===N?z.layout:null,R=z?.layout??null,H=bp(),Z=(R?.width??0)+rt*2,ne=(R?.height??0)+rt*2;p.useEffect(()=>{I&&(H.setContentSize(Z,ne),H.isAutoFit()&&H.zoomToFit())},[I,Z,ne]),p.useEffect(()=>P(new Map),[I]),p.useEffect(()=>E(new Map),[I]);const[fe,O]=p.useState(!1),B=p.useRef(!0);p.useEffect(()=>{if(!I){O(!1),R||(B.current=!0);return}const T=B.current?0:wp();if(B.current=!1,T===0){O(!0);return}const D=setTimeout(()=>O(!0),T);return()=>clearTimeout(D)},[I,R]);const M=p.useRef(new Map),q=p.useRef(!1),ge=p.useRef(k);ge.current=k;const de=p.useMemo(()=>{const T=new Map((R?.nodes??[]).map(j=>[j.id,j])),D=new Map(C);for(const[j,$]of k)D.set(j,$);for(const[j,{dx:$,dy:W}]of D){const Q=T.get(j);Q&&T.set(j,{...Q,x:Q.x+$,y:Q.y+W})}return M.current=T,T},[R,k,C]),[Ee,K]=p.useState(!1);p.useEffect(()=>{if(!_){K(!1);return}const T=setTimeout(()=>K(!0),fp);return()=>clearTimeout(T)},[_]);const U=p.useCallback((T,D)=>{if(D.button!==0||D.target.closest('button, a, [role="button"], [data-no-drag]'))return;D.stopPropagation();const j=D.clientX,$=D.clientY,W=H.getZoom()||1,Q=k.get(T)??{dx:0,dy:0},A=D.currentTarget;A.setPointerCapture(D.pointerId);let V=!1;const F=le=>{const ke=(le.clientX-j)/W,Me=(le.clientY-$)/W;!V&&Math.hypot(ke,Me)<3||(V=!0,q.current=!0,P(Qe=>new Map(Qe).set(T,{dx:Q.dx+ke,dy:Q.dy+Me})))},X=le=>{if(A.releasePointerCapture(le.pointerId),A.removeEventListener("pointermove",F),A.removeEventListener("pointerup",X),V){const ke=ge.current.get(T);ke&&E(Me=>new Map(Me).set(T,ke))}};A.addEventListener("pointermove",F),A.addEventListener("pointerup",X)},[k]),Y=p.useMemo(()=>new Map(g.nodes.map(T=>[T.id,T.role])),[g]),J=p.useMemo(()=>new Map(g.edges.map(T=>[T.id,T])),[g]),se=p.useMemo(()=>{const T=new Map(g.nodes.map(D=>[D.id,D]));return new Set(g.edges.filter(D=>{const j=T.get(ae(D)===D.source?D.target:D.source);return!!j&&js(D,j)!==void 0}).map(D=>D.id))},[g]),je=p.useMemo(()=>{const T=new Map;if(!I)return T;for(const D of g.edges){const j=ae(D)===D.source?D.target:D.source,$=de.get(j);if(!$||se.has(D.id))continue;const W=j===D.source,Q=`${j}|${W?"out":"in"}`;if(T.has(Q))continue;const A=W,V=Yn+Xn;T.set(Q,a==="RIGHT"?{base:{x:A?$.x+ve+V:$.x-V,y:$.y+tt/2},dir:{x:A?-1:1,y:0}}:{base:{x:$.x+ve/2,y:A?$.y+$.height+V:$.y-V},dir:{x:0,y:A?-1:1}})}return T},[g,de,I,a,se]),Le=p.useMemo(()=>{const T=new Map,D=new URLSearchParams(window.location.search).has("dbg"),j=new Set([...C.keys(),...k.keys()]);if(!I||j.size===0)return T;D&&console.log(`[drag] moved: ${[...j].join(", ")}`);const $=new Map(g.nodes.map(W=>[W.id,W]));for(const W of g.edges){const Q=ae(W),A=Q===W.source?W.target:W.source;if(!j.has(Q)&&!j.has(A))continue;const V=de.get(Q),F=de.get(A),X=$.get(Q);if(!V||!F||!X)continue;const le=W.storageDirection==="flipped",ke=a==="RIGHT";let Me;try{Me=tl(X,W.slotName)}catch{D&&console.log(`   SKIP ${Q}.${W.slotName}: row not displayed`);continue}const Qe=ke?{x:V.x+(le?0:ve),y:V.y+Me}:{x:V.x+ve/2,y:V.y+Me},He=ke?{x:le?-1:1,y:0}:{x:0,y:1},ot=A===W.source,Ht=ke?{x:ot?F.x+ve:F.x,y:F.y+tt/2}:{x:F.x+ve/2,y:ot?F.y+F.height:F.y},Rn=ke?{x:ot?1:-1,y:0}:{x:0,y:ot?1:-1};T.set(W.id,op(Qe,Ht,He,Rn)),D&&console.log(`   reroute ${Q}.${W.slotName} -> ${A}`)}return D&&console.log(`[drag] rerouted ${T.size} edge(s)`),T},[I,k,C,g,de,a]);p.useEffect(()=>{if(!I||!new URLSearchParams(window.location.search).has("dbg"))return;const T=new Map;for(const D of I.edges){const j=J.get(D.id);if(!j)continue;const $=Xt(D.sections);if($.length<2)continue;const W=ae(j)===j.source?j.target:j.source;let Q=0,A=0;for(let F=1;F<$.length;F++){const X=Math.abs($[F].x-$[F-1].x),le=Math.abs($[F].y-$[F-1].y);X>.5&&le>.5&&A++,F>1&&Q++}const V=ae(j);T.set(W,[...T.get(W)??[],`${V}.${j.slotName}  pts=${$.length} bends=${Q}${A?` DIAGONAL x${A}`:""}  start=(${Math.round($[0].x)},${Math.round($[0].y)}) end=(${Math.round($[$.length-1].x)},${Math.round($[$.length-1].y)})`])}for(const[D,j]of T){if(j.length<2)continue;console.log(`
=== approaches to ${D} (${j.length}) ===`);const $=de.get(D);$&&console.log(`   box at (${Math.round($.x)},${Math.round($.y)}) h=${Math.round($.height)}`),j.forEach(W=>console.log("   "+W))}},[I,J,de]);const G=p.useMemo(()=>{const T=new Map;if(!I)return T;for(const D of I.edges){const j=J.get(D.id);if(!j||j.storageDirection==="flipped"||se.has(D.id)||Zn(l,Xt(D.sections))<=0)continue;const $=ae(j)===j.source?j.target:j.source,W=`${$}|${$===j.source?"out":"in"}`,Q=je.get(W);if(!Q)continue;const A=j.type==="ownership",V=Y.get(j.source)==="context"||Y.get(j.target)==="context",F=g.edgeColors.get(D.id),X=T.get(W);T.set(W,X?{...X,isOwn:X.isOwn||A,dimmed:X.dimmed&&V,edgeIds:[...X.edgeIds,D.id],...X.color?.text===F?.text?{}:{color:void 0}}:{...Q,isOwn:A,dimmed:V,edgeIds:[D.id],...F?{color:F}:{}})}return T},[I,J,je,l,Y,g,se]),oe=p.useMemo(()=>new Set(g.nodes.map(T=>T.id)),[g]),he=p.useCallback(T=>!!s&&T.channel!=="plain"&&!T.isLoop&&!oe.has(T.range),[s,oe]),Se=p.useRef(null),Dn=p.useRef(null),On=p.useRef(void 0),bi=p.useMemo(()=>{const T=new Map,D=new Map;for(const j of g.edges){D.set(j.id,[j.source,j.target]);for(const $ of[j.source,j.target])T.set($,[...T.get($)??[],j.id])}return{nodeEdges:T,edgeEnds:D}},[g]),xi=p.useRef(bi);xi.current=bi;const it=p.useCallback(T=>{On.current=T,Dn.current===null&&(Dn.current=requestAnimationFrame(()=>{Dn.current=null;const D=On.current;On.current=void 0;const j=Se.current,$=H.wrapperRef.current;if(D===void 0||!j||!$)return;let W=null,Q=null;if(D){const{nodeEdges:V,edgeEnds:F}=xi.current;if(D.kind==="node"){W=new Set(V.get(D.id)??[]),Q=new Set([D.id]);for(const X of W)for(const le of F.get(X)??[])Q.add(le)}else W=new Set([D.id]),Q=new Set(F.get(D.id)??[])}const A=(V,F,X)=>{V.style.filter=F===null||F?"":`opacity(${X})`};j.querySelectorAll("path[data-edge-id]").forEach(V=>{const F=V.dataset.edgeId??"",X=W?W.has(F):null;A(V,X,.38),V.style.strokeWidth=X?String(V.dataset.channel==="reference"?_p:il):""}),j.querySelectorAll("path[data-arrowhead]").forEach(V=>{const F=(V.dataset.arrowhead??"").split(" ");A(V,W?F.some(X=>W.has(X)):null,.08)}),$.querySelectorAll("[data-node-id]").forEach(V=>{A(V,Q?Q.has(V.dataset.nodeId??""):null,.25)})}))},[]);p.useEffect(()=>it(null),[g,I,it]);const vl=T=>y(D=>{const j=new Set(D);return j.has(T)?j.delete(T):j.add(T),j}),vi=T=>{zo("dir",T),c(T)},Ft=T=>{zo("merge",T),d(T)},_t=e.getConceptLabel("attribute",!0).toLowerCase(),_e=T=>`px-2 py-0.5 text-xs rounded border ${T?"border-blue-500 bg-blue-50 dark:bg-blue-950 text-blue-700 dark:text-blue-300":"border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-800 hover:bg-gray-100 dark:hover:bg-slate-700"}`;return h.jsxs("div",{className:"relative w-full h-full",children:[h.jsxs("div",{"data-pan-ignore":!0,className:"absolute top-2 right-2 z-10 flex gap-1 items-center",children:[Ee&&h.jsxs("div",{className:`mr-2 flex items-center gap-2 rounded px-2 py-1
                          ...
                          bg-white/80 dark:bg-slate-900/80 shadow-sm`,children:[h.jsx("span",{className:`inline-block h-3 w-3 animate-spin rounded-full
                             ...
                             dark:border-slate-600 dark:border-t-slate-300`}),"Computing layout…"]}),o&&h.jsxs(h.Fragment,{children:[h.jsx("button",{className:_e(r),title:r?"Hide owners: show only what you selected":"Show every owner up to the root (can pull in most of the schema)",onClick:o,children:"⇱ roots"}),h.jsx("span",{className:"w-px h-4 bg-gray-300 dark:bg-slate-600 mx-1"})]}),h.jsx("button",{className:_e(a==="RIGHT"),title:"Layout left to right",onClick:()=>vi("RIGHT"),children:"LR"}),h.jsx("button",{className:_e(a==="DOWN"),title:"Layout top down",onClick:()=>vi("DOWN"),children:"TB"}),h.jsx("span",{className:"w-px h-4 bg-gray-300 dark:bg-slate-600 mx-1"}),h.jsx("button",{className:_e(l==="near"),title:"Merge converging edges near the node (~40px)",onClick:()=>Ft("near"),children:"⋙"}),h.jsx("button",{className:_e(l==="far"),title:"Merge converging edges early (~120px)",onClick:()=>Ft("far"),children:"⋙⋙"}),h.jsx("button",{className:_e(l==="bend"),title:"Merge at ELK's last corner",onClick:()=>Ft("bend"),children:"⌙"}),h.jsx("button",{className:_e(l==="off"),title:"No merging — every edge runs to its own port",onClick:()=>Ft("off"),children:"≡"}),h.jsx("span",{className:"w-px h-4 bg-gray-300 dark:bg-slate-600 mx-1"}),[["+",()=>H.zoomBy(1.3),"Zoom in"],["−",()=>H.zoomBy(1/1.3),"Zoom out"],["1:1",()=>H.applyZoom(1),"Reset zoom"],["⛶",()=>H.zoomToFit(),"Fit to view"]].map(([T,D,j])=>h.jsx("button",{onClick:D,title:j,className:_e(!1),children:T},T))]}),h.jsx("div",{ref:H.containerRef,"data-graph-direction":a,className:"w-full h-full overflow-auto cursor-grab",children:h.jsx("div",{ref:H.spacerRef,children:h.jsx("div",{ref:H.wrapperRef,className:"relative",children:R&&h.jsxs(h.Fragment,{children:[h.jsxs("svg",{ref:Se,className:"absolute top-0 left-0 pointer-events-none",width:Z,height:ne,children:[h.jsxs("defs",{children:[h.jsx("marker",{id:u("arrow-own"),viewBox:"0 0 10 7",refX:"0",refY:"3.5",markerWidth:We,markerHeight:We*.75,markerUnits:"userSpaceOnUse",orient:"auto-start-reverse",children:h.jsx("path",{d:"M0,0L10,3.5L0,7Z",fill:xe.ownFwd})}),h.jsx("marker",{id:u("arrow-own-back"),viewBox:"0 0 10 7",refX:"10",refY:"3.5",markerWidth:We,markerHeight:We*.75,markerUnits:"userSpaceOnUse",orient:"auto-start-reverse",children:h.jsx("path",{d:"M10,0L0,3.5L10,7Z",fill:xe.ownBkwd})}),h.jsx("marker",{id:u("arrow-assoc"),viewBox:"0 0 10 7",refX:"0",refY:"3.5",markerWidth:We*Uo,markerHeight:We*.75*Uo,markerUnits:"userSpaceOnUse",orient:"auto-start-reverse",children:h.jsx("path",{d:"M0,0L10,3.5L0,7Z",fill:xe.association})})]}),h.jsxs("g",{transform:`translate(${rt}, ${rt})`,style:{opacity:fe?1:0,transition:`opacity ${yp()}ms`},children:[[...G].map(([T,D])=>h.jsx("path",{"data-arrowhead":D.edgeIds.join(" "),d:ip(D.base,D.dir,We,Xn),fill:D.color?.text??Go(D.isOwn,!1),opacity:D.dimmed?.4:1,style:{transition:`filter ${Zt()}ms`}},`head-${T}`)),(I?.edges??[]).map(T=>{const D=J.get(T.id);if(!D)throw new Error(`Routed edge ${T.id} missing from view model`);const j=D.storageDirection==="flipped",$=ae(D)===D.source?D.target:D.source,W=j||se.has(T.id)?void 0:je.get(`${$}|${$===D.source?"out":"in"}`),Q=Le.get(T.id),A=!!W&&Zn(l,Q??Xt(T.sections))>0,V=D.type!=="ownership",F=A?T.sections:Wp(T.sections,We+Yn+(j?2:0)),X=V?zp(F,Xn+Yn):F,le=Q??Xt(X),ke=Rn=>Jf(Rn,$p),Me=Zn(l,le),Qe=W&&Me>0?np(le,W.base,Me,ke):ke(le);if(!Qe)return null;const He=D.type==="ownership",ot=Y.get(T.source)==="context"||Y.get(T.target)==="context",Ht=A?void 0:He?j?"arrow-own-back":"arrow-own":"arrow-assoc";return h.jsxs("g",{children:[h.jsx("path",{"data-edge-id":T.id,"data-channel":He?"ownership":"reference",d:Qe,fill:"none",opacity:ot?.4:1,stroke:g.edgeColors.get(T.id)?.text??Go(He,j),strokeWidth:He?sl:Fp,strokeDasharray:He?void 0:"5 4",markerEnd:Ht?`url(#${u(Ht)})`:void 0,markerStart:!He&&!A?`url(#${u("arrow-assoc")})`:void 0,style:{transition:`filter ${Zt()}ms, stroke-width ${Zt()}ms`}}),h.jsx("path",{d:Qe,fill:"none",stroke:"transparent",strokeWidth:11,style:{pointerEvents:"stroke"},onMouseEnter:()=>it({kind:"edge",id:T.id}),onMouseLeave:()=>it(null)})]},T.id)})]})]}),h.jsx(Iu,{initial:!1,children:g.nodes.map(T=>{const D=de.get(T.id);if(!D)return null;const j=T.role==="context",$=D.x+rt,W=D.y+rt,Q={duration:Yt(k.has(T.id)?0:Ha()),ease:pp};return h.jsxs(Kf.div,{initial:{opacity:0,x:$,y:W},animate:{opacity:j?Rp:1,x:$,y:W},exit:{opacity:0,transition:{duration:Yt(_o())}},transition:{x:Q,y:Q,opacity:{duration:Yt(_o()),delay:Yt(gp())}},"data-node-id":T.id,"data-help-id":Wl(T),"data-pan-ignore":!0,"data-pinned":C.has(T.id)?"":void 0,onPointerDown:A=>U(T.id,A),onClick:()=>{if(q.current){q.current=!1;return}n?.(T.members.length?T.label:T.id)},onMouseEnter:()=>it({kind:"node",id:T.id}),onMouseLeave:()=>it(null),className:`absolute rounded-md text-xs bg-white dark:bg-slate-800 cursor-pointer ${j?"border border-dashed border-gray-400 dark:border-slate-500":C.has(T.id)?"border-2 border-amber-500 dark:border-amber-400 shadow-md":"border-2 border-slate-500 dark:border-slate-400 shadow-md"}`,style:{width:ve,height:T.height,transition:`filter ${Zt()}ms`},children:[h.jsxs("div",{className:"flex items-center gap-1 px-2 rounded-t-[4px] bg-slate-700 dark:bg-slate-700 text-white border-b border-slate-800 dark:border-slate-600",style:{height:tt},children:[h.jsx("span",{className:`font-semibold truncate ${T.abstract?"italic":""}`,title:T.description||T.id,children:T.label}),h.jsxs("span",{className:"ml-auto flex gap-1 shrink-0",children:[T.members.length>0&&h.jsxs("span",{title:`${T.members.length} classes that are a ${T.label}, merged into one box`,className:"text-[9px] px-1 rounded bg-sky-100 dark:bg-sky-900 text-sky-800 dark:text-sky-200",children:["⑃ ",T.members.length]}),T.isaParents.map(A=>h.jsxs("span",{title:`is-a ${A}`,className:"text-[9px] px-1 rounded bg-sky-100 dark:bg-sky-900 text-sky-800 dark:text-sky-200",children:["⊳ ",A]},A)),T.subclassCount>0&&T.members.length===0&&h.jsxs("span",{title:`${T.subclassCount} subclasses shown`,className:"text-[9px] px-1 rounded bg-sky-100 dark:bg-sky-900 text-sky-800 dark:text-sky-200",children:["▷ ",T.subclassCount]}),(()=>{const V=(T.members.length?T.members.map(F=>F.id):[T.id]).filter(F=>t.has(F));return V.length?h.jsx("button",{"data-dismiss":T.id,"data-help-id":"node-dismiss",title:V.length>1?`Remove all ${V.length} selected classes in ${T.label}`:`Remove ${T.label} from the canvas`,onClick:F=>{F.stopPropagation(),V.forEach(X=>i?.(X))},className:`text-[10px] leading-none px-1 rounded text-gray-400
                                     ...
                                     bg-sky-50/60 dark:bg-sky-950/30`,style:{height:fi},children:h.jsx(kp,{label:T.label,rows:T.relationRows,onAdd:A=>s?.(A),onRemove:A=>i?.(A),onInspect:n,colorOf:w,slotOrder:T.allRows.map(A=>A.slot),parentOf:A=>e.getClassSummary(A)?.parentId})}),T.rows.map(A=>A.header?h.jsx("div",{"data-no-drag":!0,"data-help-id":_l(A.header.id),title:`${A.header.label} — is a ${T.label}; click for details`,onClick:V=>{V.stopPropagation(),n?.(A.header.id)},className:`flex items-center px-2 text-[10px] font-semibold
                                     cursor-pointer hover:brightness-110`,style:{height:nt,background:A.header.color.fill,color:Sl},children:h.jsx("span",{className:"truncate",children:A.header.label})},A.slot):h.jsxs("div",{"data-help-id":zl(T,A),"data-expandable":he(A)?"":void 0,"data-no-drag":he(A)?"":void 0,title:(A.channel==="plain"?`${A.slot}: ${A.range}`:`${A.slot} → ${A.range} (${A.cardinality})${A.flipped?" — owner side":""}`+(he(A)?` — click to add ${A.range}`:""))+((A.owners?.length??0)>1?`
also declared by ${A.owners.slice(1).map(V=>V.label).join(", ")}`:""),onClick:he(A)?V=>{V.stopPropagation(),s?.(A.range)}:void 0,className:`flex items-center gap-1.5 px-2 text-[11px] ${A.targetColor?"":A.connected?"text-gray-700 dark:text-gray-300":"text-gray-400 dark:text-gray-500"} ${he(A)?"cursor-pointer hover:bg-sky-50 dark:hover:bg-sky-900/30 hover:text-sky-700 dark:hover:text-sky-300":""}`,style:{height:nt,...A.targetColor?{color:A.targetColor.text}:{}},children:[h.jsx("span",{className:"w-1.5 h-1.5 rounded-full shrink-0 border",style:{borderColor:A.rangeColor,background:A.connected?A.rangeColor:"transparent"}}),h.jsx("span",{className:`truncate ${T.members.length&&!A.owners?.length?`font-semibold ${A.targetColor?"":"text-gray-900 dark:text-gray-100"}`:""}`,children:A.slot}),A.isLoop&&h.jsx(Vp,{title:`self-referential: a ${A.range} can own another ${A.range} via ${A.slot}`}),h.jsxs("span",{className:"ml-auto text-[9px] truncate max-w-[90px]",children:[h.jsx("span",{style:{color:A.rangeColor},children:A.range}),h.jsxs("span",{className:"text-gray-400 dark:text-gray-500",children:[" ",A.cardinality]})]})]},A.declaringClass?`${A.declaringClass}|${A.slot}`:A.slot)),T.hiddenCount>0&&h.jsx("button",{className:"w-full text-left px-2 text-[10px] text-sky-600 dark:text-sky-400 hover:underline",style:{height:qa},title:`${_t} without an edge on the current canvas, plus plain (non-entity) ${_t}`,onClick:A=>{A.stopPropagation(),vl(T.id)},children:T.expanded?`− fewer ${_t}`:`+ ${T.hiddenCount} more ${_t}`})]},T.id)})})]})})})})]})}function Gp({classId:e,dataService:t,onClose:n,onNavigate:s,isSelected:i,onToggleSelect:r}){const o=p.useMemo(()=>t.getClassSummary(e),[e,t]),[a,c]=p.useState([]),l=p.useCallback(u=>{u!==e&&(c(m=>[...m,e]),s(u))},[e,s]),d=p.useCallback(()=>{c(u=>u.length===0?u:(s(u[u.length-1]),u.slice(0,-1)))},[s]);p.useEffect(()=>{const u=m=>{m.key==="Escape"&&n()};return window.addEventListener("keydown",u),()=>window.removeEventListener("keydown",u)},[n]);const f=t.getTypeLabel("slot",!0);return h.jsxs("aside",{className:`w-96 shrink-0 flex flex-col min-h-0 border-l border-gray-200 dark:border-slate-700
                 bg-white dark:bg-slate-900`,"aria-label":"Entity details",children:[h.jsxs("header",{className:`flex items-start gap-2 px-3 py-2 border-b border-gray-200 dark:border-slate-700
                  ...
                  ${o?"":`absolute top-14 ${s?"right-[27rem]":"right-4"}`}`,children:[h.jsxs("div",{onPointerDown:r.onPointerDown,className:`sticky top-0 flex items-baseline justify-between gap-2 px-4 py-2
                   ...
                   text-gray-400 dark:text-gray-500 mb-1`,children:e})}const Xo={"own-fwd":{text:"owns (forward)",color:xe.ownFwd},"own-bkwd":{text:"belongs to (backward)",color:xe.ownBkwd},association:{text:"association (no ownership)",color:xe.association},excluded:{text:"dropped",cls:"text-gray-400 dark:text-gray-500 border-gray-300"}},Zp=[{kind:"own-fwd",color:xe.ownFwd,title:"A owns B",body:"The arrow runs from the owner to what it holds. A owns B when the schema puts the collection on A, or when B has no independent existence — a Quantity of 5 mg is not something you look up."},{kind:"own-bkwd",color:xe.ownBkwd,title:"A belongs to B",body:'The same relationship stored at the other end: A carries a pointer to one B that exists without it. Drawn B → A, so you still read "start at B to find A". A Participant carries on existing whether or not any observation points at it.'},{kind:"association",color:xe.association,title:"A and B are associated",body:"Neither owns the other. Dashed, with arrowheads at both ends. Only two edges in the schema are this — a slot the ownership rules would otherwise claim, wrongly."}],Jp=[{glyph:"⇱ roots",what:"Also draw everything on the path up to a root."},{glyph:"LR / TB",what:"Lay the diagram out left-to-right or top-down."},{glyph:"⋙ ⋙⋙ ⌙ ≡",what:"Where converging edges join before their shared arrowhead — near the box, early, at the last corner, or not at all. Temporary, for picking one by eye."},{glyph:"+ − 1:1 ⛶",what:"Zoom in, out, reset, fit to view."}],em=[["0..1","optional, at most one"],["1..1","required, exactly one"],["0..*","optional, any number"],["1..*","required, one or more"]];function tm({dataService:e,onClose:t,onSelect:n,offset:s}){const i=p.useMemo(()=>e.getOwnershipPairGroups(),[e]),[r,o]=p.useState(null),a=c=>h.jsx("button",{onClick:()=>n([c]),className:"hover:underline text-blue-600 dark:text-blue-400",title:`Select ${c}`,children:c});return h.jsx(rl,{title:"Ownership legend",subtitle:"What the diagram's arrows, colors and buttons mean.",onClose:t,offset:s,children:h.jsxs("div",{className:"text-xs",children:[h.jsxs(bt,{title:"The three kinds of relationship",children:[h.jsxs("p",{className:"text-[11px] text-gray-500 dark:text-gray-400 mb-2",children:["Every edge is a class-valued attribute. Classes are placed so that if ",h.jsx("b",{children:"A"})," is drawn before ",h.jsx("b",{children:"B"}),", you reach ",h.jsx("b",{children:"B"})," through"," ",h.jsx("b",{children:"A"})," — so an edge always tells you where to start."]}),h.jsx("ul",{className:"space-y-2",children:Zp.map(c=>h.jsxs("li",{className:"flex gap-2",children:[h.jsx(Wa,{kind:c.kind,className:"mt-0.5"}),h.jsxs("div",{className:"min-w-0",children:[h.jsx("div",{className:"font-medium",style:{color:c.color},children:c.title}),h.jsx("p",{className:"text-[11px] leading-snug text-gray-600 dark:text-gray-400",children:c.body})]})]},c.title))}),h.jsxs("p",{className:"text-[11px] leading-snug text-gray-500 dark:text-gray-400 mt-2",children:["An edge leaves the ",h.jsx("b",{children:"attribute's row"}),", not the box — that is how you tell which attribute made it. A ",h.jsx("b",{children:"⟲"})," on a row is a slot pointing back at its own class."]}),h.jsxs("p",{className:"text-[11px] leading-snug text-gray-500 dark:text-gray-400 mt-2",children:["Owners are drawn first, so a box's ",h.jsx("b",{children:"← N"})," counts what it belongs to (on its left) and ",h.jsx("b",{children:"M →"})," what it owns (on its right). Hover either to list them. The little edge on each row is the one above: it says which end holds the arrowhead, and so which entity declares the attribute — and ",h.jsx("i",{children:"both"})," kinds turn up on ",h.jsx("i",{children:"both"})," sides."]})]}),h.jsxs(bt,{title:"Colors",children:[h.jsx(Yo,{caption:"A row's dot and its range label say what KIND of thing the attribute points at.",items:[{color:xt.entity,label:"another entity"},{color:xt.enum,label:"a value set"},{color:xt.dataType,label:"a data type"}]}),h.jsxs("p",{className:"text-[11px] leading-snug text-gray-600 dark:text-gray-400 mt-2",children:["A ",h.jsx("b",{children:"filled"})," dot draws an edge; a ",h.jsx("b",{children:"hollow"})," one does not, because what it points at is not on the canvas. Only entity ranges can draw edges at all."]}),h.jsx(Yo,{className:"mt-3",caption:"Inside a merged box, a color says which entity an attribute belongs to.",items:jl.slice(0,4).map((c,l)=>({color:c.text,swatch:c.fill,label:l===0?"the parent":`child ${l}`}))})]}),h.jsx(bt,{title:"Cardinality",children:h.jsx("ul",{className:"flex flex-wrap gap-x-4 gap-y-1",children:em.map(([c,l])=>h.jsxs("li",{className:"flex items-center gap-1.5",children:[h.jsx("span",{className:"font-mono text-[11px] text-gray-700 dark:text-gray-300",children:c}),h.jsx("span",{className:"text-[11px] text-gray-500 dark:text-gray-400",children:l})]},c))})}),h.jsx(bt,{title:"The toolbar",children:h.jsx("ul",{className:"space-y-1",children:Jp.map(c=>h.jsxs("li",{className:"flex gap-2",children:[h.jsx("span",{className:"shrink-0 font-mono text-[11px] text-gray-700 dark:text-gray-300 w-20",children:c.glyph}),h.jsx("span",{className:"text-[11px] leading-snug text-gray-600 dark:text-gray-400",children:c.what})]},c.glyph))})}),h.jsxs(bt,{title:"Every relationship, by rule",children:[h.jsx("p",{className:"text-[11px] text-gray-500 dark:text-gray-400 mb-1.5",children:"Derived live from the classifier the graph itself uses, so this cannot drift from what is drawn. Overrides and value-object membership are hand-curated — if a pair looks wrong, the classification is. Click any class to select it."}),h.jsx("ul",{className:"space-y-1",children:i.map(c=>{const l=`${c.verdict}/${c.rule}`,d=Xo[c.verdict]??Xo.excluded,f=r===l;return h.jsxs("li",{className:"border-l-2 pl-2 border-gray-200 dark:border-slate-600",children:[h.jsxs("button",{onClick:()=>o(f?null:l),className:"w-full text-left",children:[h.jsx("span",{className:`inline-block px-1 rounded border text-[10px] ${d.cls??""}`,style:d.color?{color:d.color,borderColor:d.color}:void 0,children:d.text}),h.jsx("span",{className:"ml-1.5 font-medium",children:c.rule}),h.jsx("span",{className:"ml-1 text-gray-400",children:c.pairs.length}),h.jsx("span",{className:"ml-1 text-gray-400",children:f?"▾":"▸"})]}),h.jsx("p",{className:"text-[11px] leading-snug text-gray-600 dark:text-gray-400 mt-0.5",children:c.ruleText}),f&&h.jsx("ul",{className:"mt-1 mb-1.5 space-y-0.5 font-mono text-[10px]",children:c.pairs.map(u=>h.jsxs("li",{className:"text-gray-600 dark:text-gray-400",children:[a(u.declaredOn),h.jsxs("span",{className:"text-gray-400",children:[".",u.slotName]}),h.jsx("span",{className:"mx-1 text-gray-400",children:u.multivalued?"↠":"→"}),a(u.range),u.isLoop&&h.jsx("span",{className:"ml-1",style:{color:xt.entity},children:"loop"}),(c.verdict==="own-bkwd"||c.verdict==="association")&&h.jsxs("span",{className:"ml-1 text-gray-400",children:["(owner: ",u.owner,")"]})]},`${u.declaredOn}.${u.slotName}`))})]},l)})})]}),h.jsxs("p",{className:"text-[10px] text-gray-400 dark:text-gray-500 mt-3",children:["A box's ",h.jsx("b",{children:"“N related”"})," count is of distinct classes"," ",h.jsx("i",{children:"outside"})," it, so selecting a class that folds into a merged box can make the number go ",h.jsx("i",{children:"down"}),". Correct, if counter-intuitive."]})]})})}function bt({title:e,children:t}){return h.jsxs("section",{className:"mb-4 last:mb-1",children:[h.jsx("h3",{className:`text-[11px] font-semibold uppercase tracking-wider
                     text-gray-400 dark:text-gray-500 mb-1`,children:e}),t]})}function Yo({caption:e,items:t,className:n}){return h.jsxs("div",{className:n,children:[h.jsx("p",{className:"text-[11px] text-gray-500 dark:text-gray-400 mb-1",children:e}),h.jsx("ul",{className:"flex flex-wrap gap-x-3 gap-y-1",children:t.map(s=>h.jsxs("li",{className:"flex items-center gap-1",children:[h.jsx("span",{className:"inline-block w-3 h-3 rounded-sm border",style:{background:s.swatch??s.color,borderColor:s.color}}),h.jsx("span",{className:"text-[11px]",style:{color:s.color},children:s.label})]},s.label))})]})}const nm=!1,sm=!1,al=p.createContext(null);function yt(){const e=p.useContext(al);if(!e)throw new Error("useHelp must be used inside <HelpProvider>");return e}const im=300,om=[{id:"graph-canvas-reading",label:"Reading the diagram"},{id:"relation-bar",label:"The relation bar"},{id:"merged-boxes",label:"Inheritance and merged boxes"},{id:"node-dismiss",label:"Closing a box"},{id:"copy-link",label:"Sharing what you see"}];function rm({onOpenLegend:e,onOpenCases:t,legendOpen:n,casesOpen:s,onClosePanels:i,anyPanelOpen:r}){const{showEntry:o,showAddresses:a,toggleAddresses:c}=yt(),[l,d]=p.useState(!1),f=p.useRef(void 0),u=()=>{f.current!==void 0&&(clearTimeout(f.current),f.current=void 0)},m=()=>{u(),f.current=setTimeout(()=>d(!1),im)};p.useEffect(()=>u,[]),p.useEffect(()=>{if(!l)return;const b=x=>{x.target?.closest("[data-help-menu]")||d(!1)},w=x=>{x.key==="Escape"&&d(!1)};return document.addEventListener("mousedown",b,!0),document.addEventListener("keydown",w),()=>{document.removeEventListener("mousedown",b,!0),document.removeEventListener("keydown",w)}},[l]);const y=b=>()=>{d(!1),b()};return h.jsxs("span",{"data-help-menu":!0,"data-help-id":"help-menu",className:"relative",onMouseEnter:()=>{u(),d(!0)},onMouseLeave:m,children:[h.jsxs("button",{onClick:()=>d(b=>!b),title:"Legend, example cases and help topics",className:`text-sm underline hover:text-white ${l?"text-white":"text-blue-100"}`,children:["Help ",h.jsx("span",{"aria-hidden":!0,className:"opacity-70",children:"▾"})]}),l&&h.jsxs("div",{className:`absolute right-0 top-full mt-1 z-40 w-60 py-1
                     rounded-md border border-gray-300 dark:border-slate-600
                     bg-white dark:bg-slate-800 shadow-xl
                     text-gray-900 dark:text-gray-100`,children:[h.jsxs(tn,{onClick:y(e),children:[n?"Hide ownership legend":"Ownership legend",h.jsx(es,{children:"every relationship in the schema, by rule"})]}),h.jsxs(tn,{onClick:y(t),children:[s?"Hide example cases":"Example cases",h.jsx(es,{children:"selections worth looking at"})]}),r&&h.jsxs(tn,{onClick:y(i),children:["Close all panels",h.jsx(es,{children:"legend, cases and the detail drawer"})]}),h.jsx(am,{}),om.map(b=>h.jsx(tn,{onClick:y(()=>o(b.id)),children:b.label},b.id)),sm]})]})}function tn({onClick:e,children:t}){return h.jsx("button",{onClick:e,className:`block w-full text-left px-3 py-1.5 text-xs
                 hover:bg-gray-100 dark:hover:bg-slate-700`,children:t})}function es({children:e}){return h.jsx("span",{className:"block text-[10px] text-gray-400 dark:text-gray-500",children:e})}function am(){return h.jsx("div",{className:"my-1 border-t border-gray-200 dark:border-slate-700"})}function ll(e){const t=Number(e?.trim());return Number.isFinite(t)&&t>=240?t:void 0}function cl(e){const t=e?.trim().toLowerCase();return t==="dim"||t==="ring"||t==="none"?t:void 0}function dl(e){const t=e?.trim().toLowerCase();return t==="left"||t==="right"||t==="top"||t==="bottom"?t:void 0}function hl(e){const t=e?.trim();if(!t)return;const n=Number(t);if(Number.isFinite(n))return{px:n};const s=t.match(/^(-)?(?:anchor|parentBox)\.(width|height)(?:\s*\*\s*(-?[\d.]+))?$/i);if(!s)return;const[,i,r,o]=s,a=o===void 0?1:Number(o);if(Number.isFinite(a))return{of:r.toLowerCase(),times:i?-a:a}}function pi(e,t){const n=e?.trim();if(!n)return{kind:"help-id",arg:t};if(n==="none")return{kind:"none"};const s=n.indexOf(":");return s===-1?{kind:"help-id",arg:n}:{kind:n.slice(0,s).trim(),arg:n.slice(s+1).trim()}}const lm="Format",cm="Walkthrough",dm=new Set([lm,"TODO"]),ul=/^<\/?(?:details|summary)\b[^>]*>$/i;function ye(e,t){const n=t.toLowerCase();for(const s of e){const i=st(s);if(i){if(i.name==="beats"&&n!=="beats")return;if(i.name===n)return i.value}}}function st(e){const t=e.trimStart().match(/^-\s+(.*)$/);if(!t)return;const n=t[1].replace(/\*\*/g,""),s=n.indexOf(":");if(s===-1)return;const i=n.slice(0,s).trim();if(/^[A-Za-z_][A-Za-z0-9_]*$/.test(i))return{name:i.toLowerCase(),value:n.slice(s+1).trim()}}function mi(e){return e.length>0&&!/^\s/.test(e)&&st(e)!==void 0}function fl(e,t){const n=t.toLowerCase(),s=e.findIndex(l=>st(l)?.name===n);if(s===-1)return;const i=st(e[s]).value,r=[];for(let l=s+1;l<e.length&&!(mi(e[l])||ul.test(e[l].trim()));l++)r.push(e[l]);for(;r.length&&r[r.length-1].trim()==="";)r.pop();if(r.length===0)return i;const o=r.filter(l=>l.trim()!=="").map(l=>l.length-l.trimStart().length),a=Math.min(...o),c=r.map(l=>l.slice(a)).join(`
`);return i?`${i}
${c}`:c}function hm(e,t){const n=t.toLowerCase(),s=e.findIndex(r=>st(r)?.name===n);if(s===-1)return[];const i=[];for(let r=s+1;r<e.length;r++){const o=e[r].trimStart();if(mi(e[r])||o==="")break;o.startsWith("- ")&&i.push(o.slice(2).trim())}return i}function um(e,t){const n=e.findIndex(o=>st(o)?.name==="beats");if(n===-1)return;const s=[];let i=null;const r=()=>{i&&s.push(i)};for(let o=n+1;o<e.length;o++){const a=e[o].trimStart();if(mi(e[o])||e[o].length>0&&!/^\s/.test(e[o])&&/^<\/?[a-z]/i.test(a))break;if(a==="")continue;const c=a.match(/^(\d+)\.\s+(.*)$/);if(c){r(),i={text:c[2].trim()};continue}const l=st(a);if(l&&i){const{name:d,value:f}=l;if(d==="description"){const u=e[o].length-e[o].trimStart().length,m=[];let y=o+1;for(;y<e.length;y++){if(e[y].trim()===""){m.push("");continue}if(e[y].length-e[y].trimStart().length<=u)break;m.push(e[y])}for(;m.length&&m[m.length-1].trim()==="";)m.pop();if(m.length){const b=m.filter(S=>S.trim()!=="").map(S=>S.length-S.trimStart().length),w=Math.min(...b),x=m.map(S=>S.slice(w)).join(`
`);i.description=f?`${f}
${x}`:x}else i.description=f;o=y-1;continue}d==="anchor"?i.anchor=pi(f,t):d==="action"?i.action=f.trim():d==="change"?i.change=f.trim():d==="only"?(i.change=f.trim(),i.replace=!0):d==="highlight"?i.highlight=cl(f):d==="width"?i.width=ll(f):d==="position"?i.position=dl(f):d==="offsetx"?i.offsetX=hl(f):d==="keep"&&(i.keep=f.trim()!=="false");continue}i&&!a.startsWith("-")&&(i.text=`${i.text} ${a}`.trim())}return r(),s.length>0?s:void 0}function fm(e,t){const n=e.split(`
`),i=n[0].match(/^###\s+(.+)$/);if(!i)return null;const r=i[1].trim(),o=ye(n,"Title")??r,a=fl(n,"Description")??"",c=hm(n,"Interactions"),l=ye(n,"Shortcut"),d=ye(n,"Context"),f=pi(ye(n,"Anchor"),r),u=ye(n,"Action"),m=ye(n,"Once"),y=ye(n,"Only"),b=ye(n,"Change"),w=b??y,x=b===void 0&&y!==void 0?!0:void 0,S=cl(ye(n,"Highlight")),v=ll(ye(n,"Width")),g=dl(ye(n,"Position")),k=hl(ye(n,"OffsetX")),P=um(n,r),C=ye(n,"Tour");return{id:r,title:o,description:a,interactions:c,shortcut:l,context:d,anchor:f,action:u,once:m,change:w,replace:x,highlight:S,width:v,position:g,offsetX:k,tour:C===void 0?void 0:C||cm,order:t,beats:P}}function pm(e,t){const n=e.split(`
...
`),anchor:c.anchor??s.anchor,action:c.action,highlight:c.highlight??s.highlight,width:a,position:c.position??s.position,offsetX:c.offsetX??s.offsetX,change:c.change,replace:c.replace})})}),n}function mm(e){const n=e.replace(/<!--[\s\S]*?-->/g,"").trim().split(/(?=^## )/m).map(a=>a.trim()).filter(Boolean),s=[],i=new Map;let r=0;for(const a of n){if(!a.match(/^## /m))continue;const c=a.match(/^##\s+(.+)$/m)?.[1].trim();if(c&&dm.has(c))continue;const l=pm(a,()=>r++);s.push(l);for(const d of l.entries)i.set(d.id,d)}const o=new Map;for(const a of s)a.tourMeta&&o.set(a.tourMeta.name,a.tourMeta);return{sections:s,entries:i,tourMeta:o}}const gm=/\{\{\s*([a-z][a-z0-9-]*)\s*:\s*([^}]*?)\s*\}\}/gi;function ym(e,t){return!t||!e.includes("{{")?e:e.replace(gm,(n,s,i)=>t[s.toLowerCase()]?.(i)??n)}function Zo(e){const t=new Set;return e.map((n,s)=>({p:n,index:s})).filter(({p:n})=>t.has(n.step)?!1:(t.add(n.step),!0)).map(({p:n,index:s})=>({index:s,step:n.step,title:n.entry.title,beatCount:n.beatCount}))}function ml({scope:e,onClose:t}){const{content:n,tours:s,tourMeta:i,tourName:r,tourIndex:o,positions:a,position:c,goToStep:l,startTour:d}=yt();p.useEffect(()=>{const w=x=>{x.key==="Escape"&&(x.stopPropagation(),x.preventDefault(),t())};return window.addEventListener("keydown",w,!0),()=>window.removeEventListener("keydown",w,!0)},[t]);const f=p.useRef(null);p.useEffect(()=>{const w=f.current;if(!(!w||typeof w.showPopover!="function"))return w.showPopover(),()=>{w.matches(":popover-open")&&w.hidePopover()}},[]);const u=p.useMemo(()=>e==="all"?s.map(w=>({name:w,rows:Zo(Ns(n,w))})):[],[e,s,n]),m=c?.step,y=o===null?void 0:r,b=(w,x,S)=>h.jsxs("button",{onClick:S,"aria-current":x?"step":void 0,className:`help-map-step${x?" help-map-step-here":""}`,children:[h.jsx("span",{className:"help-map-num",children:w.step}),h.jsx("span",{className:"help-map-title",children:w.title}),w.beatCount>0&&h.jsx("span",{className:"help-map-beats",title:`${w.beatCount+1} screens in this step`,children:w.beatCount+1})]},w.index);return tr.createPortal(h.jsx("div",{ref:f,popover:"manual",className:"help-map-backdrop",onMouseDown:t,children:h.jsxs("div",{role:"dialog","aria-label":e==="all"?"All tours":"Tour outline",className:"help-map",onMouseDown:w=>w.stopPropagation(),children:[h.jsxs("div",{className:"help-map-head",children:[h.jsxs("div",{children:[h.jsx("h2",{children:e==="all"?"Tours":y??"This tour"}),h.jsx("p",{children:e==="all"?"Every guided walk, and what is in it. Click any step to start there.":"Click any step to jump to it."})]}),h.jsx("button",{onClick:t,title:"Close (Esc)",className:"help-map-close",children:"✕"})]}),h.jsx("div",{className:"help-map-body",children:e==="tour"?Zo(a).map(w=>b(w,w.step===m,()=>{l(w.index),t()})):u.map(({name:w,rows:x})=>h.jsxs("section",{className:"help-map-tour",children:[h.jsx("button",{className:"help-map-tourname",onClick:()=>{d(w),t()},children:w}),i.get(w)?.description&&h.jsx("p",{className:"help-map-blurb",children:i.get(w).description}),x.map(S=>b(S,y===w&&S.step===m,()=>{y===w?l(S.index):d(w,S.index),t()}))]},w))})]})}),document.body)}function wm(){const{tours:e,tourMeta:t,startTour:n}=yt(),[s,i]=p.useState(!1),[r,o]=p.useState(!1),a=p.useRef(null);return p.useEffect(()=>{if(!s)return;const c=d=>{d.target?.closest("[data-tour-chooser]")||i(!1)},l=d=>{d.key==="Escape"&&i(!1)};return document.addEventListener("mousedown",c,!0),document.addEventListener("keydown",l),()=>{document.removeEventListener("mousedown",c,!0),document.removeEventListener("keydown",l)}},[s]),e.length===0?null:h.jsxs("span",{"data-tour-chooser":!0,"data-help-id":"tour-chooser",className:"relative",onMouseEnter:()=>i(!0),children:[h.jsx("button",{onClick:()=>{i(!1),o(!0)},title:"Guided walks through the app and the model; click for the overview",className:`text-sm font-semibold px-2.5 py-1 rounded-full bg-white/95
                   text-blue-700 shadow-sm hover:bg-white hover:shadow`,children:"Guided tours"}),s&&h.jsxs("div",{ref:a,role:"dialog","aria-label":"Guided tours",className:`absolute right-0 top-full mt-1 z-40 w-80 p-1
                     ...
                     text-gray-900 dark:text-gray-100`,children:[h.jsxs("p",{className:"px-3 pt-2 pb-1 text-[11px] text-gray-500 dark:text-gray-400",children:["Each one stands on its own. Leave any tour with ",h.jsx("kbd",{children:"Esc"}),"."]}),h.jsxs("button",{"data-tour-overview":!0,onClick:()=>{i(!1),o(!0)},className:`block w-full text-left px-3 py-2 rounded
                       hover:bg-gray-100 dark:hover:bg-slate-700`,children:[h.jsx("span",{className:"block text-xs font-semibold",children:"Overview"}),h.jsxs("span",{className:"block text-[11px] text-gray-500 dark:text-gray-400",children:["All ",e.length," tours and every step in them — start anywhere."]})]}),h.jsx("div",{className:"my-1 border-t border-gray-200 dark:border-slate-700"}),e.map(c=>h.jsxs("button",{onClick:()=>{i(!1),n(c)},className:`block w-full text-left px-3 py-2 rounded
                         hover:bg-gray-100 dark:hover:bg-slate-700`,children:[h.jsx("span",{className:"block text-xs font-semibold",children:c}),t.get(c)?.description&&h.jsx("span",{className:"block text-[11px] text-gray-500 dark:text-gray-400",children:t.get(c).description})]},c))]}),r&&h.jsx(ml,{scope:"all",onClose:()=>o(!1)})]})}const bm="dmvd.help.showAddresses";function xm(){const e=document.activeElement;return e instanceof HTMLInputElement||e instanceof HTMLTextAreaElement||e?.getAttribute("contenteditable")==="true"}function vm(e,t){if(!t)return e;const n=r=>ym(r,t),s=r=>r===void 0?void 0:n(r),i=new Map([...e.entries].map(([r,o])=>[r,{...o,description:n(o.description),interactions:o.interactions.map(n),action:s(o.action),context:s(o.context),beats:o.beats?.map(a=>({...a,description:s(a.description),action:s(a.action)}))}]));return{sections:e.sections.map(r=>({...r,entries:r.entries.map(o=>i.get(o.id)??o),tourMeta:r.tourMeta&&{...r.tourMeta,description:n(r.tourMeta.description)}})),entries:i,tourMeta:new Map([...e.tourMeta].map(([r,o])=>[r,{...o,description:n(o.description)}]))}}function km({markdown:e,onPushChange:t,onPopChange:n,onJumpChanges:s,onTourStart:i,onTourEnd:r,textResolvers:o,centerOn:a,children:c}){const[l,d]=p.useState(),f=l??o,u=p.useMemo(()=>vm(mm(e),f),[e,f]),[m,y]=p.useState(!1),[b,w]=p.useState(null),[x,S]=p.useState(void 0),v=p.useMemo(()=>Ls(u),[u]),g=p.useMemo(()=>Ns(u,x),[u,x]),k=p.useMemo(()=>pl(u,x).length,[u,x]),[P,C]=p.useState(null),[E,N]=p.useState(()=>!1),z=p.useCallback(()=>{N(K=>{const U=!K;try{window.localStorage.setItem(bm,U?"1":"0")}catch{}return U})},[]),_=p.useCallback(()=>{y(!1),C(null)},[]),I=p.useCallback(()=>C(null),[]),R=p.useCallback(K=>C(K),[]),H=p.useCallback(K=>{const U=g[K];U&&(w(K),C(U.entry.id),U.change!=null&&t&&t(U.change,U.replace))},[g,t]),Z=p.useCallback(K=>{g[K+1]?.change!=null&&n&&n();const Y=g[K];Y&&(w(K),C(Y.entry.id))},[g,n]),ne=p.useCallback(K=>{if(b===null||K===b)return;const U=g[K];if(U&&s){if(K>b){const Y=g.slice(b+1,K+1).filter(J=>J.change!=null).map(J=>({query:J.change,replace:J.replace}));s(Y,0)}else{const Y=g.slice(K+1,b+1).filter(J=>J.change!=null).length;s([],Y)}w(K),C(U.entry.id)}},[b,g,s]),fe=p.useCallback((K=Ls(u)[0],U=0)=>{y(!1),S(K);const Y=Ns(u,K),J=Math.min(Math.max(U,0),Math.max(Y.length-1,0)),se=Y[J];if(!se)return;i?.(),w(J),C(se.entry.id);const je=Y.slice(0,J+1).filter(Le=>Le.change!=null).map(Le=>({query:Le.change,replace:Le.replace}));J>0&&s?s(je,0):se.change!=null&&t&&t(se.change,se.replace)},[u,t,s,i]),O=p.useCallback(()=>{w(null),C(null),S(void 0),r?.()},[r]),B=p.useCallback(()=>{b!==null&&(b+1>=g.length?O():H(b+1))},[b,g.length,H,O]),M=p.useCallback(()=>{b!==null&&b>0&&Z(b-1)},[b,Z]),q=p.useCallback(()=>{b!==null&&O(),C(null)},[b,O]),ge=p.useCallback(K=>{if(!K)return null;const{kind:U}=K;if(U==="none")return null;const{arg:Y}=K,J=U==="help-id"?Y:`${U}:${Y}`,se=document.querySelectorAll(`[data-help-id="${CSS.escape(J)}"]`);return se.length<2?se[0]??null:[...se].find(je=>je.getBoundingClientRect().height>0)??se[0]},[]);p.useEffect(()=>(document.body.classList.toggle("help-mode",m),()=>{document.body.classList.remove("help-mode")}),[m]),p.useEffect(()=>{if(m)return window.addEventListener("blur",_),()=>window.removeEventListener("blur",_)},[m,_]),p.useEffect(()=>{if(!m)return;function K(U){const Y=U.target;if(!Y)return;const J=Y.closest("[data-help-id]");J?(U.stopPropagation(),U.preventDefault(),R(J.getAttribute("data-help-id"))):Y.closest("[data-help-popover]")||I()}return document.addEventListener("click",K,!0),()=>document.removeEventListener("click",K,!0)},[m,R,I]),p.useEffect(()=>{function K(U){if(U.key==="?"&&!xm()){U.preventDefault(),b===null?fe():O();return}if(U.key==="Escape"&&(m||b!==null||P)){U.preventDefault(),U.stopPropagation(),P&&b===null?I():b!==null?O():q();return}b!==null&&(U.key==="ArrowRight"&&(U.preventDefault(),B()),U.key==="ArrowLeft"&&(U.preventDefault(),M()))}return document.addEventListener("keydown",K,!0),()=>document.removeEventListener("keydown",K,!0)},[m,b,P,q,I,O,fe,B,M]);const de=p.useCallback(()=>a?ge(pi(a,a))?.getBoundingClientRect()??null:null,[a,ge]),Ee=p.useMemo(()=>({setTextResolvers:d,helpMode:m,toggleHelpMode:q,exitHelpMode:_,tourIndex:b,startTour:fe,endTour:O,nextStep:B,prevStep:M,goToStep:ne,positions:g,position:b===null?void 0:g[b],stepCount:k,tours:v,tourName:x,tourMeta:u.tourMeta,showAddresses:E,toggleAddresses:z,content:u,activeId:P,showEntry:R,dismissEntry:I,resolveAnchor:ge,centerRect:de}),[m,q,_,b,fe,O,B,M,ne,g,k,v,x,E,z,u,P,R,I,ge,de]);return h.jsx(al.Provider,{value:Ee,children:c})}const Vs={a:({href:e,children:t})=>h.jsx("a",{href:e,target:"_blank",rel:"noreferrer",children:t}),blockquote:({children:e})=>h.jsxs("div",{className:"help-popover-alert",role:"note",children:[h.jsx("span",{className:"help-popover-alert-mark","aria-hidden":"true",children:"!"}),h.jsx("div",{children:e})]})};function Tm(e){try{return localStorage.getItem(e)}catch{return null}}function Sm(e,t){try{localStorage.setItem(e,t)}catch{}}const gl="help-once-",ss="data-help-anchor",Jo="data-help-hint",Cm="--help-hint",Am=40;function Pm(e){return e.split(`
`).filter(t=>!/^\s{0,3}>/.test(t)).join(`
`).replace(/\n{3,}/g,`

`).trim()}function Em(e){return Tm(gl+e)==="1"}function Mm(e){Sm(gl+e,"1")}function Dm(e){return{...Vs,blockquote:({children:t})=>h.jsxs("div",{className:"help-popover-alert",role:"note",children:[h.jsx("span",{className:"help-popover-alert-mark","aria-hidden":"true",children:"!"}),h.jsxs("div",{children:[t,h.jsxs("label",{className:"help-popover-alert-once",children:[h.jsx("input",{type:"checkbox",onChange:e}),"Don't show this again"]})]})]})}}function Om(){const{helpMode:e,tourIndex:t,position:n,positions:s,stepCount:i,content:r,activeId:o,dismissEntry:a,nextStep:c,prevStep:l,endTour:d,showEntry:f,resolveAnchor:u,centerRect:m,showAddresses:y,tourName:b,tourMeta:w}=yt(),x=b===void 0?void 0:w.get(b)?.abbr??b,[S,v]=p.useState(!1),g=t!==null;p.useEffect(()=>{g||v(!1)},[g]);const k=o?r.entries.get(o):void 0,P=ol(),C=u,E=g?n?.anchor:k?.anchor,N=(g?n?.highlight:k?.highlight)??"dim",z=()=>{if(!n||n.beatCount===0)return null;const G=n.beatIndex+1;return h.jsx("span",{className:"help-tour-dots",title:`Screen ${G+1} of ${n.beatCount+1} in this step`,children:Array.from({length:n.beatCount},(oe,he)=>h.jsx("span",{className:he<G?"help-dot help-dot-on":"help-dot"},he))})},[_,I]=p.useState(!1),[R,H]=p.useState(void 0),[Z,ne]=p.useState(!1),fe=p.useRef(null),[,O]=p.useState(0),B=k?.once,M=B!==void 0&&Em(B),q=p.useMemo(()=>B===void 0?Vs:Dm(()=>{Mm(B),O(G=>G+1)}),[B]),ge=(g?n?.blocks??[]:[k?.description??""]).map(G=>M?Pm(G):G).filter(Boolean),de=(g?n?.width:void 0)??Math.max(Bm(ge.join(`

`)),g?$m():0),Ee=p.useRef(!1);p.useEffect(()=>{Ee.current=!1},[o,E]);const K=P.reset;p.useEffect(()=>{K()},[o,t,K]),p.useLayoutEffect(()=>{if(!o){I(!1),H(void 0);return}let G=null;const oe=()=>{const Se=C(E);Se!==G&&(G?.removeAttribute(ss),G=Se,I(!!Se),H(Se?.closest("[data-graph-direction]")?.getAttribute("data-graph-direction")==="RIGHT"?"below":void 0),Se&&(Se.setAttribute(ss,""),Ee.current||(Ee.current=!0,Se.scrollIntoView({block:"center",behavior:"smooth"}))))};oe();const he=new MutationObserver(oe);return he.observe(document.body,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["data-help-id"]}),()=>{he.disconnect(),G?.removeAttribute(ss),I(!1),H(void 0)}},[o,E,C]);const U=600,Y=g&&n?.change!=null&&E!==void 0&&E.kind!=="none",[J,se]=p.useState(!1);p.useEffect(()=>{if(!Y){se(!0);return}se(!1);const G=window.setTimeout(()=>se(!0),U);return()=>window.clearTimeout(G)},[Y,t]);const je=J||_;p.useEffect(()=>{const G=fe.current;G&&(k&&je?G.matches(":popover-open")||G.showPopover():G.matches(":popover-open")&&G.hidePopover())},[k,je]),p.useEffect(()=>{(!e||g)&&ne(!1)},[e,g]);const Le=p.useMemo(()=>e&&!g?[...r.entries.values()].filter(G=>C(G.anchor)).slice(0,Am).map((G,oe)=>({id:G.id,title:G.title,name:`${Cm}-${oe}`})):[],[e,g,r,C]);return p.useLayoutEffect(()=>{const G=Le.map(oe=>{const he=C(r.entries.get(oe.id)?.anchor);return he?.setAttribute(Jo,oe.name),he}).filter(Boolean);return()=>G.forEach(oe=>oe.removeAttribute(Jo))},[Le,r,C]),h.jsxs(h.Fragment,{children:[_&&o&&N!=="none"&&h.jsx("div",{className:`help-spotlight${N==="ring"?" help-spotlight-ring":""}`}),Le.map(({id:G,title:oe,name:he})=>h.jsx("button",{className:"help-hint",title:oe??G,style:{positionAnchor:he},onMouseEnter:()=>{Z||f(G)},onMouseLeave:()=>{Z||a()},onClick:Se=>{Se.stopPropagation(),ne(!0),f(G)},children:"?"},G)),h.jsx("div",{ref:fe,popover:"manual","data-help-popover":"","data-anchored":_?"":void 0,className:"help-popover",style:{...Fm(_,g?n?.position:void 0,g?n?.offsetX:void 0,de,_?null:m(),R),...P.offset?{positionArea:"none",left:P.offset.left,top:P.offset.top,right:"auto",bottom:"auto",margin:0,transform:"none"}:{}},children:k&&h.jsxs(h.Fragment,{children:[h.jsxs("h4",{className:"help-popover-title",onPointerDown:P.onPointerDown,style:{cursor:P.offset?"grabbing":"grab",userSelect:"none"},title:"Drag to move",children:[g&&x&&h.jsx("span",{className:"help-popover-tour",children:x}),k.title]}),g&&n?.action&&h.jsxs("div",{className:"help-popover-action",children:[h.jsx("span",{className:"help-popover-action-mark","aria-hidden":"true",children:"✓"}),h.jsx("div",{children:h.jsx(Wt,{children:n.action})})]}),g&&y&&n?.change&&!n.action&&h.jsxs("div",{className:"help-popover-action",style:{opacity:.85},children:[h.jsx("span",{className:"help-popover-action-mark","aria-hidden":"true",children:"⚠"}),h.jsxs("div",{children:[h.jsx("em",{children:"Authoring:"})," this position changes the app (",h.jsx("code",{children:n.change}),") but has no ",h.jsx("code",{children:"Action:"}),"."]})]}),ge.length>0&&h.jsx("div",{className:"help-popover-body",children:ge.map((G,oe,he)=>h.jsx("div",{className:oe===he.length-1?void 0:"help-beat-past",children:h.jsx(Wt,{components:q,children:G})},oe))}),k.interactions.length>0&&h.jsx("ul",{className:"help-popover-interactions",children:k.interactions.map((G,oe)=>h.jsx("li",{children:h.jsx(Wt,{components:Vs,children:G})},oe))}),k.shortcut&&h.jsxs("p",{className:"help-popover-shortcut",children:["Shortcut: ",h.jsx("kbd",{children:k.shortcut})]}),k.context&&h.jsx("div",{className:"help-popover-context",children:h.jsx(Wt,{children:k.context})}),g?h.jsxs("div",{className:"help-tour-nav",children:[h.jsxs("span",{className:"help-tour-count",title:`Position ${t+1} of ${s.length}`,children:[n?.step," / ",i]}),z(),h.jsx("button",{className:"help-tour-map-btn",onClick:()=>v(G=>!G),"aria-expanded":S,title:"Show the tour outline",children:"⊞"}),h.jsx("span",{className:"help-tour-spacer"}),h.jsx("button",{onClick:l,disabled:t===0,title:"Previous (← arrow key)",children:"← back"}),h.jsx("button",{onClick:c,className:"help-tour-next",title:"Next (→ arrow key)",children:t+1===s.length?"done":"next →"}),h.jsx("button",{onClick:d,title:"End the tour and undo what it added (Esc)",children:"✕"})]}):h.jsxs("div",{className:"help-tour-nav",children:[h.jsx("span",{className:"help-tour-spacer"}),h.jsx("button",{onClick:()=>{ne(!1),a()},children:"close"})]}),y&&h.jsx(Rm,{address:g?n?.address:k.id,searchFor:g?n?.searchFor:`### ${k.id}`})]})}),S&&g&&h.jsx(ml,{scope:"tour",onClose:()=>v(!1)})]})}function Rm({address:e,searchFor:t}){const[n,s]=p.useState(!1);return p.useEffect(()=>{if(!n)return;const i=setTimeout(()=>s(!1),1200);return()=>clearTimeout(i)},[n]),!e||!t?null:h.jsxs("button",{type:"button",className:"help-popover-address",title:`Copy “${t}” — search help-content.md for it`,onClick:()=>{navigator.clipboard?.writeText(t).then(()=>s(!0),()=>{})},children:[e,n?" ✓":""]})}const yl=320,jm=320,Lm=800,Nm=8,Vm=24,Im=3;function Bm(e){const t=e.trim().length;return t===0?yl:Math.round(Math.min(Lm,Math.max(jm,Math.sqrt(t*Nm*Vm*Im))))}function $m(){return 393}function Fm(e,t,n,s,i,r){const o=window.innerWidth,a=window.innerHeight,c=Math.min(s??yl,o-16);if(!e){const d=i??new DOMRect(0,0,o,a),f=d.left+d.width/2;return{left:Math.max(8,Math.min(f-c/2,o-c-8)),top:"50%",transform:"translateY(-50%)",maxHeight:`${a-16}px`,width:c}}return{positionArea:t?{right:"inline-end span-block-end",left:"inline-start span-block-end",top:"block-start span-inline-end",bottom:"block-end span-inline-end"}[t]:r==="below"?"block-end span-inline-end":"inline-end span-block-end",width:c,..._m(n)}}function _m(e){return e?{marginLeft:"px"in e?`${e.px}px`:`calc(anchor-size(${e.of}) * ${e.times})`}:{}}const is=e=>e&&e.trim()?e.trim():void 0;function Hm(e){return{"model-description":t=>is(e.getClassDescription(t)),"enum-description":t=>is(e.getEnumDetail(t)?.description),"category-label":t=>is(nr.find(n=>n.id===t)?.label)}}const Wm=`# BDCHM Explorer help
...
`,gi={inTour:!1,held:[],tempHeld:[],tour:[],region:0,tourStates:[],scalars:{}},zm="~";function er(e,t){return e&&t.includes(e)?e:null}function wl(e,t=!1){const n=new URLSearchParams(e),s={};if(n.get("panels")==="0"){for(const c of Ga)s[c]=!1;s.detail=null}n.has("detail")&&(s.detail=n.get("detail")||null),n.has("roots")&&(s.roots=n.get("roots")==="1"),n.has("sibs")&&(s.sibs=n.get("sibs")==="1"),n.has("legend")&&(s.legend=n.get("legend")==="1"),n.has("cases")&&(s.cases=n.get("cases")==="1");const i=er(n.get("dir"),["RIGHT","DOWN"]);i&&(s.dir=i);const r=er(n.get("merge"),["near","far","bend","off"]);r&&(s.merge=r);const o=n.get("sel"),a=o?o.split(zm).filter(Boolean):Ka(n);return t?{sel:a,scalars:s,replace:!0}:{sel:a,scalars:s}}function Dt(e,t){return[...new Set([...e,...t])]}function Um(e){return{...gi,inTour:!0,held:[...e]}}function Gm(){return gi}function Km(e){return Dt(e.held,e.tempHeld)}function bl(e,t){const n=t.replace?e.region+1:e.region,s=t.replace?[...t.sel]:Dt(e.tour,t.sel),i={...e.scalars,...t.scalars};return{...e,tour:s,region:n,scalars:i,tourStates:[...e.tourStates,{sel:s,scalars:i,region:n}]}}function xl(e){if(e.tourStates.length===0)return e;const t=e.tourStates.slice(0,-1),n=t[t.length-1];return{...e,tourStates:t,tour:n?n.sel:[],region:n?n.region:0}}function yi(e){return e.region>0}function Qm(e,t){if(!e.inTour)return e;const n=yi(e)?"tempHeld":"held";return e[n].includes(t)?e:{...e,[n]:[...e[n],t]}}function qm(e,t){if(!e.inTour)return e;const n=s=>s.filter(i=>i!==t);return{...e,tour:n(e.tour),tempHeld:n(e.tempHeld),held:yi(e)?e.held:n(e.held)}}function wi(e,t){if(!t.inTour)return e;const n=yi(t)?Dt(t.tour,t.tempHeld):Dt(Dt(t.tour,t.tempHeld),t.held);return{...e,...t.scalars,sel:n}}function Xm(){const{modelData:e,loading:t,error:n}=Ll(),s=p.useMemo(()=>e?new Nl(e):null,[e]),{setTextResolvers:i}=yt(),r=p.useMemo(()=>s?Hm(s):void 0,[s]);p.useEffect(()=>i(r),[r,i]);const o=p.useMemo(()=>Ie(),[]),[a,c]=p.useState(()=>new Set(o.sel)),[l,d]=p.useState(o.detail),[f,u]=p.useState(!1),m=p.useRef(!1),[y,b]=p.useState(o.roots),[w,x]=p.useState(o.sibs),[S,v]=p.useState(o.dir),[g,k]=p.useState(o.merge),[P,C]=p.useState(o.cases),[E,N]=p.useState(o.legend),[z,_]=p.useState(!1),I=p.useCallback(O=>{c(new Set(O.sel)),b(!!O.roots),d(null)},[]);p.useEffect(()=>{const O=()=>{const B=Ie();c(new Set(B.sel)),d(B.detail),b(B.roots),x(B.sibs),v(B.dir),k(B.merge),N(B.legend),C(B.cases)};return window.addEventListener("popstate",O),window.addEventListener("explore:state-from-url",O),()=>{window.removeEventListener("popstate",O),window.removeEventListener("explore:state-from-url",O)}},[]),p.useEffect(()=>{const O={sel:[...a],detail:l,roots:y,sibs:w,dir:S,merge:g,legend:E,cases:P},B=m.current;m.current=!1,Qa(O,{push:B})},[a,l,y,w,S,g,E,P]);const R=p.useCallback(O=>{at(O,!Ie().sel.includes(O)),c(B=>{const M=new Set(B);return M.has(O)?M.delete(O):M.add(O),M})},[]),H=p.useCallback(O=>{at(O,!0),c(B=>B.has(O)?B:new Set(B).add(O))},[]),Z=p.useCallback(O=>{at(O,!1),c(B=>{if(!B.has(O))return B;const M=new Set(B);return M.delete(O),M})},[]),ne=p.useCallback(O=>{c(M=>M.size===O.length&&O.every(q=>M.has(q))?M:(m.current=!0,new Set(O)));const B=new Set(O);for(const M of Ie().sel)B.has(M)||at(M,!1);for(const M of O)at(M,!0)},[]),fe=p.useCallback(()=>{for(const O of Ie().sel)at(O,!1);c(new Set),d(null),u(!1),b(!1)},[]);return n?h.jsxs("div",{className:"p-8 text-red-600",children:["Failed to load model data: ",String(n)]}):t||!s?h.jsx("div",{className:"p-8 text-gray-400",children:"Loading model…"}):h.jsxs("div",{className:"relative flex flex-col h-screen bg-white dark:bg-slate-900 text-gray-900 dark:text-gray-100",children:[h.jsxs("header",{className:"flex items-center justify-between px-4 py-2 bg-blue-600 text-white shrink-0",children:[h.jsxs("div",{children:[h.jsx("h1",{"data-help-id":"app-title",className:"text-lg font-bold leading-tight cursor-pointer hover:opacity-80 transition-opacity",onClick:fe,title:"Click to clear the selection and reset the view",children:"BDCHM Explorer"}),h.jsx("p",{className:"text-xs text-blue-100",children:"BioData Catalyst Harmonized Model"})]}),h.jsxs("div",{className:"flex items-center gap-4",children:[h.jsx(sg,{}),h.jsx(wm,{}),h.jsx(rm,{onOpenLegend:()=>N(O=>!O),onOpenCases:()=>C(O=>!O),legendOpen:E,casesOpen:P,anyPanelOpen:E||P||l!==null,onClosePanels:()=>{N(!1),C(!1),d(null)}}),h.jsx("button",{onClick:async()=>{const O=Op({sel:[...a],detail:l,roots:y,sibs:w,dir:S,merge:g,legend:E,cases:P});try{await navigator.clipboard.writeText(O),_(!0),window.setTimeout(()=>_(!1),1500)}catch{_(!1),window.prompt("Copy this link:",O)}},"data-help-id":"copy-link",className:"text-sm underline text-blue-100 hover:text-white",title:"Copy a link that reproduces exactly this view, settings included",children:z?"✓ copied":"copy link"}),h.jsx("a",{href:"/dynamic-model-var-docs/previous.html",className:"text-sm underline text-blue-100 hover:text-white",children:"previous views"}),h.jsx("a",{href:"https://github.com/Sigfried/dynamic-model-var-docs",target:"_blank",rel:"noopener noreferrer",className:"text-blue-100 hover:text-white",title:"Source code on GitHub","aria-label":"Source code on GitHub",children:h.jsx("svg",{viewBox:"0 0 16 16",width:"18",height:"18",fill:"currentColor","aria-hidden":!0,children:h.jsx("path",{d:"M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27s1.36.09 2 .27c1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.01 8.01 0 0 0 16 8c0-4.42-3.58-8-8-8Z"})})})]})]}),E&&h.jsx(tm,{onClose:()=>N(!1),onSelect:O=>I({name:"ad hoc",note:"",sel:O}),dataService:s}),P&&h.jsx(Yp,{onClose:()=>C(!1),onApply:I,selectedIds:a,dataService:s,offset:E}),h.jsxs("div",{className:"flex-1 flex min-h-0",children:[f?h.jsxs("button",{onClick:()=>u(!1),title:"Show entity selection",className:`shrink-0 w-8 border-r border-gray-200 dark:border-slate-700
                       bg-gray-50 dark:bg-slate-800 hover:bg-gray-100 dark:hover:bg-slate-700
                       flex flex-col items-center gap-2 py-2 text-gray-400`,children:[h.jsx("span",{className:"text-xs",children:"▶"}),h.jsxs("span",{className:"text-[10px] uppercase tracking-wider [writing-mode:vertical-rl]",children:[s.getConceptLabel("entity",!0),a.size>0?` (${a.size})`:""]})]}):h.jsxs("div",{className:"w-80 shrink-0 flex flex-col min-h-0 border-r border-gray-200 dark:border-slate-700",children:[h.jsx("div",{className:"flex-1 overflow-y-auto min-h-0","data-help-id":"selection-tree",children:h.jsx(Ul,{dataService:s,selectedIds:a,onToggle:R,onShowCategory:ne})}),h.jsx("button",{onClick:()=>u(!0),title:"Hide entity selection",className:`shrink-0 px-3 py-1 text-xs text-gray-400 border-t border-gray-200
                         dark:border-slate-700 hover:bg-gray-50 dark:hover:bg-slate-800 text-left`,children:"◀ Hide"})]}),h.jsx("div",{className:"flex-1 min-w-0","data-help-id":"graph-canvas",children:a.size===0?h.jsx("div",{className:"h-full flex items-center justify-center text-sm text-gray-400 p-8",children:"Select entities on the left to build the ownership subgraph."}):h.jsx(Up,{dataService:s,selectedIds:a,onNodeClick:d,onAdd:H,onRemove:Z,pathToRoot:y,onTogglePathToRoot:()=>b(O=>!O),direction:S,setDirection:v,mergeMode:g,setMergeMode:k,mergeSibs:w,setMergeSibs:x})}),l&&h.jsx(Gp,{classId:l,dataService:s,onClose:()=>d(null),onNavigate:d,isSelected:a.has(l),onToggleSelect:R})]})]})}let ue=gi;function at(e,t){ue=t?Qm(ue,e):qm(ue,e)}function Mn(e){Qa(e),window.dispatchEvent(new Event("explore:state-from-url"))}function Ym(){ue=Um(Ie().sel)}function Zm(){if(!ue.inTour)return;const e=Km(ue),t=Ie();ue=Gm(),Mn({...t,sel:e})}function Jm(e,t=!1){ue=bl(ue,wl(e,t)),Mn(wi(Ie(),ue))}function eg(){ue=xl(ue),Mn(wi(Ie(),ue))}function tg(e,t){for(let n=0;n<t;n++)ue=xl(ue);for(const n of e)ue=bl(ue,wl(n.query,n.replace));Mn(wi(Ie(),ue))}function ng(){return h.jsxs(km,{markdown:Wm,onPushChange:Jm,onPopChange:eg,onJumpChanges:tg,onTourStart:Ym,onTourEnd:Zm,children:[h.jsx(Xm,{}),h.jsx(Om,{})]})}function sg(){const{helpMode:e,toggleHelpMode:t,startTour:n}=yt();return p.useEffect(()=>{Ep()&&n()},[]),h.jsx("span",{className:"flex items-center gap-2","data-help-id":"help-button",children:nm})}Vl.createRoot(document.getElementById("root")).render(h.jsx(p.StrictMode,{children:h.jsx(ng,{})}));
