...
- **Description:**
  ...
  *belonging to* its defining entity, it places the target to the right and
  ...
  :s[{{relation:own-fwd:Condition.affected_body_site:BodySite}}]{text-align: center}
