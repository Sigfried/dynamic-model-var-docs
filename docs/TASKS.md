...
## Then — cleanups with a known shape
  ...
  | 14 | **Improve the intros to README and the first tour** — they might share text. README's *Model shape* does not actually describe the model's shape; it describes how the app adjusts it for comprehension. [sg]                                                | [README](../README.md) · [§3.1](TOURS_AND_CONTENT.md#31-what-bdchm-covers-needs-a-better-title) |
