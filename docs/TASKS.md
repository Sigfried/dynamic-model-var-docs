...
## Then — cleanups with a known shape
  ...
  | 13 | README.md is out of date                                                                                                                                                                                                                                        | [../README.md](../README.md)                                                                                                                             |
  | 14 | **Fix `EXPLORE_VIZ.md`** — audited ~20–25% stale, and the staleness is *concentrated*: the "Core visual-design conclusions" list is the worst section and reads as settled design law. **Fix the numbered list and the two `ownerCap` mentions first.**         | [BACKLOG §EXPLORE_VIZ](BACKLOG.md#explore_vizmd-is-2025-stale-1)                                                             |
  | 15 | **A sync check that each `containmentGraph` override slot name still has exactly one site.** The sets are keyed by SLOT NAME, not `(class, slot)`, and every member happening to occur at one class is **luck, not design**.                                    | [BACKLOG §Config rot](BACKLOG.md#hand-curated-config-rot)                                                                    |
