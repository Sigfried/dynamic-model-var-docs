...
| 1b | Have click on Guided tours button bring up the overview. *(Salvaged 2026-09-09 from a stash.)* | |
| 1c | Tour steps don't tell you what tour you're on. And tour name before `Title:`. Add new field `TourAbbr:` and use that instead of title if it exists. *(Salvaged 2026-09-09 from a stash.)* | |
