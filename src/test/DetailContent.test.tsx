...
import { ACTIVE_VOCAB, SectionId } from '../config/appConfig';
...
describe('DetailContent - ClassElement', () => {
  ...
  test('should render slots section with all slots', () => {
    ...
    expect(screen.getByText(ACTIVE_VOCAB.section[SectionId.Attributes])).toBeInTheDocument();
...
describe('DetailContent -EnumElement', () => {
  ...
  test('should render permissible values section', () => {
    ...
    expect(screen.getByText(ACTIVE_VOCAB.section[SectionId.PermissibleValues])).toBeInTheDocument();
  ...
  test.skip('should render used by classes section', () => {
    ...
    expect(screen.getByText(`${ACTIVE_VOCAB.section[SectionId.UsedByEntities]} (2)`)).toBeInTheDocument();
    expect(screen.getByText('TestClass')).toBeInTheDocument();
...
describe('DetailContent -SlotElement', () => {
  ...
  test('should render properties section', () => {
    ...
    expect(screen.getByText(ACTIVE_VOCAB.concept.attributeType.singular)).toBeInTheDocument();
  ...
  test.skip('should render used by classes section', () => {
    ...
    expect(screen.getByText(`${ACTIVE_VOCAB.section[SectionId.UsedByEntities]} (3)`)).toBeInTheDocument();
